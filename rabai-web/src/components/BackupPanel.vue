        ...
        <div class="selective-restore-modal">
          ...
          <div v-else-if="selectiveDialog.slides.length > 0" class="selective-slides-grid">
            ...
            >
              ...
              <img v-if="slide.svg_path" :src="getSlidePreviewUrl(slide.svg_path)" class="slide-preview-img" alt="" @error="e => (e.target as HTMLImageElement).style && ((e.target as HTMLImageElement).style.display='none')" />
            </div>
          </div>
