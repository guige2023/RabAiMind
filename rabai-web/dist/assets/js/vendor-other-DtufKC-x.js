function Cv(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}/**
* @vue/shared v3.5.30
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Zf(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const Ut={},Is=[],Di=()=>{},hg=()=>!1,Il=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),Qf=n=>n.startsWith("onUpdate:"),Zt=Object.assign,eh=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Pv=Object.prototype.hasOwnProperty,wt=(n,e)=>Pv.call(n,e),nt=Array.isArray,Ds=n=>ra(n)==="[object Map]",to=n=>ra(n)==="[object Set]",hd=n=>ra(n)==="[object Date]",ut=n=>typeof n=="function",Wt=n=>typeof n=="string",hi=n=>typeof n=="symbol",Rt=n=>n!==null&&typeof n=="object",dg=n=>(Rt(n)||ut(n))&&ut(n.then)&&ut(n.catch),pg=Object.prototype.toString,ra=n=>pg.call(n),Lv=n=>ra(n).slice(8,-1),mg=n=>ra(n)==="[object Object]",th=n=>Wt(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,Uo=Zf(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Dl=n=>{const e=Object.create(null);return(t=>e[t]||(e[t]=n(t)))},Iv=/-\w/g,wn=Dl(n=>n.replace(Iv,e=>e.slice(1).toUpperCase())),Dv=/\B([A-Z])/g,Or=Dl(n=>n.replace(Dv,"-$1").toLowerCase()),Nl=Dl(n=>n.charAt(0).toUpperCase()+n.slice(1)),uc=Dl(n=>n?`on${Nl(n)}`:""),Ci=(n,e)=>!Object.is(n,e),el=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},gg=(n,e,t,i=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:i,value:t})},Ul=n=>{const e=parseFloat(n);return isNaN(e)?n:e},Nv=n=>{const e=Wt(n)?Number(n):NaN;return isNaN(e)?n:e};let dd;const Ol=()=>dd||(dd=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function nh(n){if(nt(n)){const e={};for(let t=0;t<n.length;t++){const i=n[t],r=Wt(i)?Bv(i):nh(i);if(r)for(const s in r)e[s]=r[s]}return e}else if(Wt(n)||Rt(n))return n}const Uv=/;(?![^(]*\))/g,Ov=/:([^]+)/,Fv=/\/\*[^]*?\*\//g;function Bv(n){const e={};return n.replace(Fv,"").split(Uv).forEach(t=>{if(t){const i=t.split(Ov);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function ih(n){let e="";if(Wt(n))e=n;else if(nt(n))for(let t=0;t<n.length;t++){const i=ih(n[t]);i&&(e+=i+" ")}else if(Rt(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const kv="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Vv=Zf(kv);function _g(n){return!!n||n===""}function Hv(n,e){if(n.length!==e.length)return!1;let t=!0;for(let i=0;t&&i<n.length;i++)t=Dr(n[i],e[i]);return t}function Dr(n,e){if(n===e)return!0;let t=hd(n),i=hd(e);if(t||i)return t&&i?n.getTime()===e.getTime():!1;if(t=hi(n),i=hi(e),t||i)return n===e;if(t=nt(n),i=nt(e),t||i)return t&&i?Hv(n,e):!1;if(t=Rt(n),i=Rt(e),t||i){if(!t||!i)return!1;const r=Object.keys(n).length,s=Object.keys(e).length;if(r!==s)return!1;for(const o in n){const a=n.hasOwnProperty(o),l=e.hasOwnProperty(o);if(a&&!l||!a&&l||!Dr(n[o],e[o]))return!1}}return String(n)===String(e)}function rh(n,e){return n.findIndex(t=>Dr(t,e))}const vg=n=>!!(n&&n.__v_isRef===!0),zv=n=>Wt(n)?n:n==null?"":nt(n)||Rt(n)&&(n.toString===pg||!ut(n.toString))?vg(n)?zv(n.value):JSON.stringify(n,xg,2):String(n),xg=(n,e)=>vg(e)?xg(n,e.value):Ds(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[i,r],s)=>(t[fc(i,s)+" =>"]=r,t),{})}:to(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>fc(t))}:hi(e)?fc(e):Rt(e)&&!nt(e)&&!mg(e)?String(e):e,fc=(n,e="")=>{var t;return hi(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.30
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ln;class Gv{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=Ln,!e&&Ln&&(this.index=(Ln.scopes||(Ln.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=Ln;try{return Ln=this,e()}finally{Ln=t}}}on(){++this._on===1&&(this.prevScope=Ln,Ln=this)}off(){this._on>0&&--this._on===0&&(Ln=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Wv(){return Ln}let Ft;const hc=new WeakSet;class yg{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ln&&Ln.active&&Ln.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,hc.has(this)&&(hc.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Mg(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,pd(this),bg(this);const e=Ft,t=ui;Ft=this,ui=!0;try{return this.fn()}finally{Eg(this),Ft=e,ui=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ah(e);this.deps=this.depsTail=void 0,pd(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?hc.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ou(this)&&this.run()}get dirty(){return Ou(this)}}let Sg=0,Oo,Fo;function Mg(n,e=!1){if(n.flags|=8,e){n.next=Fo,Fo=n;return}n.next=Oo,Oo=n}function sh(){Sg++}function oh(){if(--Sg>0)return;if(Fo){let e=Fo;for(Fo=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;Oo;){let e=Oo;for(Oo=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(i){n||(n=i)}e=t}}if(n)throw n}function bg(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Eg(n){let e,t=n.depsTail,i=t;for(;i;){const r=i.prevDep;i.version===-1?(i===t&&(t=r),ah(i),jv(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=r}n.deps=e,n.depsTail=t}function Ou(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Tg(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function Tg(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Wo)||(n.globalVersion=Wo,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Ou(n))))return;n.flags|=2;const e=n.dep,t=Ft,i=ui;Ft=n,ui=!0;try{bg(n);const r=n.fn(n._value);(e.version===0||Ci(r,n._value))&&(n.flags|=128,n._value=r,e.version++)}catch(r){throw e.version++,r}finally{Ft=t,ui=i,Eg(n),n.flags&=-3}}function ah(n,e=!1){const{dep:t,prevSub:i,nextSub:r}=n;if(i&&(i.nextSub=r,n.prevSub=void 0),r&&(r.prevSub=i,n.nextSub=void 0),t.subs===n&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let s=t.computed.deps;s;s=s.nextDep)ah(s,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function jv(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let ui=!0;const Ag=[];function lr(){Ag.push(ui),ui=!1}function cr(){const n=Ag.pop();ui=n===void 0?!0:n}function pd(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=Ft;Ft=void 0;try{e()}finally{Ft=t}}}let Wo=0;class Xv{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class lh{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!Ft||!ui||Ft===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==Ft)t=this.activeLink=new Xv(Ft,this),Ft.deps?(t.prevDep=Ft.depsTail,Ft.depsTail.nextDep=t,Ft.depsTail=t):Ft.deps=Ft.depsTail=t,wg(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=Ft.depsTail,t.nextDep=void 0,Ft.depsTail.nextDep=t,Ft.depsTail=t,Ft.deps===t&&(Ft.deps=i)}return t}trigger(e){this.version++,Wo++,this.notify(e)}notify(e){sh();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{oh()}}}function wg(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)wg(i)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Fu=new WeakMap,is=Symbol(""),Bu=Symbol(""),jo=Symbol("");function gn(n,e,t){if(ui&&Ft){let i=Fu.get(n);i||Fu.set(n,i=new Map);let r=i.get(t);r||(i.set(t,r=new lh),r.map=i,r.key=t),r.track()}}function tr(n,e,t,i,r,s){const o=Fu.get(n);if(!o){Wo++;return}const a=l=>{l&&l.trigger()};if(sh(),e==="clear")o.forEach(a);else{const l=nt(n),c=l&&th(t);if(l&&t==="length"){const u=Number(i);o.forEach((h,d)=>{(d==="length"||d===jo||!hi(d)&&d>=u)&&a(h)})}else switch((t!==void 0||o.has(void 0))&&a(o.get(t)),c&&a(o.get(jo)),e){case"add":l?c&&a(o.get("length")):(a(o.get(is)),Ds(n)&&a(o.get(Bu)));break;case"delete":l||(a(o.get(is)),Ds(n)&&a(o.get(Bu)));break;case"set":Ds(n)&&a(o.get(is));break}}oh()}function ps(n){const e=Et(n);return e===n?e:(gn(e,"iterate",jo),Qn(n)?e:e.map(di))}function Fl(n){return gn(n=Et(n),"iterate",jo),n}function Ai(n,e){return ur(n)?Hs(rs(n)?di(e):e):di(e)}const qv={__proto__:null,[Symbol.iterator](){return dc(this,Symbol.iterator,n=>Ai(this,n))},concat(...n){return ps(this).concat(...n.map(e=>nt(e)?ps(e):e))},entries(){return dc(this,"entries",n=>(n[1]=Ai(this,n[1]),n))},every(n,e){return Xi(this,"every",n,e,void 0,arguments)},filter(n,e){return Xi(this,"filter",n,e,t=>t.map(i=>Ai(this,i)),arguments)},find(n,e){return Xi(this,"find",n,e,t=>Ai(this,t),arguments)},findIndex(n,e){return Xi(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return Xi(this,"findLast",n,e,t=>Ai(this,t),arguments)},findLastIndex(n,e){return Xi(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return Xi(this,"forEach",n,e,void 0,arguments)},includes(...n){return pc(this,"includes",n)},indexOf(...n){return pc(this,"indexOf",n)},join(n){return ps(this).join(n)},lastIndexOf(...n){return pc(this,"lastIndexOf",n)},map(n,e){return Xi(this,"map",n,e,void 0,arguments)},pop(){return go(this,"pop")},push(...n){return go(this,"push",n)},reduce(n,...e){return md(this,"reduce",n,e)},reduceRight(n,...e){return md(this,"reduceRight",n,e)},shift(){return go(this,"shift")},some(n,e){return Xi(this,"some",n,e,void 0,arguments)},splice(...n){return go(this,"splice",n)},toReversed(){return ps(this).toReversed()},toSorted(n){return ps(this).toSorted(n)},toSpliced(...n){return ps(this).toSpliced(...n)},unshift(...n){return go(this,"unshift",n)},values(){return dc(this,"values",n=>Ai(this,n))}};function dc(n,e,t){const i=Fl(n),r=i[e]();return i!==n&&!Qn(n)&&(r._next=r.next,r.next=()=>{const s=r._next();return s.done||(s.value=t(s.value)),s}),r}const Kv=Array.prototype;function Xi(n,e,t,i,r,s){const o=Fl(n),a=o!==n&&!Qn(n),l=o[e];if(l!==Kv[e]){const h=l.apply(n,s);return a?di(h):h}let c=t;o!==n&&(a?c=function(h,d){return t.call(this,Ai(n,h),d,n)}:t.length>2&&(c=function(h,d){return t.call(this,h,d,n)}));const u=l.call(o,c,i);return a&&r?r(u):u}function md(n,e,t,i){const r=Fl(n),s=r!==n&&!Qn(n);let o=t,a=!1;r!==n&&(s?(a=i.length===0,o=function(c,u,h){return a&&(a=!1,c=Ai(n,c)),t.call(this,c,Ai(n,u),h,n)}):t.length>3&&(o=function(c,u,h){return t.call(this,c,u,h,n)}));const l=r[e](o,...i);return a?Ai(n,l):l}function pc(n,e,t){const i=Et(n);gn(i,"iterate",jo);const r=i[e](...t);return(r===-1||r===!1)&&hh(t[0])?(t[0]=Et(t[0]),i[e](...t)):r}function go(n,e,t=[]){lr(),sh();const i=Et(n)[e].apply(n,t);return oh(),cr(),i}const Yv=Zf("__proto__,__v_isRef,__isVue"),Rg=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(hi));function $v(n){hi(n)||(n=String(n));const e=Et(this);return gn(e,"has",n),e.hasOwnProperty(n)}class Cg{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,i){if(t==="__v_skip")return e.__v_skip;const r=this._isReadonly,s=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return s;if(t==="__v_raw")return i===(r?s?ox:Dg:s?Ig:Lg).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const o=nt(e);if(!r){let l;if(o&&(l=qv[t]))return l;if(t==="hasOwnProperty")return $v}const a=Reflect.get(e,t,Sn(e)?e:i);if((hi(t)?Rg.has(t):Yv(t))||(r||gn(e,"get",t),s))return a;if(Sn(a)){const l=o&&th(t)?a:a.value;return r&&Rt(l)?Vu(l):l}return Rt(a)?r?Vu(a):uh(a):a}}class Pg extends Cg{constructor(e=!1){super(!1,e)}set(e,t,i,r){let s=e[t];const o=nt(e)&&th(t);if(!this._isShallow){const c=ur(s);if(!Qn(i)&&!ur(i)&&(s=Et(s),i=Et(i)),!o&&Sn(s)&&!Sn(i))return c||(s.value=i),!0}const a=o?Number(t)<e.length:wt(e,t),l=Reflect.set(e,t,i,Sn(e)?e:r);return e===Et(r)&&(a?Ci(i,s)&&tr(e,"set",t,i):tr(e,"add",t,i)),l}deleteProperty(e,t){const i=wt(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&i&&tr(e,"delete",t,void 0),r}has(e,t){const i=Reflect.has(e,t);return(!hi(t)||!Rg.has(t))&&gn(e,"has",t),i}ownKeys(e){return gn(e,"iterate",nt(e)?"length":is),Reflect.ownKeys(e)}}class Jv extends Cg{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const Zv=new Pg,Qv=new Jv,ex=new Pg(!0);const ku=n=>n,va=n=>Reflect.getPrototypeOf(n);function tx(n,e,t){return function(...i){const r=this.__v_raw,s=Et(r),o=Ds(s),a=n==="entries"||n===Symbol.iterator&&o,l=n==="keys"&&o,c=r[n](...i),u=t?ku:e?Hs:di;return!e&&gn(s,"iterate",l?Bu:is),Zt(Object.create(c),{next(){const{value:h,done:d}=c.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}}})}}function xa(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function nx(n,e){const t={get(r){const s=this.__v_raw,o=Et(s),a=Et(r);n||(Ci(r,a)&&gn(o,"get",r),gn(o,"get",a));const{has:l}=va(o),c=e?ku:n?Hs:di;if(l.call(o,r))return c(s.get(r));if(l.call(o,a))return c(s.get(a));s!==o&&s.get(r)},get size(){const r=this.__v_raw;return!n&&gn(Et(r),"iterate",is),r.size},has(r){const s=this.__v_raw,o=Et(s),a=Et(r);return n||(Ci(r,a)&&gn(o,"has",r),gn(o,"has",a)),r===a?s.has(r):s.has(r)||s.has(a)},forEach(r,s){const o=this,a=o.__v_raw,l=Et(a),c=e?ku:n?Hs:di;return!n&&gn(l,"iterate",is),a.forEach((u,h)=>r.call(s,c(u),c(h),o))}};return Zt(t,n?{add:xa("add"),set:xa("set"),delete:xa("delete"),clear:xa("clear")}:{add(r){const s=Et(this),o=va(s),a=Et(r),l=!e&&!Qn(r)&&!ur(r)?a:r;return o.has.call(s,l)||Ci(r,l)&&o.has.call(s,r)||Ci(a,l)&&o.has.call(s,a)||(s.add(l),tr(s,"add",l,l)),this},set(r,s){!e&&!Qn(s)&&!ur(s)&&(s=Et(s));const o=Et(this),{has:a,get:l}=va(o);let c=a.call(o,r);c||(r=Et(r),c=a.call(o,r));const u=l.call(o,r);return o.set(r,s),c?Ci(s,u)&&tr(o,"set",r,s):tr(o,"add",r,s),this},delete(r){const s=Et(this),{has:o,get:a}=va(s);let l=o.call(s,r);l||(r=Et(r),l=o.call(s,r)),a&&a.call(s,r);const c=s.delete(r);return l&&tr(s,"delete",r,void 0),c},clear(){const r=Et(this),s=r.size!==0,o=r.clear();return s&&tr(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=tx(r,n,e)}),t}function ch(n,e){const t=nx(n,e);return(i,r,s)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?i:Reflect.get(wt(t,r)&&r in i?t:i,r,s)}const ix={get:ch(!1,!1)},rx={get:ch(!1,!0)},sx={get:ch(!0,!1)};const Lg=new WeakMap,Ig=new WeakMap,Dg=new WeakMap,ox=new WeakMap;function ax(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function lx(n){return n.__v_skip||!Object.isExtensible(n)?0:ax(Lv(n))}function uh(n){return ur(n)?n:fh(n,!1,Zv,ix,Lg)}function cx(n){return fh(n,!1,ex,rx,Ig)}function Vu(n){return fh(n,!0,Qv,sx,Dg)}function fh(n,e,t,i,r){if(!Rt(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const s=lx(n);if(s===0)return n;const o=r.get(n);if(o)return o;const a=new Proxy(n,s===2?i:t);return r.set(n,a),a}function rs(n){return ur(n)?rs(n.__v_raw):!!(n&&n.__v_isReactive)}function ur(n){return!!(n&&n.__v_isReadonly)}function Qn(n){return!!(n&&n.__v_isShallow)}function hh(n){return n?!!n.__v_raw:!1}function Et(n){const e=n&&n.__v_raw;return e?Et(e):n}function ux(n){return!wt(n,"__v_skip")&&Object.isExtensible(n)&&gg(n,"__v_skip",!0),n}const di=n=>Rt(n)?uh(n):n,Hs=n=>Rt(n)?Vu(n):n;function Sn(n){return n?n.__v_isRef===!0:!1}function sP(n){return Ng(n,!1)}function oP(n){return Ng(n,!0)}function Ng(n,e){return Sn(n)?n:new fx(n,e)}class fx{constructor(e,t){this.dep=new lh,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:Et(e),this._value=t?e:di(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,i=this.__v_isShallow||Qn(e)||ur(e);e=i?e:Et(e),Ci(e,t)&&(this._rawValue=e,this._value=i?e:di(e),this.dep.trigger())}}function hx(n){return Sn(n)?n.value:n}const dx={get:(n,e,t)=>e==="__v_raw"?n:hx(Reflect.get(n,e,t)),set:(n,e,t,i)=>{const r=n[e];return Sn(r)&&!Sn(t)?(r.value=t,!0):Reflect.set(n,e,t,i)}};function Ug(n){return rs(n)?n:new Proxy(n,dx)}class px{constructor(e,t,i){this.fn=e,this.setter=t,this._value=void 0,this.dep=new lh(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Wo-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&Ft!==this)return Mg(this,!0),!0}get value(){const e=this.dep.track();return Tg(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function mx(n,e,t=!1){let i,r;return ut(n)?i=n:(i=n.get,r=n.set),new px(i,r,t)}const ya={},gl=new WeakMap;let Kr;function gx(n,e=!1,t=Kr){if(t){let i=gl.get(t);i||gl.set(t,i=[]),i.push(n)}}function _x(n,e,t=Ut){const{immediate:i,deep:r,once:s,scheduler:o,augmentJob:a,call:l}=t,c=b=>r?b:Qn(b)||r===!1||r===0?nr(b,1):nr(b);let u,h,d,g,p=!1,x=!1;if(Sn(n)?(h=()=>n.value,p=Qn(n)):rs(n)?(h=()=>c(n),p=!0):nt(n)?(x=!0,p=n.some(b=>rs(b)||Qn(b)),h=()=>n.map(b=>{if(Sn(b))return b.value;if(rs(b))return c(b);if(ut(b))return l?l(b,2):b()})):ut(n)?e?h=l?()=>l(n,2):n:h=()=>{if(d){lr();try{d()}finally{cr()}}const b=Kr;Kr=u;try{return l?l(n,3,[g]):n(g)}finally{Kr=b}}:h=Di,e&&r){const b=h,I=r===!0?1/0:r;h=()=>nr(b(),I)}const m=Wv(),_=()=>{u.stop(),m&&m.active&&eh(m.effects,u)};if(s&&e){const b=e;e=(...I)=>{b(...I),_()}}let M=x?new Array(n.length).fill(ya):ya;const A=b=>{if(!(!(u.flags&1)||!u.dirty&&!b))if(e){const I=u.run();if(r||p||(x?I.some((D,B)=>Ci(D,M[B])):Ci(I,M))){d&&d();const D=Kr;Kr=u;try{const B=[I,M===ya?void 0:x&&M[0]===ya?[]:M,g];M=I,l?l(e,3,B):e(...B)}finally{Kr=D}}}else u.run()};return a&&a(A),u=new yg(h),u.scheduler=o?()=>o(A,!1):A,g=b=>gx(b,!1,u),d=u.onStop=()=>{const b=gl.get(u);if(b){if(l)l(b,4);else for(const I of b)I();gl.delete(u)}},e?i?A(!0):M=u.run():o?o(A.bind(null,!0),!0):u.run(),_.pause=u.pause.bind(u),_.resume=u.resume.bind(u),_.stop=_,_}function nr(n,e=1/0,t){if(e<=0||!Rt(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,Sn(n))nr(n.value,e,t);else if(nt(n))for(let i=0;i<n.length;i++)nr(n[i],e,t);else if(to(n)||Ds(n))n.forEach(i=>{nr(i,e,t)});else if(mg(n)){for(const i in n)nr(n[i],e,t);for(const i of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,i)&&nr(n[i],e,t)}return n}/**
* @vue/runtime-core v3.5.30
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function sa(n,e,t,i){try{return i?n(...i):n()}catch(r){Bl(r,e,t)}}function pi(n,e,t,i){if(ut(n)){const r=sa(n,e,t,i);return r&&dg(r)&&r.catch(s=>{Bl(s,e,t)}),r}if(nt(n)){const r=[];for(let s=0;s<n.length;s++)r.push(pi(n[s],e,t,i));return r}}function Bl(n,e,t,i=!0){const r=e?e.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||Ut;if(e){let a=e.parent;const l=e.proxy,c=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const u=a.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](n,l,c)===!1)return}a=a.parent}if(s){lr(),sa(s,null,10,[n,l,c]),cr();return}}vx(n,t,r,i,o)}function vx(n,e,t,i=!0,r=!1){if(r)throw n}const An=[];let bi=-1;const Ns=[];let Pr=null,Ls=0;const Og=Promise.resolve();let _l=null;function Fg(n){const e=_l||Og;return n?e.then(this?n.bind(this):n):e}function xx(n){let e=bi+1,t=An.length;for(;e<t;){const i=e+t>>>1,r=An[i],s=Xo(r);s<n||s===n&&r.flags&2?e=i+1:t=i}return e}function dh(n){if(!(n.flags&1)){const e=Xo(n),t=An[An.length-1];!t||!(n.flags&2)&&e>=Xo(t)?An.push(n):An.splice(xx(e),0,n),n.flags|=1,Bg()}}function Bg(){_l||(_l=Og.then(Vg))}function yx(n){nt(n)?Ns.push(...n):Pr&&n.id===-1?Pr.splice(Ls+1,0,n):n.flags&1||(Ns.push(n),n.flags|=1),Bg()}function gd(n,e,t=bi+1){for(;t<An.length;t++){const i=An[t];if(i&&i.flags&2){if(n&&i.id!==n.uid)continue;An.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function kg(n){if(Ns.length){const e=[...new Set(Ns)].sort((t,i)=>Xo(t)-Xo(i));if(Ns.length=0,Pr){Pr.push(...e);return}for(Pr=e,Ls=0;Ls<Pr.length;Ls++){const t=Pr[Ls];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Pr=null,Ls=0}}const Xo=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Vg(n){try{for(bi=0;bi<An.length;bi++){const e=An[bi];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),sa(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;bi<An.length;bi++){const e=An[bi];e&&(e.flags&=-2)}bi=-1,An.length=0,kg(),_l=null,(An.length||Ns.length)&&Vg()}}let ln=null,Hg=null;function vl(n){const e=ln;return ln=n,Hg=n&&n.type.__scopeId||null,e}function Sx(n,e=ln,t){if(!e||n._n)return n;const i=(...r)=>{i._d&&Sl(-1);const s=vl(e);let o;try{o=n(...r)}finally{vl(s),i._d&&Sl(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function aP(n,e){if(ln===null)return n;const t=Gl(ln),i=n.dirs||(n.dirs=[]);for(let r=0;r<e.length;r++){let[s,o,a,l=Ut]=e[r];s&&(ut(s)&&(s={mounted:s,updated:s}),s.deep&&nr(o),i.push({dir:s,instance:t,value:o,oldValue:void 0,arg:a,modifiers:l}))}return n}function Br(n,e,t,i){const r=n.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(lr(),pi(l,t,8,[n.el,a,n,e]),cr())}}function Mx(n,e){if(vn){let t=vn.provides;const i=vn.parent&&vn.parent.provides;i===t&&(t=vn.provides=Object.create(i)),t[n]=e}}function tl(n,e,t=!1){const i=xh();if(i||Os){let r=Os?Os._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(r&&n in r)return r[n];if(arguments.length>1)return t&&ut(e)?e.call(i&&i.proxy):e}}const bx=Symbol.for("v-scx"),Ex=()=>tl(bx);function mc(n,e,t){return zg(n,e,t)}function zg(n,e,t=Ut){const{immediate:i,deep:r,flush:s,once:o}=t,a=Zt({},t),l=e&&i||!e&&s!=="post";let c;if($o){if(s==="sync"){const g=Ex();c=g.__watcherHandles||(g.__watcherHandles=[])}else if(!l){const g=()=>{};return g.stop=Di,g.resume=Di,g.pause=Di,g}}const u=vn;a.call=(g,p,x)=>pi(g,u,p,x);let h=!1;s==="post"?a.scheduler=g=>{mn(g,u&&u.suspense)}:s!=="sync"&&(h=!0,a.scheduler=(g,p)=>{p?g():dh(g)}),a.augmentJob=g=>{e&&(g.flags|=4),h&&(g.flags|=2,u&&(g.id=u.uid,g.i=u))};const d=_x(n,e,a);return $o&&(c?c.push(d):l&&d()),d}function Tx(n,e,t){const i=this.proxy,r=Wt(n)?n.includes(".")?Gg(i,n):()=>i[n]:n.bind(i,i);let s;ut(e)?s=e:(s=e.handler,t=e);const o=oa(this),a=zg(r,s.bind(i),t);return o(),a}function Gg(n,e){const t=e.split(".");return()=>{let i=n;for(let r=0;r<t.length&&i;r++)i=i[t[r]];return i}}const Wg=Symbol("_vte"),jg=n=>n.__isTeleport,Bo=n=>n&&(n.disabled||n.disabled===""),_d=n=>n&&(n.defer||n.defer===""),vd=n=>typeof SVGElement<"u"&&n instanceof SVGElement,xd=n=>typeof MathMLElement=="function"&&n instanceof MathMLElement,Hu=(n,e)=>{const t=n&&n.to;return Wt(t)?e?e(t):null:t},Xg={name:"Teleport",__isTeleport:!0,process(n,e,t,i,r,s,o,a,l,c){const{mc:u,pc:h,pbc:d,o:{insert:g,querySelector:p,createText:x,createComment:m}}=c,_=Bo(e.props);let{shapeFlag:M,children:A,dynamicChildren:b}=e;if(n==null){const I=e.el=x(""),D=e.anchor=x("");g(I,t,i),g(D,t,i);const B=(w,L)=>{M&16&&u(A,w,L,r,s,o,a,l)},E=()=>{const w=e.target=Hu(e.props,p),L=zu(w,e,x,g);w&&(o!=="svg"&&vd(w)?o="svg":o!=="mathml"&&xd(w)&&(o="mathml"),r&&r.isCE&&(r.ce._teleportTargets||(r.ce._teleportTargets=new Set)).add(w),_||(B(w,L),nl(e,!1)))};_&&(B(t,D),nl(e,!0)),_d(e.props)?(e.el.__isMounted=!1,mn(()=>{E(),delete e.el.__isMounted},s)):E()}else{if(_d(e.props)&&n.el.__isMounted===!1){mn(()=>{Xg.process(n,e,t,i,r,s,o,a,l,c)},s);return}e.el=n.el,e.targetStart=n.targetStart;const I=e.anchor=n.anchor,D=e.target=n.target,B=e.targetAnchor=n.targetAnchor,E=Bo(n.props),w=E?t:D,L=E?I:B;if(o==="svg"||vd(D)?o="svg":(o==="mathml"||xd(D))&&(o="mathml"),b?(d(n.dynamicChildren,b,w,r,s,o,a),_h(n,e,!0)):l||h(n,e,w,L,r,s,o,a,!1),_)E?e.props&&n.props&&e.props.to!==n.props.to&&(e.props.to=n.props.to):Sa(e,t,I,c,1);else if((e.props&&e.props.to)!==(n.props&&n.props.to)){const R=e.target=Hu(e.props,p);R&&Sa(e,R,null,c,0)}else E&&Sa(e,D,B,c,1);nl(e,_)}},remove(n,e,t,{um:i,o:{remove:r}},s){const{shapeFlag:o,children:a,anchor:l,targetStart:c,targetAnchor:u,target:h,props:d}=n;if(h&&(r(c),r(u)),s&&r(l),o&16){const g=s||!Bo(d);for(let p=0;p<a.length;p++){const x=a[p];i(x,e,t,g,!!x.dynamicChildren)}}},move:Sa,hydrate:Ax};function Sa(n,e,t,{o:{insert:i},m:r},s=2){s===0&&i(n.targetAnchor,e,t);const{el:o,anchor:a,shapeFlag:l,children:c,props:u}=n,h=s===2;if(h&&i(o,e,t),(!h||Bo(u))&&l&16)for(let d=0;d<c.length;d++)r(c[d],e,t,2);h&&i(a,e,t)}function Ax(n,e,t,i,r,s,{o:{nextSibling:o,parentNode:a,querySelector:l,insert:c,createText:u}},h){function d(m,_){let M=_;for(;M;){if(M&&M.nodeType===8){if(M.data==="teleport start anchor")e.targetStart=M;else if(M.data==="teleport anchor"){e.targetAnchor=M,m._lpa=e.targetAnchor&&o(e.targetAnchor);break}}M=o(M)}}function g(m,_){_.anchor=h(o(m),_,a(m),t,i,r,s)}const p=e.target=Hu(e.props,l),x=Bo(e.props);if(p){const m=p._lpa||p.firstChild;e.shapeFlag&16&&(x?(g(n,e),d(p,m),e.targetAnchor||zu(p,e,u,c,a(n)===p?n:null)):(e.anchor=o(n),d(p,m),e.targetAnchor||zu(p,e,u,c),h(m&&o(m),e,p,t,i,r,s))),nl(e,x)}else x&&e.shapeFlag&16&&(g(n,e),e.targetStart=n,e.targetAnchor=o(n));return e.anchor&&o(e.anchor)}const lP=Xg;function nl(n,e){const t=n.ctx;if(t&&t.ut){let i,r;for(e?(i=n.el,r=n.anchor):(i=n.targetStart,r=n.targetAnchor);i&&i!==r;)i.nodeType===1&&i.setAttribute("data-v-owner",t.uid),i=i.nextSibling;t.ut()}}function zu(n,e,t,i,r=null){const s=e.targetStart=t(""),o=e.targetAnchor=t("");return s[Wg]=o,n&&(i(s,n,r),i(o,n,r)),o}const Ti=Symbol("_leaveCb"),_o=Symbol("_enterCb");function qg(){const n={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return e_(()=>{n.isMounted=!0}),n_(()=>{n.isUnmounting=!0}),n}const Xn=[Function,Array],Kg={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Xn,onEnter:Xn,onAfterEnter:Xn,onEnterCancelled:Xn,onBeforeLeave:Xn,onLeave:Xn,onAfterLeave:Xn,onLeaveCancelled:Xn,onBeforeAppear:Xn,onAppear:Xn,onAfterAppear:Xn,onAppearCancelled:Xn},Yg=n=>{const e=n.subTree;return e.component?Yg(e.component):e},wx={name:"BaseTransition",props:Kg,setup(n,{slots:e}){const t=xh(),i=qg();return()=>{const r=e.default&&ph(e.default(),!0);if(!r||!r.length)return;const s=$g(r),o=Et(n),{mode:a}=o;if(i.isLeaving)return gc(s);const l=yd(s);if(!l)return gc(s);let c=qo(l,o,i,t,h=>c=h);l.type!==_n&&os(l,c);let u=t.subTree&&yd(t.subTree);if(u&&u.type!==_n&&!$r(u,l)&&Yg(t).type!==_n){let h=qo(u,o,i,t);if(os(u,h),a==="out-in"&&l.type!==_n)return i.isLeaving=!0,h.afterLeave=()=>{i.isLeaving=!1,t.job.flags&8||t.update(),delete h.afterLeave,u=void 0},gc(s);a==="in-out"&&l.type!==_n?h.delayLeave=(d,g,p)=>{const x=Jg(i,u);x[String(u.key)]=u,d[Ti]=()=>{g(),d[Ti]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{p(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return s}}};function $g(n){let e=n[0];if(n.length>1){for(const t of n)if(t.type!==_n){e=t;break}}return e}const Rx=wx;function Jg(n,e){const{leavingVNodes:t}=n;let i=t.get(e.type);return i||(i=Object.create(null),t.set(e.type,i)),i}function qo(n,e,t,i,r){const{appear:s,mode:o,persisted:a=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:h,onBeforeLeave:d,onLeave:g,onAfterLeave:p,onLeaveCancelled:x,onBeforeAppear:m,onAppear:_,onAfterAppear:M,onAppearCancelled:A}=e,b=String(n.key),I=Jg(t,n),D=(w,L)=>{w&&pi(w,i,9,L)},B=(w,L)=>{const R=L[1];D(w,L),nt(w)?w.every(U=>U.length<=1)&&R():w.length<=1&&R()},E={mode:o,persisted:a,beforeEnter(w){let L=l;if(!t.isMounted)if(s)L=m||l;else return;w[Ti]&&w[Ti](!0);const R=I[b];R&&$r(n,R)&&R.el[Ti]&&R.el[Ti](),D(L,[w])},enter(w){if(I[b]===n)return;let L=c,R=u,U=h;if(!t.isMounted)if(s)L=_||c,R=M||u,U=A||h;else return;let H=!1;w[_o]=J=>{H||(H=!0,J?D(U,[w]):D(R,[w]),E.delayedLeave&&E.delayedLeave(),w[_o]=void 0)};const q=w[_o].bind(null,!1);L?B(L,[w,q]):q()},leave(w,L){const R=String(n.key);if(w[_o]&&w[_o](!0),t.isUnmounting)return L();D(d,[w]);let U=!1;w[Ti]=q=>{U||(U=!0,L(),q?D(x,[w]):D(p,[w]),w[Ti]=void 0,I[R]===n&&delete I[R])};const H=w[Ti].bind(null,!1);I[R]=n,g?B(g,[w,H]):H()},clone(w){const L=qo(w,e,t,i,r);return r&&r(L),L}};return E}function gc(n){if(kl(n))return n=Nr(n),n.children=null,n}function yd(n){if(!kl(n))return jg(n.type)&&n.children?$g(n.children):n;if(n.component)return n.component.subTree;const{shapeFlag:e,children:t}=n;if(t){if(e&16)return t[0];if(e&32&&ut(t.default))return t.default()}}function os(n,e){n.shapeFlag&6&&n.component?(n.transition=e,os(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function ph(n,e=!1,t){let i=[],r=0;for(let s=0;s<n.length;s++){let o=n[s];const a=t==null?o.key:String(t)+String(o.key!=null?o.key:s);o.type===In?(o.patchFlag&128&&r++,i=i.concat(ph(o.children,e,a))):(e||o.type!==_n)&&i.push(a!=null?Nr(o,{key:a}):o)}if(r>1)for(let s=0;s<i.length;s++)i[s].patchFlag=-2;return i}function cP(n,e){return ut(n)?Zt({name:n.name},e,{setup:n}):n}function Zg(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Sd(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const xl=new WeakMap;function ko(n,e,t,i,r=!1){if(nt(n)){n.forEach((x,m)=>ko(x,e&&(nt(e)?e[m]:e),t,i,r));return}if(Us(i)&&!r){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&ko(n,e,t,i.component.subTree);return}const s=i.shapeFlag&4?Gl(i.component):i.el,o=r?null:s,{i:a,r:l}=n,c=e&&e.r,u=a.refs===Ut?a.refs={}:a.refs,h=a.setupState,d=Et(h),g=h===Ut?hg:x=>Sd(u,x)?!1:wt(d,x),p=(x,m)=>!(m&&Sd(u,m));if(c!=null&&c!==l){if(Md(e),Wt(c))u[c]=null,g(c)&&(h[c]=null);else if(Sn(c)){const x=e;p(c,x.k)&&(c.value=null),x.k&&(u[x.k]=null)}}if(ut(l))sa(l,a,12,[o,u]);else{const x=Wt(l),m=Sn(l);if(x||m){const _=()=>{if(n.f){const M=x?g(l)?h[l]:u[l]:p()||!n.k?l.value:u[n.k];if(r)nt(M)&&eh(M,s);else if(nt(M))M.includes(s)||M.push(s);else if(x)u[l]=[s],g(l)&&(h[l]=u[l]);else{const A=[s];p(l,n.k)&&(l.value=A),n.k&&(u[n.k]=A)}}else x?(u[l]=o,g(l)&&(h[l]=o)):m&&(p(l,n.k)&&(l.value=o),n.k&&(u[n.k]=o))};if(o){const M=()=>{_(),xl.delete(n)};M.id=-1,xl.set(n,M),mn(M,t)}else Md(n),_()}}}function Md(n){const e=xl.get(n);e&&(e.flags|=8,xl.delete(n))}Ol().requestIdleCallback;Ol().cancelIdleCallback;const Us=n=>!!n.type.__asyncLoader,kl=n=>n.type.__isKeepAlive;function Cx(n,e){Qg(n,"a",e)}function Px(n,e){Qg(n,"da",e)}function Qg(n,e,t=vn){const i=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(Vl(e,i,t),t){let r=t.parent;for(;r&&r.parent;)kl(r.parent.vnode)&&Lx(i,e,t,r),r=r.parent}}function Lx(n,e,t,i){const r=Vl(e,n,i,!0);i_(()=>{eh(i[e],r)},t)}function Vl(n,e,t=vn,i=!1){if(t){const r=t[n]||(t[n]=[]),s=e.__weh||(e.__weh=(...o)=>{lr();const a=oa(t),l=pi(e,t,n,o);return a(),cr(),l});return i?r.unshift(s):r.push(s),s}}const pr=n=>(e,t=vn)=>{(!$o||n==="sp")&&Vl(n,(...i)=>e(...i),t)},Ix=pr("bm"),e_=pr("m"),Dx=pr("bu"),t_=pr("u"),n_=pr("bum"),i_=pr("um"),Nx=pr("sp"),Ux=pr("rtg"),Ox=pr("rtc");function Fx(n,e=vn){Vl("ec",n,e)}const Bx="components";function uP(n,e){return Vx(Bx,n,!0,e)||n}const kx=Symbol.for("v-ndc");function Vx(n,e,t=!0,i=!1){const r=ln||vn;if(r){const s=r.type;{const a=Ty(s,!1);if(a&&(a===e||a===wn(e)||a===Nl(wn(e))))return s}const o=bd(r[n]||s[n],e)||bd(r.appContext[n],e);return!o&&i?s:o}}function bd(n,e){return n&&(n[e]||n[wn(e)]||n[Nl(wn(e))])}function fP(n,e,t,i){let r;const s=t,o=nt(n);if(o||Wt(n)){const a=o&&rs(n);let l=!1,c=!1;a&&(l=!Qn(n),c=ur(n),n=Fl(n)),r=new Array(n.length);for(let u=0,h=n.length;u<h;u++)r[u]=e(l?c?Hs(di(n[u])):di(n[u]):n[u],u,void 0,s)}else if(typeof n=="number"){r=new Array(n);for(let a=0;a<n;a++)r[a]=e(a+1,a,void 0,s)}else if(Rt(n))if(n[Symbol.iterator])r=Array.from(n,(a,l)=>e(a,l,void 0,s));else{const a=Object.keys(n);r=new Array(a.length);for(let l=0,c=a.length;l<c;l++){const u=a[l];r[l]=e(n[u],u,l,s)}}else r=[];return r}function hP(n,e,t={},i,r){if(ln.ce||ln.parent&&Us(ln.parent)&&ln.parent.ce){const c=Object.keys(t).length>0;return qu(),Ku(In,null,[yn("slot",t,i)],c?-2:64)}let s=n[e];s&&s._c&&(s._d=!1),qu();const o=s&&r_(s(t)),a=t.key||o&&o.key,l=Ku(In,{key:(a&&!hi(a)?a:`_${e}`)+(!o&&i?"_fb":"")},o||[],o&&n._===1?64:-2);return s&&s._c&&(s._d=!0),l}function r_(n){return n.some(e=>Yo(e)?!(e.type===_n||e.type===In&&!r_(e.children)):!0)?n:null}const Gu=n=>n?E_(n)?Gl(n):Gu(n.parent):null,Vo=Zt(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Gu(n.parent),$root:n=>Gu(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>o_(n),$forceUpdate:n=>n.f||(n.f=()=>{dh(n.update)}),$nextTick:n=>n.n||(n.n=Fg.bind(n.proxy)),$watch:n=>Tx.bind(n)}),_c=(n,e)=>n!==Ut&&!n.__isScriptSetup&&wt(n,e),Hx={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=n;if(e[0]!=="$"){const d=o[e];if(d!==void 0)switch(d){case 1:return i[e];case 2:return r[e];case 4:return t[e];case 3:return s[e]}else{if(_c(i,e))return o[e]=1,i[e];if(r!==Ut&&wt(r,e))return o[e]=2,r[e];if(wt(s,e))return o[e]=3,s[e];if(t!==Ut&&wt(t,e))return o[e]=4,t[e];Wu&&(o[e]=0)}}const c=Vo[e];let u,h;if(c)return e==="$attrs"&&gn(n.attrs,"get",""),c(n);if((u=a.__cssModules)&&(u=u[e]))return u;if(t!==Ut&&wt(t,e))return o[e]=4,t[e];if(h=l.config.globalProperties,wt(h,e))return h[e]},set({_:n},e,t){const{data:i,setupState:r,ctx:s}=n;return _c(r,e)?(r[e]=t,!0):i!==Ut&&wt(i,e)?(i[e]=t,!0):wt(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(s[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:i,appContext:r,props:s,type:o}},a){let l;return!!(t[a]||n!==Ut&&a[0]!=="$"&&wt(n,a)||_c(e,a)||wt(s,a)||wt(i,a)||wt(Vo,a)||wt(r.config.globalProperties,a)||(l=o.__cssModules)&&l[a])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:wt(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Ed(n){return nt(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Wu=!0;function zx(n){const e=o_(n),t=n.proxy,i=n.ctx;Wu=!1,e.beforeCreate&&Td(e.beforeCreate,n,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:h,mounted:d,beforeUpdate:g,updated:p,activated:x,deactivated:m,beforeDestroy:_,beforeUnmount:M,destroyed:A,unmounted:b,render:I,renderTracked:D,renderTriggered:B,errorCaptured:E,serverPrefetch:w,expose:L,inheritAttrs:R,components:U,directives:H,filters:q}=e;if(c&&Gx(c,i,null),o)for(const j in o){const ie=o[j];ut(ie)&&(i[j]=ie.bind(t))}if(r){const j=r.call(t,t);Rt(j)&&(n.data=uh(j))}if(Wu=!0,s)for(const j in s){const ie=s[j],X=ut(ie)?ie.bind(t,t):ut(ie.get)?ie.get.bind(t,t):Di,$=!ut(ie)&&ut(ie.set)?ie.set.bind(t):Di,ne=wy({get:X,set:$});Object.defineProperty(i,j,{enumerable:!0,configurable:!0,get:()=>ne.value,set:fe=>ne.value=fe})}if(a)for(const j in a)s_(a[j],i,t,j);if(l){const j=ut(l)?l.call(t):l;Reflect.ownKeys(j).forEach(ie=>{Mx(ie,j[ie])})}u&&Td(u,n,"c");function O(j,ie){nt(ie)?ie.forEach(X=>j(X.bind(t))):ie&&j(ie.bind(t))}if(O(Ix,h),O(e_,d),O(Dx,g),O(t_,p),O(Cx,x),O(Px,m),O(Fx,E),O(Ox,D),O(Ux,B),O(n_,M),O(i_,b),O(Nx,w),nt(L))if(L.length){const j=n.exposed||(n.exposed={});L.forEach(ie=>{Object.defineProperty(j,ie,{get:()=>t[ie],set:X=>t[ie]=X,enumerable:!0})})}else n.exposed||(n.exposed={});I&&n.render===Di&&(n.render=I),R!=null&&(n.inheritAttrs=R),U&&(n.components=U),H&&(n.directives=H),w&&Zg(n)}function Gx(n,e,t=Di){nt(n)&&(n=ju(n));for(const i in n){const r=n[i];let s;Rt(r)?"default"in r?s=tl(r.from||i,r.default,!0):s=tl(r.from||i):s=tl(r),Sn(s)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[i]=s}}function Td(n,e,t){pi(nt(n)?n.map(i=>i.bind(e.proxy)):n.bind(e.proxy),e,t)}function s_(n,e,t,i){let r=i.includes(".")?Gg(t,i):()=>t[i];if(Wt(n)){const s=e[n];ut(s)&&mc(r,s)}else if(ut(n))mc(r,n.bind(t));else if(Rt(n))if(nt(n))n.forEach(s=>s_(s,e,t,i));else{const s=ut(n.handler)?n.handler.bind(t):e[n.handler];ut(s)&&mc(r,s,n)}}function o_(n){const e=n.type,{mixins:t,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=n.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!t&&!i?l=e:(l={},r.length&&r.forEach(c=>yl(l,c,o,!0)),yl(l,e,o)),Rt(e)&&s.set(e,l),l}function yl(n,e,t,i=!1){const{mixins:r,extends:s}=e;s&&yl(n,s,t,!0),r&&r.forEach(o=>yl(n,o,t,!0));for(const o in e)if(!(i&&o==="expose")){const a=Wx[o]||t&&t[o];n[o]=a?a(n[o],e[o]):e[o]}return n}const Wx={data:Ad,props:wd,emits:wd,methods:Lo,computed:Lo,beforeCreate:En,created:En,beforeMount:En,mounted:En,beforeUpdate:En,updated:En,beforeDestroy:En,beforeUnmount:En,destroyed:En,unmounted:En,activated:En,deactivated:En,errorCaptured:En,serverPrefetch:En,components:Lo,directives:Lo,watch:Xx,provide:Ad,inject:jx};function Ad(n,e){return e?n?function(){return Zt(ut(n)?n.call(this,this):n,ut(e)?e.call(this,this):e)}:e:n}function jx(n,e){return Lo(ju(n),ju(e))}function ju(n){if(nt(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function En(n,e){return n?[...new Set([].concat(n,e))]:e}function Lo(n,e){return n?Zt(Object.create(null),n,e):e}function wd(n,e){return n?nt(n)&&nt(e)?[...new Set([...n,...e])]:Zt(Object.create(null),Ed(n),Ed(e??{})):e}function Xx(n,e){if(!n)return e;if(!e)return n;const t=Zt(Object.create(null),n);for(const i in e)t[i]=En(n[i],e[i]);return t}function a_(){return{app:null,config:{isNativeTag:hg,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let qx=0;function Kx(n,e){return function(i,r=null){ut(i)||(i=Zt({},i)),r!=null&&!Rt(r)&&(r=null);const s=a_(),o=new WeakSet,a=[];let l=!1;const c=s.app={_uid:qx++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:Cy,get config(){return s.config},set config(u){},use(u,...h){return o.has(u)||(u&&ut(u.install)?(o.add(u),u.install(c,...h)):ut(u)&&(o.add(u),u(c,...h))),c},mixin(u){return s.mixins.includes(u)||s.mixins.push(u),c},component(u,h){return h?(s.components[u]=h,c):s.components[u]},directive(u,h){return h?(s.directives[u]=h,c):s.directives[u]},mount(u,h,d){if(!l){const g=c._ceVNode||yn(i,r);return g.appContext=s,d===!0?d="svg":d===!1&&(d=void 0),n(g,u,d),l=!0,c._container=u,u.__vue_app__=c,Gl(g.component)}},onUnmount(u){a.push(u)},unmount(){l&&(pi(a,c._instance,16),n(null,c._container),delete c._container.__vue_app__)},provide(u,h){return s.provides[u]=h,c},runWithContext(u){const h=Os;Os=c;try{return u()}finally{Os=h}}};return c}}let Os=null;const Yx=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${wn(e)}Modifiers`]||n[`${Or(e)}Modifiers`];function $x(n,e,...t){if(n.isUnmounted)return;const i=n.vnode.props||Ut;let r=t;const s=e.startsWith("update:"),o=s&&Yx(i,e.slice(7));o&&(o.trim&&(r=t.map(u=>Wt(u)?u.trim():u)),o.number&&(r=t.map(Ul)));let a,l=i[a=uc(e)]||i[a=uc(wn(e))];!l&&s&&(l=i[a=uc(Or(e))]),l&&pi(l,n,6,r);const c=i[a+"Once"];if(c){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,pi(c,n,6,r)}}const Jx=new WeakMap;function l_(n,e,t=!1){const i=t?Jx:e.emitsCache,r=i.get(n);if(r!==void 0)return r;const s=n.emits;let o={},a=!1;if(!ut(n)){const l=c=>{const u=l_(c,e,!0);u&&(a=!0,Zt(o,u))};!t&&e.mixins.length&&e.mixins.forEach(l),n.extends&&l(n.extends),n.mixins&&n.mixins.forEach(l)}return!s&&!a?(Rt(n)&&i.set(n,null),null):(nt(s)?s.forEach(l=>o[l]=null):Zt(o,s),Rt(n)&&i.set(n,o),o)}function Hl(n,e){return!n||!Il(e)?!1:(e=e.slice(2).replace(/Once$/,""),wt(n,e[0].toLowerCase()+e.slice(1))||wt(n,Or(e))||wt(n,e))}function Rd(n){const{type:e,vnode:t,proxy:i,withProxy:r,propsOptions:[s],slots:o,attrs:a,emit:l,render:c,renderCache:u,props:h,data:d,setupState:g,ctx:p,inheritAttrs:x}=n,m=vl(n);let _,M;try{if(t.shapeFlag&4){const b=r||i,I=b;_=wi(c.call(I,b,u,h,g,d,p)),M=a}else{const b=e;_=wi(b.length>1?b(h,{attrs:a,slots:o,emit:l}):b(h,null)),M=e.props?a:Zx(a)}}catch(b){Ho.length=0,Bl(b,n,1),_=yn(_n)}let A=_;if(M&&x!==!1){const b=Object.keys(M),{shapeFlag:I}=A;b.length&&I&7&&(s&&b.some(Qf)&&(M=Qx(M,s)),A=Nr(A,M,!1,!0))}return t.dirs&&(A=Nr(A,null,!1,!0),A.dirs=A.dirs?A.dirs.concat(t.dirs):t.dirs),t.transition&&os(A,t.transition),_=A,vl(m),_}const Zx=n=>{let e;for(const t in n)(t==="class"||t==="style"||Il(t))&&((e||(e={}))[t]=n[t]);return e},Qx=(n,e)=>{const t={};for(const i in n)(!Qf(i)||!(i.slice(9)in e))&&(t[i]=n[i]);return t};function ey(n,e,t){const{props:i,children:r,component:s}=n,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?Cd(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(c_(o,i,d)&&!Hl(c,d))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?Cd(i,o,c):!0:!!o;return!1}function Cd(n,e,t){const i=Object.keys(e);if(i.length!==Object.keys(n).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(c_(e,n,s)&&!Hl(t,s))return!0}return!1}function c_(n,e,t){const i=n[t],r=e[t];return t==="style"&&Rt(i)&&Rt(r)?!Dr(i,r):i!==r}function ty({vnode:n,parent:e},t){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.el=n.el),i===n)(n=e.vnode).el=t,e=e.parent;else break}}const u_={},f_=()=>Object.create(u_),h_=n=>Object.getPrototypeOf(n)===u_;function ny(n,e,t,i=!1){const r={},s=f_();n.propsDefaults=Object.create(null),d_(n,e,r,s);for(const o in n.propsOptions[0])o in r||(r[o]=void 0);t?n.props=i?r:cx(r):n.type.props?n.props=r:n.props=s,n.attrs=s}function iy(n,e,t,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=n,a=Et(r),[l]=n.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=n.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(Hl(n.emitsOptions,d))continue;const g=e[d];if(l)if(wt(s,d))g!==s[d]&&(s[d]=g,c=!0);else{const p=wn(d);r[p]=Xu(l,a,p,g,n,!1)}else g!==s[d]&&(s[d]=g,c=!0)}}}else{d_(n,e,r,s)&&(c=!0);let u;for(const h in a)(!e||!wt(e,h)&&((u=Or(h))===h||!wt(e,u)))&&(l?t&&(t[h]!==void 0||t[u]!==void 0)&&(r[h]=Xu(l,a,h,void 0,n,!0)):delete r[h]);if(s!==a)for(const h in s)(!e||!wt(e,h))&&(delete s[h],c=!0)}c&&tr(n.attrs,"set","")}function d_(n,e,t,i){const[r,s]=n.propsOptions;let o=!1,a;if(e)for(let l in e){if(Uo(l))continue;const c=e[l];let u;r&&wt(r,u=wn(l))?!s||!s.includes(u)?t[u]=c:(a||(a={}))[u]=c:Hl(n.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=Et(t),c=a||Ut;for(let u=0;u<s.length;u++){const h=s[u];t[h]=Xu(r,l,h,c[h],n,!wt(c,h))}}return o}function Xu(n,e,t,i,r,s){const o=n[t];if(o!=null){const a=wt(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&ut(l)){const{propsDefaults:c}=r;if(t in c)i=c[t];else{const u=oa(r);i=c[t]=l.call(null,e),u()}}else i=l;r.ce&&r.ce._setProp(t,i)}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===Or(t))&&(i=!0))}return i}const ry=new WeakMap;function p_(n,e,t=!1){const i=t?ry:e.propsCache,r=i.get(n);if(r)return r;const s=n.props,o={},a=[];let l=!1;if(!ut(n)){const u=h=>{l=!0;const[d,g]=p_(h,e,!0);Zt(o,d),g&&a.push(...g)};!t&&e.mixins.length&&e.mixins.forEach(u),n.extends&&u(n.extends),n.mixins&&n.mixins.forEach(u)}if(!s&&!l)return Rt(n)&&i.set(n,Is),Is;if(nt(s))for(let u=0;u<s.length;u++){const h=wn(s[u]);Pd(h)&&(o[h]=Ut)}else if(s)for(const u in s){const h=wn(u);if(Pd(h)){const d=s[u],g=o[h]=nt(d)||ut(d)?{type:d}:Zt({},d),p=g.type;let x=!1,m=!0;if(nt(p))for(let _=0;_<p.length;++_){const M=p[_],A=ut(M)&&M.name;if(A==="Boolean"){x=!0;break}else A==="String"&&(m=!1)}else x=ut(p)&&p.name==="Boolean";g[0]=x,g[1]=m,(x||wt(g,"default"))&&a.push(h)}}const c=[o,a];return Rt(n)&&i.set(n,c),c}function Pd(n){return n[0]!=="$"&&!Uo(n)}const mh=n=>n==="_"||n==="_ctx"||n==="$stable",gh=n=>nt(n)?n.map(wi):[wi(n)],sy=(n,e,t)=>{if(e._n)return e;const i=Sx((...r)=>gh(e(...r)),t);return i._c=!1,i},m_=(n,e,t)=>{const i=n._ctx;for(const r in n){if(mh(r))continue;const s=n[r];if(ut(s))e[r]=sy(r,s,i);else if(s!=null){const o=gh(s);e[r]=()=>o}}},g_=(n,e)=>{const t=gh(e);n.slots.default=()=>t},__=(n,e,t)=>{for(const i in e)(t||!mh(i))&&(n[i]=e[i])},oy=(n,e,t)=>{const i=n.slots=f_();if(n.vnode.shapeFlag&32){const r=e._;r?(__(i,e,t),t&&gg(i,"_",r,!0)):m_(e,i)}else e&&g_(n,e)},ay=(n,e,t)=>{const{vnode:i,slots:r}=n;let s=!0,o=Ut;if(i.shapeFlag&32){const a=e._;a?t&&a===1?s=!1:__(r,e,t):(s=!e.$stable,m_(e,r)),o=e}else e&&(g_(n,e),o={default:1});if(s)for(const a in r)!mh(a)&&o[a]==null&&delete r[a]},mn=hy;function ly(n){return cy(n)}function cy(n,e){const t=Ol();t.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:h,nextSibling:d,setScopeId:g=Di,insertStaticContent:p}=n,x=(k,z,Z,ge=null,ae=null,_e=null,N=void 0,Ee=null,ve=!!z.dynamicChildren)=>{if(k===z)return;k&&!$r(k,z)&&(ge=Se(k),fe(k,ae,_e,!0),k=null),z.patchFlag===-2&&(ve=!1,z.dynamicChildren=null);const{type:me,ref:xe,shapeFlag:C}=z;switch(me){case zl:m(k,z,Z,ge);break;case _n:_(k,z,Z,ge);break;case il:k==null&&M(z,Z,ge,N);break;case In:U(k,z,Z,ge,ae,_e,N,Ee,ve);break;default:C&1?I(k,z,Z,ge,ae,_e,N,Ee,ve):C&6?H(k,z,Z,ge,ae,_e,N,Ee,ve):(C&64||C&128)&&me.process(k,z,Z,ge,ae,_e,N,Ee,ve,Ae)}xe!=null&&ae?ko(xe,k&&k.ref,_e,z||k,!z):xe==null&&k&&k.ref!=null&&ko(k.ref,null,_e,k,!0)},m=(k,z,Z,ge)=>{if(k==null)i(z.el=a(z.children),Z,ge);else{const ae=z.el=k.el;z.children!==k.children&&c(ae,z.children)}},_=(k,z,Z,ge)=>{k==null?i(z.el=l(z.children||""),Z,ge):z.el=k.el},M=(k,z,Z,ge)=>{[k.el,k.anchor]=p(k.children,z,Z,ge,k.el,k.anchor)},A=({el:k,anchor:z},Z,ge)=>{let ae;for(;k&&k!==z;)ae=d(k),i(k,Z,ge),k=ae;i(z,Z,ge)},b=({el:k,anchor:z})=>{let Z;for(;k&&k!==z;)Z=d(k),r(k),k=Z;r(z)},I=(k,z,Z,ge,ae,_e,N,Ee,ve)=>{if(z.type==="svg"?N="svg":z.type==="math"&&(N="mathml"),k==null)D(z,Z,ge,ae,_e,N,Ee,ve);else{const me=k.el&&k.el._isVueCE?k.el:null;try{me&&me._beginPatch(),w(k,z,ae,_e,N,Ee,ve)}finally{me&&me._endPatch()}}},D=(k,z,Z,ge,ae,_e,N,Ee)=>{let ve,me;const{props:xe,shapeFlag:C,transition:S,dirs:W}=k;if(ve=k.el=o(k.type,_e,xe&&xe.is,xe),C&8?u(ve,k.children):C&16&&E(k.children,ve,null,ge,ae,vc(k,_e),N,Ee),W&&Br(k,null,ge,"created"),B(ve,k,k.scopeId,N,ge),xe){for(const de in xe)de!=="value"&&!Uo(de)&&s(ve,de,null,xe[de],_e,ge);"value"in xe&&s(ve,"value",null,xe.value,_e),(me=xe.onVnodeBeforeMount)&&xi(me,ge,k)}W&&Br(k,null,ge,"beforeMount");const re=uy(ae,S);re&&S.beforeEnter(ve),i(ve,z,Z),((me=xe&&xe.onVnodeMounted)||re||W)&&mn(()=>{me&&xi(me,ge,k),re&&S.enter(ve),W&&Br(k,null,ge,"mounted")},ae)},B=(k,z,Z,ge,ae)=>{if(Z&&g(k,Z),ge)for(let _e=0;_e<ge.length;_e++)g(k,ge[_e]);if(ae){let _e=ae.subTree;if(z===_e||y_(_e.type)&&(_e.ssContent===z||_e.ssFallback===z)){const N=ae.vnode;B(k,N,N.scopeId,N.slotScopeIds,ae.parent)}}},E=(k,z,Z,ge,ae,_e,N,Ee,ve=0)=>{for(let me=ve;me<k.length;me++){const xe=k[me]=Ee?er(k[me]):wi(k[me]);x(null,xe,z,Z,ge,ae,_e,N,Ee)}},w=(k,z,Z,ge,ae,_e,N)=>{const Ee=z.el=k.el;let{patchFlag:ve,dynamicChildren:me,dirs:xe}=z;ve|=k.patchFlag&16;const C=k.props||Ut,S=z.props||Ut;let W;if(Z&&kr(Z,!1),(W=S.onVnodeBeforeUpdate)&&xi(W,Z,z,k),xe&&Br(z,k,Z,"beforeUpdate"),Z&&kr(Z,!0),(C.innerHTML&&S.innerHTML==null||C.textContent&&S.textContent==null)&&u(Ee,""),me?L(k.dynamicChildren,me,Ee,Z,ge,vc(z,ae),_e):N||ie(k,z,Ee,null,Z,ge,vc(z,ae),_e,!1),ve>0){if(ve&16)R(Ee,C,S,Z,ae);else if(ve&2&&C.class!==S.class&&s(Ee,"class",null,S.class,ae),ve&4&&s(Ee,"style",C.style,S.style,ae),ve&8){const re=z.dynamicProps;for(let de=0;de<re.length;de++){const se=re[de],Ue=C[se],Te=S[se];(Te!==Ue||se==="value")&&s(Ee,se,Ue,Te,ae,Z)}}ve&1&&k.children!==z.children&&u(Ee,z.children)}else!N&&me==null&&R(Ee,C,S,Z,ae);((W=S.onVnodeUpdated)||xe)&&mn(()=>{W&&xi(W,Z,z,k),xe&&Br(z,k,Z,"updated")},ge)},L=(k,z,Z,ge,ae,_e,N)=>{for(let Ee=0;Ee<z.length;Ee++){const ve=k[Ee],me=z[Ee],xe=ve.el&&(ve.type===In||!$r(ve,me)||ve.shapeFlag&198)?h(ve.el):Z;x(ve,me,xe,null,ge,ae,_e,N,!0)}},R=(k,z,Z,ge,ae)=>{if(z!==Z){if(z!==Ut)for(const _e in z)!Uo(_e)&&!(_e in Z)&&s(k,_e,z[_e],null,ae,ge);for(const _e in Z){if(Uo(_e))continue;const N=Z[_e],Ee=z[_e];N!==Ee&&_e!=="value"&&s(k,_e,Ee,N,ae,ge)}"value"in Z&&s(k,"value",z.value,Z.value,ae)}},U=(k,z,Z,ge,ae,_e,N,Ee,ve)=>{const me=z.el=k?k.el:a(""),xe=z.anchor=k?k.anchor:a("");let{patchFlag:C,dynamicChildren:S,slotScopeIds:W}=z;W&&(Ee=Ee?Ee.concat(W):W),k==null?(i(me,Z,ge),i(xe,Z,ge),E(z.children||[],Z,xe,ae,_e,N,Ee,ve)):C>0&&C&64&&S&&k.dynamicChildren&&k.dynamicChildren.length===S.length?(L(k.dynamicChildren,S,Z,ae,_e,N,Ee),(z.key!=null||ae&&z===ae.subTree)&&_h(k,z,!0)):ie(k,z,Z,xe,ae,_e,N,Ee,ve)},H=(k,z,Z,ge,ae,_e,N,Ee,ve)=>{z.slotScopeIds=Ee,k==null?z.shapeFlag&512?ae.ctx.activate(z,Z,ge,N,ve):q(z,Z,ge,ae,_e,N,ve):J(k,z,ve)},q=(k,z,Z,ge,ae,_e,N)=>{const Ee=k.component=yy(k,ge,ae);if(kl(k)&&(Ee.ctx.renderer=Ae),Sy(Ee,!1,N),Ee.asyncDep){if(ae&&ae.registerDep(Ee,O,N),!k.el){const ve=Ee.subTree=yn(_n);_(null,ve,z,Z),k.placeholder=ve.el}}else O(Ee,k,z,Z,ae,_e,N)},J=(k,z,Z)=>{const ge=z.component=k.component;if(ey(k,z,Z))if(ge.asyncDep&&!ge.asyncResolved){j(ge,z,Z);return}else ge.next=z,ge.update();else z.el=k.el,ge.vnode=z},O=(k,z,Z,ge,ae,_e,N)=>{const Ee=()=>{if(k.isMounted){let{next:C,bu:S,u:W,parent:re,vnode:de}=k;{const $e=v_(k);if($e){C&&(C.el=de.el,j(k,C,N)),$e.asyncDep.then(()=>{mn(()=>{k.isUnmounted||me()},ae)});return}}let se=C,Ue;kr(k,!1),C?(C.el=de.el,j(k,C,N)):C=de,S&&el(S),(Ue=C.props&&C.props.onVnodeBeforeUpdate)&&xi(Ue,re,C,de),kr(k,!0);const Te=Rd(k),qe=k.subTree;k.subTree=Te,x(qe,Te,h(qe.el),Se(qe),k,ae,_e),C.el=Te.el,se===null&&ty(k,Te.el),W&&mn(W,ae),(Ue=C.props&&C.props.onVnodeUpdated)&&mn(()=>xi(Ue,re,C,de),ae)}else{let C;const{el:S,props:W}=z,{bm:re,m:de,parent:se,root:Ue,type:Te}=k,qe=Us(z);kr(k,!1),re&&el(re),!qe&&(C=W&&W.onVnodeBeforeMount)&&xi(C,se,z),kr(k,!0);{Ue.ce&&Ue.ce._hasShadowRoot()&&Ue.ce._injectChildStyle(Te,k.parent?k.parent.type:void 0);const $e=k.subTree=Rd(k);x(null,$e,Z,ge,k,ae,_e),z.el=$e.el}if(de&&mn(de,ae),!qe&&(C=W&&W.onVnodeMounted)){const $e=z;mn(()=>xi(C,se,$e),ae)}(z.shapeFlag&256||se&&Us(se.vnode)&&se.vnode.shapeFlag&256)&&k.a&&mn(k.a,ae),k.isMounted=!0,z=Z=ge=null}};k.scope.on();const ve=k.effect=new yg(Ee);k.scope.off();const me=k.update=ve.run.bind(ve),xe=k.job=ve.runIfDirty.bind(ve);xe.i=k,xe.id=k.uid,ve.scheduler=()=>dh(xe),kr(k,!0),me()},j=(k,z,Z)=>{z.component=k;const ge=k.vnode.props;k.vnode=z,k.next=null,iy(k,z.props,ge,Z),ay(k,z.children,Z),lr(),gd(k),cr()},ie=(k,z,Z,ge,ae,_e,N,Ee,ve=!1)=>{const me=k&&k.children,xe=k?k.shapeFlag:0,C=z.children,{patchFlag:S,shapeFlag:W}=z;if(S>0){if(S&128){$(me,C,Z,ge,ae,_e,N,Ee,ve);return}else if(S&256){X(me,C,Z,ge,ae,_e,N,Ee,ve);return}}W&8?(xe&16&&he(me,ae,_e),C!==me&&u(Z,C)):xe&16?W&16?$(me,C,Z,ge,ae,_e,N,Ee,ve):he(me,ae,_e,!0):(xe&8&&u(Z,""),W&16&&E(C,Z,ge,ae,_e,N,Ee,ve))},X=(k,z,Z,ge,ae,_e,N,Ee,ve)=>{k=k||Is,z=z||Is;const me=k.length,xe=z.length,C=Math.min(me,xe);let S;for(S=0;S<C;S++){const W=z[S]=ve?er(z[S]):wi(z[S]);x(k[S],W,Z,null,ae,_e,N,Ee,ve)}me>xe?he(k,ae,_e,!0,!1,C):E(z,Z,ge,ae,_e,N,Ee,ve,C)},$=(k,z,Z,ge,ae,_e,N,Ee,ve)=>{let me=0;const xe=z.length;let C=k.length-1,S=xe-1;for(;me<=C&&me<=S;){const W=k[me],re=z[me]=ve?er(z[me]):wi(z[me]);if($r(W,re))x(W,re,Z,null,ae,_e,N,Ee,ve);else break;me++}for(;me<=C&&me<=S;){const W=k[C],re=z[S]=ve?er(z[S]):wi(z[S]);if($r(W,re))x(W,re,Z,null,ae,_e,N,Ee,ve);else break;C--,S--}if(me>C){if(me<=S){const W=S+1,re=W<xe?z[W].el:ge;for(;me<=S;)x(null,z[me]=ve?er(z[me]):wi(z[me]),Z,re,ae,_e,N,Ee,ve),me++}}else if(me>S)for(;me<=C;)fe(k[me],ae,_e,!0),me++;else{const W=me,re=me,de=new Map;for(me=re;me<=S;me++){const Oe=z[me]=ve?er(z[me]):wi(z[me]);Oe.key!=null&&de.set(Oe.key,me)}let se,Ue=0;const Te=S-re+1;let qe=!1,$e=0;const be=new Array(Te);for(me=0;me<Te;me++)be[me]=0;for(me=W;me<=C;me++){const Oe=k[me];if(Ue>=Te){fe(Oe,ae,_e,!0);continue}let ze;if(Oe.key!=null)ze=de.get(Oe.key);else for(se=re;se<=S;se++)if(be[se-re]===0&&$r(Oe,z[se])){ze=se;break}ze===void 0?fe(Oe,ae,_e,!0):(be[ze-re]=me+1,ze>=$e?$e=ze:qe=!0,x(Oe,z[ze],Z,null,ae,_e,N,Ee,ve),Ue++)}const Ce=qe?fy(be):Is;for(se=Ce.length-1,me=Te-1;me>=0;me--){const Oe=re+me,ze=z[Oe],Ve=z[Oe+1],lt=Oe+1<xe?Ve.el||x_(Ve):ge;be[me]===0?x(null,ze,Z,lt,ae,_e,N,Ee,ve):qe&&(se<0||me!==Ce[se]?ne(ze,Z,lt,2):se--)}}},ne=(k,z,Z,ge,ae=null)=>{const{el:_e,type:N,transition:Ee,children:ve,shapeFlag:me}=k;if(me&6){ne(k.component.subTree,z,Z,ge);return}if(me&128){k.suspense.move(z,Z,ge);return}if(me&64){N.move(k,z,Z,Ae);return}if(N===In){i(_e,z,Z);for(let C=0;C<ve.length;C++)ne(ve[C],z,Z,ge);i(k.anchor,z,Z);return}if(N===il){A(k,z,Z);return}if(ge!==2&&me&1&&Ee)if(ge===0)Ee.beforeEnter(_e),i(_e,z,Z),mn(()=>Ee.enter(_e),ae);else{const{leave:C,delayLeave:S,afterLeave:W}=Ee,re=()=>{k.ctx.isUnmounted?r(_e):i(_e,z,Z)},de=()=>{_e._isLeaving&&_e[Ti](!0),C(_e,()=>{re(),W&&W()})};S?S(_e,re,de):de()}else i(_e,z,Z)},fe=(k,z,Z,ge=!1,ae=!1)=>{const{type:_e,props:N,ref:Ee,children:ve,dynamicChildren:me,shapeFlag:xe,patchFlag:C,dirs:S,cacheIndex:W}=k;if(C===-2&&(ae=!1),Ee!=null&&(lr(),ko(Ee,null,Z,k,!0),cr()),W!=null&&(z.renderCache[W]=void 0),xe&256){z.ctx.deactivate(k);return}const re=xe&1&&S,de=!Us(k);let se;if(de&&(se=N&&N.onVnodeBeforeUnmount)&&xi(se,z,k),xe&6)tt(k.component,Z,ge);else{if(xe&128){k.suspense.unmount(Z,ge);return}re&&Br(k,null,z,"beforeUnmount"),xe&64?k.type.remove(k,z,Z,Ae,ge):me&&!me.hasOnce&&(_e!==In||C>0&&C&64)?he(me,z,Z,!1,!0):(_e===In&&C&384||!ae&&xe&16)&&he(ve,z,Z),ge&&ye(k)}(de&&(se=N&&N.onVnodeUnmounted)||re)&&mn(()=>{se&&xi(se,z,k),re&&Br(k,null,z,"unmounted")},Z)},ye=k=>{const{type:z,el:Z,anchor:ge,transition:ae}=k;if(z===In){je(Z,ge);return}if(z===il){b(k);return}const _e=()=>{r(Z),ae&&!ae.persisted&&ae.afterLeave&&ae.afterLeave()};if(k.shapeFlag&1&&ae&&!ae.persisted){const{leave:N,delayLeave:Ee}=ae,ve=()=>N(Z,_e);Ee?Ee(k.el,_e,ve):ve()}else _e()},je=(k,z)=>{let Z;for(;k!==z;)Z=d(k),r(k),k=Z;r(z)},tt=(k,z,Z)=>{const{bum:ge,scope:ae,job:_e,subTree:N,um:Ee,m:ve,a:me}=k;Ld(ve),Ld(me),ge&&el(ge),ae.stop(),_e&&(_e.flags|=8,fe(N,k,z,Z)),Ee&&mn(Ee,z),mn(()=>{k.isUnmounted=!0},z)},he=(k,z,Z,ge=!1,ae=!1,_e=0)=>{for(let N=_e;N<k.length;N++)fe(k[N],z,Z,ge,ae)},Se=k=>{if(k.shapeFlag&6)return Se(k.component.subTree);if(k.shapeFlag&128)return k.suspense.next();const z=d(k.anchor||k.el),Z=z&&z[Wg];return Z?d(Z):z};let Me=!1;const Le=(k,z,Z)=>{let ge;k==null?z._vnode&&(fe(z._vnode,null,null,!0),ge=z._vnode.component):x(z._vnode||null,k,z,null,null,null,Z),z._vnode=k,Me||(Me=!0,gd(ge),kg(),Me=!1)},Ae={p:x,um:fe,m:ne,r:ye,mt:q,mc:E,pc:ie,pbc:L,n:Se,o:n};return{render:Le,hydrate:void 0,createApp:Kx(Le)}}function vc({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function kr({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function uy(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function _h(n,e,t=!1){const i=n.children,r=e.children;if(nt(i)&&nt(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=er(r[s]),a.el=o.el),!t&&a.patchFlag!==-2&&_h(o,a)),a.type===zl&&(a.patchFlag===-1&&(a=r[s]=er(a)),a.el=o.el),a.type===_n&&!a.el&&(a.el=o.el)}}function fy(n){const e=n.slice(),t=[0];let i,r,s,o,a;const l=n.length;for(i=0;i<l;i++){const c=n[i];if(c!==0){if(r=t[t.length-1],n[r]<c){e[i]=r,t.push(i);continue}for(s=0,o=t.length-1;s<o;)a=s+o>>1,n[t[a]]<c?s=a+1:o=a;c<n[t[s]]&&(s>0&&(e[i]=t[s-1]),t[s]=i)}}for(s=t.length,o=t[s-1];s-- >0;)t[s]=o,o=e[o];return t}function v_(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:v_(e)}function Ld(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function x_(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?x_(e.subTree):null}const y_=n=>n.__isSuspense;function hy(n,e){e&&e.pendingBranch?nt(n)?e.effects.push(...n):e.effects.push(n):yx(n)}const In=Symbol.for("v-fgt"),zl=Symbol.for("v-txt"),_n=Symbol.for("v-cmt"),il=Symbol.for("v-stc"),Ho=[];let zn=null;function qu(n=!1){Ho.push(zn=n?null:[])}function dy(){Ho.pop(),zn=Ho[Ho.length-1]||null}let Ko=1;function Sl(n,e=!1){Ko+=n,n<0&&zn&&e&&(zn.hasOnce=!0)}function S_(n){return n.dynamicChildren=Ko>0?zn||Is:null,dy(),Ko>0&&zn&&zn.push(n),n}function dP(n,e,t,i,r,s){return S_(b_(n,e,t,i,r,s,!0))}function Ku(n,e,t,i,r){return S_(yn(n,e,t,i,r,!0))}function Yo(n){return n?n.__v_isVNode===!0:!1}function $r(n,e){return n.type===e.type&&n.key===e.key}const M_=({key:n})=>n??null,rl=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Wt(n)||Sn(n)||ut(n)?{i:ln,r:n,k:e,f:!!t}:n:null);function b_(n,e=null,t=null,i=0,r=null,s=n===In?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&M_(e),ref:e&&rl(e),scopeId:Hg,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:ln};return a?(vh(l,t),s&128&&n.normalize(l)):t&&(l.shapeFlag|=Wt(t)?8:16),Ko>0&&!o&&zn&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&zn.push(l),l}const yn=py;function py(n,e=null,t=null,i=0,r=null,s=!1){if((!n||n===kx)&&(n=_n),Yo(n)){const a=Nr(n,e,!0);return t&&vh(a,t),Ko>0&&!s&&zn&&(a.shapeFlag&6?zn[zn.indexOf(n)]=a:zn.push(a)),a.patchFlag=-2,a}if(Ay(n)&&(n=n.__vccOpts),e){e=my(e);let{class:a,style:l}=e;a&&!Wt(a)&&(e.class=ih(a)),Rt(l)&&(hh(l)&&!nt(l)&&(l=Zt({},l)),e.style=nh(l))}const o=Wt(n)?1:y_(n)?128:jg(n)?64:Rt(n)?4:ut(n)?2:0;return b_(n,e,t,i,r,o,s,!0)}function my(n){return n?hh(n)||h_(n)?Zt({},n):n:null}function Nr(n,e,t=!1,i=!1){const{props:r,ref:s,patchFlag:o,children:a,transition:l}=n,c=e?_y(r||{},e):r,u={__v_isVNode:!0,__v_skip:!0,type:n.type,props:c,key:c&&M_(c),ref:e&&e.ref?t&&s?nt(s)?s.concat(rl(e)):[s,rl(e)]:rl(e):s,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:a,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==In?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:l,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Nr(n.ssContent),ssFallback:n.ssFallback&&Nr(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return l&&i&&os(u,l.clone(u)),u}function gy(n=" ",e=0){return yn(zl,null,n,e)}function pP(n,e){const t=yn(il,null,n);return t.staticCount=e,t}function mP(n="",e=!1){return e?(qu(),Ku(_n,null,n)):yn(_n,null,n)}function wi(n){return n==null||typeof n=="boolean"?yn(_n):nt(n)?yn(In,null,n.slice()):Yo(n)?er(n):yn(zl,null,String(n))}function er(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Nr(n)}function vh(n,e){let t=0;const{shapeFlag:i}=n;if(e==null)e=null;else if(nt(e))t=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),vh(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!h_(e)?e._ctx=ln:r===3&&ln&&(ln.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else ut(e)?(e={default:e,_ctx:ln},t=32):(e=String(e),i&64?(t=16,e=[gy(e)]):t=8);n.children=e,n.shapeFlag|=t}function _y(...n){const e={};for(let t=0;t<n.length;t++){const i=n[t];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=ih([e.class,i.class]));else if(r==="style")e.style=nh([e.style,i.style]);else if(Il(r)){const s=e[r],o=i[r];o&&s!==o&&!(nt(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function xi(n,e,t,i=null){pi(n,e,7,[t,i])}const vy=a_();let xy=0;function yy(n,e,t){const i=n.type,r=(e?e.appContext:n.appContext)||vy,s={uid:xy++,vnode:n,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Gv(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:p_(i,r),emitsOptions:l_(i,r),emit:null,emitted:null,propsDefaults:Ut,inheritAttrs:i.inheritAttrs,ctx:Ut,data:Ut,props:Ut,attrs:Ut,slots:Ut,refs:Ut,setupState:Ut,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=$x.bind(null,s),n.ce&&n.ce(s),s}let vn=null;const xh=()=>vn||ln;let Ml,Yu;{const n=Ol(),e=(t,i)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(i),s=>{r.length>1?r.forEach(o=>o(s)):r[0](s)}};Ml=e("__VUE_INSTANCE_SETTERS__",t=>vn=t),Yu=e("__VUE_SSR_SETTERS__",t=>$o=t)}const oa=n=>{const e=vn;return Ml(n),n.scope.on(),()=>{n.scope.off(),Ml(e)}},Id=()=>{vn&&vn.scope.off(),Ml(null)};function E_(n){return n.vnode.shapeFlag&4}let $o=!1;function Sy(n,e=!1,t=!1){e&&Yu(e);const{props:i,children:r}=n.vnode,s=E_(n);ny(n,i,s,e),oy(n,r,t||e);const o=s?My(n,e):void 0;return e&&Yu(!1),o}function My(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Hx);const{setup:i}=t;if(i){lr();const r=n.setupContext=i.length>1?Ey(n):null,s=oa(n),o=sa(i,n,0,[n.props,r]),a=dg(o);if(cr(),s(),(a||n.sp)&&!Us(n)&&Zg(n),a){if(o.then(Id,Id),e)return o.then(l=>{Dd(n,l)}).catch(l=>{Bl(l,n,0)});n.asyncDep=o}else Dd(n,o)}else T_(n)}function Dd(n,e,t){ut(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:Rt(e)&&(n.setupState=Ug(e)),T_(n)}function T_(n,e,t){const i=n.type;n.render||(n.render=i.render||Di);{const r=oa(n);lr();try{zx(n)}finally{cr(),r()}}}const by={get(n,e){return gn(n,"get",""),n[e]}};function Ey(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,by),slots:n.slots,emit:n.emit,expose:e}}function Gl(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Ug(ux(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in Vo)return Vo[t](n)},has(e,t){return t in e||t in Vo}})):n.proxy}function Ty(n,e=!0){return ut(n)?n.displayName||n.name:n.name||e&&n.__name}function Ay(n){return ut(n)&&"__vccOpts"in n}const wy=(n,e)=>mx(n,e,$o);function Ry(n,e,t){try{Sl(-1);const i=arguments.length;return i===2?Rt(e)&&!nt(e)?Yo(e)?yn(n,null,[e]):yn(n,e):yn(n,null,e):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&Yo(t)&&(t=[t]),yn(n,e,t))}finally{Sl(1)}}const Cy="3.5.30";/**
* @vue/runtime-dom v3.5.30
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let $u;const Nd=typeof window<"u"&&window.trustedTypes;if(Nd)try{$u=Nd.createPolicy("vue",{createHTML:n=>n})}catch{}const A_=$u?n=>$u.createHTML(n):n=>n,Py="http://www.w3.org/2000/svg",Ly="http://www.w3.org/1998/Math/MathML",Qi=typeof document<"u"?document:null,Ud=Qi&&Qi.createElement("template"),Iy={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,i)=>{const r=e==="svg"?Qi.createElementNS(Py,n):e==="mathml"?Qi.createElementNS(Ly,n):t?Qi.createElement(n,{is:t}):Qi.createElement(n);return n==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:n=>Qi.createTextNode(n),createComment:n=>Qi.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>Qi.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,i,r,s){const o=t?t.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===s||!(r=r.nextSibling)););else{Ud.innerHTML=A_(i==="svg"?`<svg>${n}</svg>`:i==="mathml"?`<math>${n}</math>`:n);const a=Ud.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Sr="transition",vo="animation",zs=Symbol("_vtc"),w_={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},R_=Zt({},Kg,w_),Dy=n=>(n.displayName="Transition",n.props=R_,n),gP=Dy((n,{slots:e})=>Ry(Rx,C_(n),e)),Vr=(n,e=[])=>{nt(n)?n.forEach(t=>t(...e)):n&&n(...e)},Od=n=>n?nt(n)?n.some(e=>e.length>1):n.length>1:!1;function C_(n){const e={};for(const U in n)U in w_||(e[U]=n[U]);if(n.css===!1)return e;const{name:t="v",type:i,duration:r,enterFromClass:s=`${t}-enter-from`,enterActiveClass:o=`${t}-enter-active`,enterToClass:a=`${t}-enter-to`,appearFromClass:l=s,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:h=`${t}-leave-from`,leaveActiveClass:d=`${t}-leave-active`,leaveToClass:g=`${t}-leave-to`}=n,p=Ny(r),x=p&&p[0],m=p&&p[1],{onBeforeEnter:_,onEnter:M,onEnterCancelled:A,onLeave:b,onLeaveCancelled:I,onBeforeAppear:D=_,onAppear:B=M,onAppearCancelled:E=A}=e,w=(U,H,q,J)=>{U._enterCancelled=J,Cr(U,H?u:a),Cr(U,H?c:o),q&&q()},L=(U,H)=>{U._isLeaving=!1,Cr(U,h),Cr(U,g),Cr(U,d),H&&H()},R=U=>(H,q)=>{const J=U?B:M,O=()=>w(H,U,q);Vr(J,[H,O]),Fd(()=>{Cr(H,U?l:s),Mi(H,U?u:a),Od(J)||Bd(H,i,x,O)})};return Zt(e,{onBeforeEnter(U){Vr(_,[U]),Mi(U,s),Mi(U,o)},onBeforeAppear(U){Vr(D,[U]),Mi(U,l),Mi(U,c)},onEnter:R(!1),onAppear:R(!0),onLeave(U,H){U._isLeaving=!0;const q=()=>L(U,H);Mi(U,h),U._enterCancelled?(Mi(U,d),Ju(U)):(Ju(U),Mi(U,d)),Fd(()=>{U._isLeaving&&(Cr(U,h),Mi(U,g),Od(b)||Bd(U,i,m,q))}),Vr(b,[U,q])},onEnterCancelled(U){w(U,!1,void 0,!0),Vr(A,[U])},onAppearCancelled(U){w(U,!0,void 0,!0),Vr(E,[U])},onLeaveCancelled(U){L(U),Vr(I,[U])}})}function Ny(n){if(n==null)return null;if(Rt(n))return[xc(n.enter),xc(n.leave)];{const e=xc(n);return[e,e]}}function xc(n){return Nv(n)}function Mi(n,e){e.split(/\s+/).forEach(t=>t&&n.classList.add(t)),(n[zs]||(n[zs]=new Set)).add(e)}function Cr(n,e){e.split(/\s+/).forEach(i=>i&&n.classList.remove(i));const t=n[zs];t&&(t.delete(e),t.size||(n[zs]=void 0))}function Fd(n){requestAnimationFrame(()=>{requestAnimationFrame(n)})}let Uy=0;function Bd(n,e,t,i){const r=n._endId=++Uy,s=()=>{r===n._endId&&i()};if(t!=null)return setTimeout(s,t);const{type:o,timeout:a,propCount:l}=P_(n,e);if(!o)return i();const c=o+"end";let u=0;const h=()=>{n.removeEventListener(c,d),s()},d=g=>{g.target===n&&++u>=l&&h()};setTimeout(()=>{u<l&&h()},a+1),n.addEventListener(c,d)}function P_(n,e){const t=window.getComputedStyle(n),i=p=>(t[p]||"").split(", "),r=i(`${Sr}Delay`),s=i(`${Sr}Duration`),o=kd(r,s),a=i(`${vo}Delay`),l=i(`${vo}Duration`),c=kd(a,l);let u=null,h=0,d=0;e===Sr?o>0&&(u=Sr,h=o,d=s.length):e===vo?c>0&&(u=vo,h=c,d=l.length):(h=Math.max(o,c),u=h>0?o>c?Sr:vo:null,d=u?u===Sr?s.length:l.length:0);const g=u===Sr&&/\b(?:transform|all)(?:,|$)/.test(i(`${Sr}Property`).toString());return{type:u,timeout:h,propCount:d,hasTransform:g}}function kd(n,e){for(;n.length<e.length;)n=n.concat(n);return Math.max(...e.map((t,i)=>Vd(t)+Vd(n[i])))}function Vd(n){return n==="auto"?0:Number(n.slice(0,-1).replace(",","."))*1e3}function Ju(n){return(n?n.ownerDocument:document).body.offsetHeight}function Oy(n,e,t){const i=n[zs];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const Hd=Symbol("_vod"),Fy=Symbol("_vsh"),By=Symbol(""),ky=/(?:^|;)\s*display\s*:/;function Vy(n,e,t){const i=n.style,r=Wt(t);let s=!1;if(t&&!r){if(e)if(Wt(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();t[a]==null&&sl(i,a,"")}else for(const o in e)t[o]==null&&sl(i,o,"");for(const o in t)o==="display"&&(s=!0),sl(i,o,t[o])}else if(r){if(e!==t){const o=i[By];o&&(t+=";"+o),i.cssText=t,s=ky.test(t)}}else e&&n.removeAttribute("style");Hd in n&&(n[Hd]=s?i.display:"",n[Fy]&&(i.display="none"))}const zd=/\s*!important$/;function sl(n,e,t){if(nt(t))t.forEach(i=>sl(n,e,i));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const i=Hy(n,e);zd.test(t)?n.setProperty(Or(i),t.replace(zd,""),"important"):n[i]=t}}const Gd=["Webkit","Moz","ms"],yc={};function Hy(n,e){const t=yc[e];if(t)return t;let i=wn(e);if(i!=="filter"&&i in n)return yc[e]=i;i=Nl(i);for(let r=0;r<Gd.length;r++){const s=Gd[r]+i;if(s in n)return yc[e]=s}return e}const Wd="http://www.w3.org/1999/xlink";function jd(n,e,t,i,r,s=Vv(e)){i&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(Wd,e.slice(6,e.length)):n.setAttributeNS(Wd,e,t):t==null||s&&!_g(t)?n.removeAttribute(e):n.setAttribute(e,s?"":hi(t)?String(t):t)}function Xd(n,e,t,i,r){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?A_(t):t);return}const s=n.tagName;if(e==="value"&&s!=="PROGRESS"&&!s.includes("-")){const a=s==="OPTION"?n.getAttribute("value")||"":n.value,l=t==null?n.type==="checkbox"?"on":"":String(t);(a!==l||!("_value"in n))&&(n.value=l),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const a=typeof n[e];a==="boolean"?t=_g(t):t==null&&a==="string"?(t="",o=!0):a==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(r||e)}function ir(n,e,t,i){n.addEventListener(e,t,i)}function zy(n,e,t,i){n.removeEventListener(e,t,i)}const qd=Symbol("_vei");function Gy(n,e,t,i,r=null){const s=n[qd]||(n[qd]={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=Wy(e);if(i){const c=s[e]=qy(i,r);ir(n,a,c,l)}else o&&(zy(n,a,o,l),s[e]=void 0)}}const Kd=/(?:Once|Passive|Capture)$/;function Wy(n){let e;if(Kd.test(n)){e={};let i;for(;i=n.match(Kd);)n=n.slice(0,n.length-i[0].length),e[i[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Or(n.slice(2)),e]}let Sc=0;const jy=Promise.resolve(),Xy=()=>Sc||(jy.then(()=>Sc=0),Sc=Date.now());function qy(n,e){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;pi(Ky(i,t.value),e,5,[i])};return t.value=n,t.attached=Xy(),t}function Ky(n,e){if(nt(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const Yd=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,Yy=(n,e,t,i,r,s)=>{const o=r==="svg";e==="class"?Oy(n,i,o):e==="style"?Vy(n,t,i):Il(e)?Qf(e)||Gy(n,e,t,i,s):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):$y(n,e,i,o))?(Xd(n,e,i),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&jd(n,e,i,o,s,e!=="value")):n._isVueCE&&(Jy(n,e)||n._def.__asyncLoader&&(/[A-Z]/.test(e)||!Wt(i)))?Xd(n,wn(e),i,s,e):(e==="true-value"?n._trueValue=i:e==="false-value"&&(n._falseValue=i),jd(n,e,i,o))};function $y(n,e,t,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in n&&Yd(e)&&ut(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return Yd(e)&&Wt(t)?!1:e in n}function Jy(n,e){const t=n._def.props;if(!t)return!1;const i=wn(e);return Array.isArray(t)?t.some(r=>wn(r)===i):Object.keys(t).some(r=>wn(r)===i)}const L_=new WeakMap,I_=new WeakMap,bl=Symbol("_moveCb"),$d=Symbol("_enterCb"),Zy=n=>(delete n.props.mode,n),Qy=Zy({name:"TransitionGroup",props:Zt({},R_,{tag:String,moveClass:String}),setup(n,{slots:e}){const t=xh(),i=qg();let r,s;return t_(()=>{if(!r.length)return;const o=n.moveClass||`${n.name||"v"}-move`;if(!iS(r[0].el,t.vnode.el,o)){r=[];return}r.forEach(eS),r.forEach(tS);const a=r.filter(nS);Ju(t.vnode.el),a.forEach(l=>{const c=l.el,u=c.style;Mi(c,o),u.transform=u.webkitTransform=u.transitionDuration="";const h=c[bl]=d=>{d&&d.target!==c||(!d||d.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",h),c[bl]=null,Cr(c,o))};c.addEventListener("transitionend",h)}),r=[]}),()=>{const o=Et(n),a=C_(o);let l=o.tag||In;if(r=[],s)for(let c=0;c<s.length;c++){const u=s[c];u.el&&u.el instanceof Element&&(r.push(u),os(u,qo(u,a,i,t)),L_.set(u,D_(u.el)))}s=e.default?ph(e.default()):[];for(let c=0;c<s.length;c++){const u=s[c];u.key!=null&&os(u,qo(u,a,i,t))}return yn(l,null,s)}}}),_P=Qy;function eS(n){const e=n.el;e[bl]&&e[bl](),e[$d]&&e[$d]()}function tS(n){I_.set(n,D_(n.el))}function nS(n){const e=L_.get(n),t=I_.get(n),i=e.left-t.left,r=e.top-t.top;if(i||r){const s=n.el,o=s.style,a=s.getBoundingClientRect();let l=1,c=1;return s.offsetWidth&&(l=a.width/s.offsetWidth),s.offsetHeight&&(c=a.height/s.offsetHeight),(!Number.isFinite(l)||l===0)&&(l=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(l-1)<.01&&(l=1),Math.abs(c-1)<.01&&(c=1),o.transform=o.webkitTransform=`translate(${i/l}px,${r/c}px)`,o.transitionDuration="0s",n}}function D_(n){const e=n.getBoundingClientRect();return{left:e.left,top:e.top}}function iS(n,e,t){const i=n.cloneNode(),r=n[zs];r&&r.forEach(a=>{a.split(/\s+/).forEach(l=>l&&i.classList.remove(l))}),t.split(/\s+/).forEach(a=>a&&i.classList.add(a)),i.style.display="none";const s=e.nodeType===1?e:e.parentNode;s.appendChild(i);const{hasTransform:o}=P_(i);return s.removeChild(i),o}const Ur=n=>{const e=n.props["onUpdate:modelValue"]||!1;return nt(e)?t=>el(e,t):e};function rS(n){n.target.composing=!0}function Jd(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ei=Symbol("_assign");function Zd(n,e,t){return e&&(n=n.trim()),t&&(n=Ul(n)),n}const vP={created(n,{modifiers:{lazy:e,trim:t,number:i}},r){n[ei]=Ur(r);const s=i||r.props&&r.props.type==="number";ir(n,e?"change":"input",o=>{o.target.composing||n[ei](Zd(n.value,t,s))}),(t||s)&&ir(n,"change",()=>{n.value=Zd(n.value,t,s)}),e||(ir(n,"compositionstart",rS),ir(n,"compositionend",Jd),ir(n,"change",Jd))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:i,trim:r,number:s}},o){if(n[ei]=Ur(o),n.composing)return;const a=(s||n.type==="number")&&!/^0\d/.test(n.value)?Ul(n.value):n.value,l=e??"";a!==l&&(document.activeElement===n&&n.type!=="range"&&(i&&e===t||r&&n.value.trim()===l)||(n.value=l))}},xP={deep:!0,created(n,e,t){n[ei]=Ur(t),ir(n,"change",()=>{const i=n._modelValue,r=Gs(n),s=n.checked,o=n[ei];if(nt(i)){const a=rh(i,r),l=a!==-1;if(s&&!l)o(i.concat(r));else if(!s&&l){const c=[...i];c.splice(a,1),o(c)}}else if(to(i)){const a=new Set(i);s?a.add(r):a.delete(r),o(a)}else o(N_(n,s))})},mounted:Qd,beforeUpdate(n,e,t){n[ei]=Ur(t),Qd(n,e,t)}};function Qd(n,{value:e,oldValue:t},i){n._modelValue=e;let r;if(nt(e))r=rh(e,i.props.value)>-1;else if(to(e))r=e.has(i.props.value);else{if(e===t)return;r=Dr(e,N_(n,!0))}n.checked!==r&&(n.checked=r)}const yP={created(n,{value:e},t){n.checked=Dr(e,t.props.value),n[ei]=Ur(t),ir(n,"change",()=>{n[ei](Gs(n))})},beforeUpdate(n,{value:e,oldValue:t},i){n[ei]=Ur(i),e!==t&&(n.checked=Dr(e,i.props.value))}},SP={deep:!0,created(n,{value:e,modifiers:{number:t}},i){const r=to(e);ir(n,"change",()=>{const s=Array.prototype.filter.call(n.options,o=>o.selected).map(o=>t?Ul(Gs(o)):Gs(o));n[ei](n.multiple?r?new Set(s):s:s[0]),n._assigning=!0,Fg(()=>{n._assigning=!1})}),n[ei]=Ur(i)},mounted(n,{value:e}){ep(n,e)},beforeUpdate(n,e,t){n[ei]=Ur(t)},updated(n,{value:e}){n._assigning||ep(n,e)}};function ep(n,e){const t=n.multiple,i=nt(e);if(!(t&&!i&&!to(e))){for(let r=0,s=n.options.length;r<s;r++){const o=n.options[r],a=Gs(o);if(t)if(i){const l=typeof a;l==="string"||l==="number"?o.selected=e.some(c=>String(c)===String(a)):o.selected=rh(e,a)>-1}else o.selected=e.has(a);else if(Dr(Gs(o),e)){n.selectedIndex!==r&&(n.selectedIndex=r);return}}!t&&n.selectedIndex!==-1&&(n.selectedIndex=-1)}}function Gs(n){return"_value"in n?n._value:n.value}function N_(n,e){const t=e?"_trueValue":"_falseValue";return t in n?n[t]:e}const sS=["ctrl","shift","alt","meta"],oS={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>sS.some(t=>n[`${t}Key`]&&!e.includes(t))},MP=(n,e)=>{if(!n)return n;const t=n._withMods||(n._withMods={}),i=e.join(".");return t[i]||(t[i]=((r,...s)=>{for(let o=0;o<e.length;o++){const a=oS[e[o]];if(a&&a(r,e))return}return n(r,...s)}))},aS={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},bP=(n,e)=>{const t=n._withKeys||(n._withKeys={}),i=e.join(".");return t[i]||(t[i]=(r=>{if(!("key"in r))return;const s=Or(r.key);if(e.some(o=>o===s||aS[o]===s))return n(r)}))},lS=Zt({patchProp:Yy},Iy);let tp;function cS(){return tp||(tp=ly(lS))}const EP=((...n)=>{const e=cS().createApp(...n),{mount:t}=e;return e.mount=i=>{const r=fS(i);if(!r)return;const s=e._component;!ut(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=t(r,!1,uS(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e});function uS(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function fS(n){return Wt(n)?document.querySelector(n):n}function U_(n,e){return function(){return n.apply(e,arguments)}}const{toString:hS}=Object.prototype,{getPrototypeOf:yh}=Object,{iterator:Wl,toStringTag:O_}=Symbol,jl=(n=>e=>{const t=hS.call(e);return n[t]||(n[t]=t.slice(8,-1).toLowerCase())})(Object.create(null)),mi=n=>(n=n.toLowerCase(),e=>jl(e)===n),Xl=n=>e=>typeof e===n,{isArray:no}=Array,Ws=Xl("undefined");function aa(n){return n!==null&&!Ws(n)&&n.constructor!==null&&!Ws(n.constructor)&&Nn(n.constructor.isBuffer)&&n.constructor.isBuffer(n)}const F_=mi("ArrayBuffer");function dS(n){let e;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?e=ArrayBuffer.isView(n):e=n&&n.buffer&&F_(n.buffer),e}const pS=Xl("string"),Nn=Xl("function"),B_=Xl("number"),la=n=>n!==null&&typeof n=="object",mS=n=>n===!0||n===!1,ol=n=>{if(jl(n)!=="object")return!1;const e=yh(n);return(e===null||e===Object.prototype||Object.getPrototypeOf(e)===null)&&!(O_ in n)&&!(Wl in n)},gS=n=>{if(!la(n)||aa(n))return!1;try{return Object.keys(n).length===0&&Object.getPrototypeOf(n)===Object.prototype}catch{return!1}},_S=mi("Date"),vS=mi("File"),xS=n=>!!(n&&typeof n.uri<"u"),yS=n=>n&&typeof n.getParts<"u",SS=mi("Blob"),MS=mi("FileList"),bS=n=>la(n)&&Nn(n.pipe);function ES(){return typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}}const np=ES(),ip=typeof np.FormData<"u"?np.FormData:void 0,TS=n=>{let e;return n&&(ip&&n instanceof ip||Nn(n.append)&&((e=jl(n))==="formdata"||e==="object"&&Nn(n.toString)&&n.toString()==="[object FormData]"))},AS=mi("URLSearchParams"),[wS,RS,CS,PS]=["ReadableStream","Request","Response","Headers"].map(mi),LS=n=>n.trim?n.trim():n.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function ca(n,e,{allOwnKeys:t=!1}={}){if(n===null||typeof n>"u")return;let i,r;if(typeof n!="object"&&(n=[n]),no(n))for(i=0,r=n.length;i<r;i++)e.call(null,n[i],i,n);else{if(aa(n))return;const s=t?Object.getOwnPropertyNames(n):Object.keys(n),o=s.length;let a;for(i=0;i<o;i++)a=s[i],e.call(null,n[a],a,n)}}function k_(n,e){if(aa(n))return null;e=e.toLowerCase();const t=Object.keys(n);let i=t.length,r;for(;i-- >0;)if(r=t[i],e===r.toLowerCase())return r;return null}const Qr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,V_=n=>!Ws(n)&&n!==Qr;function Zu(){const{caseless:n,skipUndefined:e}=V_(this)&&this||{},t={},i=(r,s)=>{if(s==="__proto__"||s==="constructor"||s==="prototype")return;const o=n&&k_(t,s)||s;ol(t[o])&&ol(r)?t[o]=Zu(t[o],r):ol(r)?t[o]=Zu({},r):no(r)?t[o]=r.slice():(!e||!Ws(r))&&(t[o]=r)};for(let r=0,s=arguments.length;r<s;r++)arguments[r]&&ca(arguments[r],i);return t}const IS=(n,e,t,{allOwnKeys:i}={})=>(ca(e,(r,s)=>{t&&Nn(r)?Object.defineProperty(n,s,{value:U_(r,t),writable:!0,enumerable:!0,configurable:!0}):Object.defineProperty(n,s,{value:r,writable:!0,enumerable:!0,configurable:!0})},{allOwnKeys:i}),n),DS=n=>(n.charCodeAt(0)===65279&&(n=n.slice(1)),n),NS=(n,e,t,i)=>{n.prototype=Object.create(e.prototype,i),Object.defineProperty(n.prototype,"constructor",{value:n,writable:!0,enumerable:!1,configurable:!0}),Object.defineProperty(n,"super",{value:e.prototype}),t&&Object.assign(n.prototype,t)},US=(n,e,t,i)=>{let r,s,o;const a={};if(e=e||{},n==null)return e;do{for(r=Object.getOwnPropertyNames(n),s=r.length;s-- >0;)o=r[s],(!i||i(o,n,e))&&!a[o]&&(e[o]=n[o],a[o]=!0);n=t!==!1&&yh(n)}while(n&&(!t||t(n,e))&&n!==Object.prototype);return e},OS=(n,e,t)=>{n=String(n),(t===void 0||t>n.length)&&(t=n.length),t-=e.length;const i=n.indexOf(e,t);return i!==-1&&i===t},FS=n=>{if(!n)return null;if(no(n))return n;let e=n.length;if(!B_(e))return null;const t=new Array(e);for(;e-- >0;)t[e]=n[e];return t},BS=(n=>e=>n&&e instanceof n)(typeof Uint8Array<"u"&&yh(Uint8Array)),kS=(n,e)=>{const i=(n&&n[Wl]).call(n);let r;for(;(r=i.next())&&!r.done;){const s=r.value;e.call(n,s[0],s[1])}},VS=(n,e)=>{let t;const i=[];for(;(t=n.exec(e))!==null;)i.push(t);return i},HS=mi("HTMLFormElement"),zS=n=>n.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(t,i,r){return i.toUpperCase()+r}),rp=(({hasOwnProperty:n})=>(e,t)=>n.call(e,t))(Object.prototype),GS=mi("RegExp"),H_=(n,e)=>{const t=Object.getOwnPropertyDescriptors(n),i={};ca(t,(r,s)=>{let o;(o=e(r,s,n))!==!1&&(i[s]=o||r)}),Object.defineProperties(n,i)},WS=n=>{H_(n,(e,t)=>{if(Nn(n)&&["arguments","caller","callee"].indexOf(t)!==-1)return!1;const i=n[t];if(Nn(i)){if(e.enumerable=!1,"writable"in e){e.writable=!1;return}e.set||(e.set=()=>{throw Error("Can not rewrite read-only method '"+t+"'")})}})},jS=(n,e)=>{const t={},i=r=>{r.forEach(s=>{t[s]=!0})};return no(n)?i(n):i(String(n).split(e)),t},XS=()=>{},qS=(n,e)=>n!=null&&Number.isFinite(n=+n)?n:e;function KS(n){return!!(n&&Nn(n.append)&&n[O_]==="FormData"&&n[Wl])}const YS=n=>{const e=new Array(10),t=(i,r)=>{if(la(i)){if(e.indexOf(i)>=0)return;if(aa(i))return i;if(!("toJSON"in i)){e[r]=i;const s=no(i)?[]:{};return ca(i,(o,a)=>{const l=t(o,r+1);!Ws(l)&&(s[a]=l)}),e[r]=void 0,s}}return i};return t(n,0)},$S=mi("AsyncFunction"),JS=n=>n&&(la(n)||Nn(n))&&Nn(n.then)&&Nn(n.catch),z_=((n,e)=>n?setImmediate:e?((t,i)=>(Qr.addEventListener("message",({source:r,data:s})=>{r===Qr&&s===t&&i.length&&i.shift()()},!1),r=>{i.push(r),Qr.postMessage(t,"*")}))(`axios@${Math.random()}`,[]):t=>setTimeout(t))(typeof setImmediate=="function",Nn(Qr.postMessage)),ZS=typeof queueMicrotask<"u"?queueMicrotask.bind(Qr):typeof process<"u"&&process.nextTick||z_,QS=n=>n!=null&&Nn(n[Wl]),ue={isArray:no,isArrayBuffer:F_,isBuffer:aa,isFormData:TS,isArrayBufferView:dS,isString:pS,isNumber:B_,isBoolean:mS,isObject:la,isPlainObject:ol,isEmptyObject:gS,isReadableStream:wS,isRequest:RS,isResponse:CS,isHeaders:PS,isUndefined:Ws,isDate:_S,isFile:vS,isReactNativeBlob:xS,isReactNative:yS,isBlob:SS,isRegExp:GS,isFunction:Nn,isStream:bS,isURLSearchParams:AS,isTypedArray:BS,isFileList:MS,forEach:ca,merge:Zu,extend:IS,trim:LS,stripBOM:DS,inherits:NS,toFlatObject:US,kindOf:jl,kindOfTest:mi,endsWith:OS,toArray:FS,forEachEntry:kS,matchAll:VS,isHTMLForm:HS,hasOwnProperty:rp,hasOwnProp:rp,reduceDescriptors:H_,freezeMethods:WS,toObjectSet:jS,toCamelCase:zS,noop:XS,toFiniteNumber:qS,findKey:k_,global:Qr,isContextDefined:V_,isSpecCompliantForm:KS,toJSONObject:YS,isAsyncFn:$S,isThenable:JS,setImmediate:z_,asap:ZS,isIterable:QS};let at=class G_ extends Error{static from(e,t,i,r,s,o){const a=new G_(e.message,t||e.code,i,r,s);return a.cause=e,a.name=e.name,e.status!=null&&a.status==null&&(a.status=e.status),o&&Object.assign(a,o),a}constructor(e,t,i,r,s){super(e),Object.defineProperty(this,"message",{value:e,enumerable:!0,writable:!0,configurable:!0}),this.name="AxiosError",this.isAxiosError=!0,t&&(this.code=t),i&&(this.config=i),r&&(this.request=r),s&&(this.response=s,this.status=s.status)}toJSON(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:ue.toJSONObject(this.config),code:this.code,status:this.status}}};at.ERR_BAD_OPTION_VALUE="ERR_BAD_OPTION_VALUE";at.ERR_BAD_OPTION="ERR_BAD_OPTION";at.ECONNABORTED="ECONNABORTED";at.ETIMEDOUT="ETIMEDOUT";at.ERR_NETWORK="ERR_NETWORK";at.ERR_FR_TOO_MANY_REDIRECTS="ERR_FR_TOO_MANY_REDIRECTS";at.ERR_DEPRECATED="ERR_DEPRECATED";at.ERR_BAD_RESPONSE="ERR_BAD_RESPONSE";at.ERR_BAD_REQUEST="ERR_BAD_REQUEST";at.ERR_CANCELED="ERR_CANCELED";at.ERR_NOT_SUPPORT="ERR_NOT_SUPPORT";at.ERR_INVALID_URL="ERR_INVALID_URL";const eM=null;function Qu(n){return ue.isPlainObject(n)||ue.isArray(n)}function W_(n){return ue.endsWith(n,"[]")?n.slice(0,-2):n}function Mc(n,e,t){return n?n.concat(e).map(function(r,s){return r=W_(r),!t&&s?"["+r+"]":r}).join(t?".":""):e}function tM(n){return ue.isArray(n)&&!n.some(Qu)}const nM=ue.toFlatObject(ue,{},null,function(e){return/^is[A-Z]/.test(e)});function ql(n,e,t){if(!ue.isObject(n))throw new TypeError("target must be an object");e=e||new FormData,t=ue.toFlatObject(t,{metaTokens:!0,dots:!1,indexes:!1},!1,function(x,m){return!ue.isUndefined(m[x])});const i=t.metaTokens,r=t.visitor||u,s=t.dots,o=t.indexes,l=(t.Blob||typeof Blob<"u"&&Blob)&&ue.isSpecCompliantForm(e);if(!ue.isFunction(r))throw new TypeError("visitor must be a function");function c(p){if(p===null)return"";if(ue.isDate(p))return p.toISOString();if(ue.isBoolean(p))return p.toString();if(!l&&ue.isBlob(p))throw new at("Blob is not supported. Use a Buffer instead.");return ue.isArrayBuffer(p)||ue.isTypedArray(p)?l&&typeof Blob=="function"?new Blob([p]):Buffer.from(p):p}function u(p,x,m){let _=p;if(ue.isReactNative(e)&&ue.isReactNativeBlob(p))return e.append(Mc(m,x,s),c(p)),!1;if(p&&!m&&typeof p=="object"){if(ue.endsWith(x,"{}"))x=i?x:x.slice(0,-2),p=JSON.stringify(p);else if(ue.isArray(p)&&tM(p)||(ue.isFileList(p)||ue.endsWith(x,"[]"))&&(_=ue.toArray(p)))return x=W_(x),_.forEach(function(A,b){!(ue.isUndefined(A)||A===null)&&e.append(o===!0?Mc([x],b,s):o===null?x:x+"[]",c(A))}),!1}return Qu(p)?!0:(e.append(Mc(m,x,s),c(p)),!1)}const h=[],d=Object.assign(nM,{defaultVisitor:u,convertValue:c,isVisitable:Qu});function g(p,x){if(!ue.isUndefined(p)){if(h.indexOf(p)!==-1)throw Error("Circular reference detected in "+x.join("."));h.push(p),ue.forEach(p,function(_,M){(!(ue.isUndefined(_)||_===null)&&r.call(e,_,ue.isString(M)?M.trim():M,x,d))===!0&&g(_,x?x.concat(M):[M])}),h.pop()}}if(!ue.isObject(n))throw new TypeError("data must be an object");return g(n),e}function sp(n){const e={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(n).replace(/[!'()~]|%20|%00/g,function(i){return e[i]})}function Sh(n,e){this._pairs=[],n&&ql(n,this,e)}const j_=Sh.prototype;j_.append=function(e,t){this._pairs.push([e,t])};j_.toString=function(e){const t=e?function(i){return e.call(this,i,sp)}:sp;return this._pairs.map(function(r){return t(r[0])+"="+t(r[1])},"").join("&")};function iM(n){return encodeURIComponent(n).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}function X_(n,e,t){if(!e)return n;const i=t&&t.encode||iM,r=ue.isFunction(t)?{serialize:t}:t,s=r&&r.serialize;let o;if(s?o=s(e,r):o=ue.isURLSearchParams(e)?e.toString():new Sh(e,r).toString(i),o){const a=n.indexOf("#");a!==-1&&(n=n.slice(0,a)),n+=(n.indexOf("?")===-1?"?":"&")+o}return n}class op{constructor(){this.handlers=[]}use(e,t,i){return this.handlers.push({fulfilled:e,rejected:t,synchronous:i?i.synchronous:!1,runWhen:i?i.runWhen:null}),this.handlers.length-1}eject(e){this.handlers[e]&&(this.handlers[e]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(e){ue.forEach(this.handlers,function(i){i!==null&&e(i)})}}const Mh={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1,legacyInterceptorReqResOrdering:!0},rM=typeof URLSearchParams<"u"?URLSearchParams:Sh,sM=typeof FormData<"u"?FormData:null,oM=typeof Blob<"u"?Blob:null,aM={isBrowser:!0,classes:{URLSearchParams:rM,FormData:sM,Blob:oM},protocols:["http","https","file","blob","url","data"]},bh=typeof window<"u"&&typeof document<"u",ef=typeof navigator=="object"&&navigator||void 0,lM=bh&&(!ef||["ReactNative","NativeScript","NS"].indexOf(ef.product)<0),cM=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",uM=bh&&window.location.href||"http://localhost",fM=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:bh,hasStandardBrowserEnv:lM,hasStandardBrowserWebWorkerEnv:cM,navigator:ef,origin:uM},Symbol.toStringTag,{value:"Module"})),xn={...fM,...aM};function hM(n,e){return ql(n,new xn.classes.URLSearchParams,{visitor:function(t,i,r,s){return xn.isNode&&ue.isBuffer(t)?(this.append(i,t.toString("base64")),!1):s.defaultVisitor.apply(this,arguments)},...e})}function dM(n){return ue.matchAll(/\w+|\[(\w*)]/g,n).map(e=>e[0]==="[]"?"":e[1]||e[0])}function pM(n){const e={},t=Object.keys(n);let i;const r=t.length;let s;for(i=0;i<r;i++)s=t[i],e[s]=n[s];return e}function q_(n){function e(t,i,r,s){let o=t[s++];if(o==="__proto__")return!0;const a=Number.isFinite(+o),l=s>=t.length;return o=!o&&ue.isArray(r)?r.length:o,l?(ue.hasOwnProp(r,o)?r[o]=[r[o],i]:r[o]=i,!a):((!r[o]||!ue.isObject(r[o]))&&(r[o]=[]),e(t,i,r[o],s)&&ue.isArray(r[o])&&(r[o]=pM(r[o])),!a)}if(ue.isFormData(n)&&ue.isFunction(n.entries)){const t={};return ue.forEachEntry(n,(i,r)=>{e(dM(i),r,t,0)}),t}return null}function mM(n,e,t){if(ue.isString(n))try{return(e||JSON.parse)(n),ue.trim(n)}catch(i){if(i.name!=="SyntaxError")throw i}return(t||JSON.stringify)(n)}const ua={transitional:Mh,adapter:["xhr","http","fetch"],transformRequest:[function(e,t){const i=t.getContentType()||"",r=i.indexOf("application/json")>-1,s=ue.isObject(e);if(s&&ue.isHTMLForm(e)&&(e=new FormData(e)),ue.isFormData(e))return r?JSON.stringify(q_(e)):e;if(ue.isArrayBuffer(e)||ue.isBuffer(e)||ue.isStream(e)||ue.isFile(e)||ue.isBlob(e)||ue.isReadableStream(e))return e;if(ue.isArrayBufferView(e))return e.buffer;if(ue.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();let a;if(s){if(i.indexOf("application/x-www-form-urlencoded")>-1)return hM(e,this.formSerializer).toString();if((a=ue.isFileList(e))||i.indexOf("multipart/form-data")>-1){const l=this.env&&this.env.FormData;return ql(a?{"files[]":e}:e,l&&new l,this.formSerializer)}}return s||r?(t.setContentType("application/json",!1),mM(e)):e}],transformResponse:[function(e){const t=this.transitional||ua.transitional,i=t&&t.forcedJSONParsing,r=this.responseType==="json";if(ue.isResponse(e)||ue.isReadableStream(e))return e;if(e&&ue.isString(e)&&(i&&!this.responseType||r)){const o=!(t&&t.silentJSONParsing)&&r;try{return JSON.parse(e,this.parseReviver)}catch(a){if(o)throw a.name==="SyntaxError"?at.from(a,at.ERR_BAD_RESPONSE,this,null,this.response):a}}return e}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:xn.classes.FormData,Blob:xn.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};ue.forEach(["delete","get","head","post","put","patch"],n=>{ua.headers[n]={}});const gM=ue.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),_M=n=>{const e={};let t,i,r;return n&&n.split(`
`).forEach(function(o){r=o.indexOf(":"),t=o.substring(0,r).trim().toLowerCase(),i=o.substring(r+1).trim(),!(!t||e[t]&&gM[t])&&(t==="set-cookie"?e[t]?e[t].push(i):e[t]=[i]:e[t]=e[t]?e[t]+", "+i:i)}),e},ap=Symbol("internals");function xo(n){return n&&String(n).trim().toLowerCase()}function al(n){return n===!1||n==null?n:ue.isArray(n)?n.map(al):String(n)}function vM(n){const e=Object.create(null),t=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let i;for(;i=t.exec(n);)e[i[1]]=i[2];return e}const xM=n=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(n.trim());function bc(n,e,t,i,r){if(ue.isFunction(i))return i.call(this,e,t);if(r&&(e=t),!!ue.isString(e)){if(ue.isString(i))return e.indexOf(i)!==-1;if(ue.isRegExp(i))return i.test(e)}}function yM(n){return n.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,i)=>t.toUpperCase()+i)}function SM(n,e){const t=ue.toCamelCase(" "+e);["get","set","has"].forEach(i=>{Object.defineProperty(n,i+t,{value:function(r,s,o){return this[i].call(this,e,r,s,o)},configurable:!0})})}let Un=class{constructor(e){e&&this.set(e)}set(e,t,i){const r=this;function s(a,l,c){const u=xo(l);if(!u)throw new Error("header name must be a non-empty string");const h=ue.findKey(r,u);(!h||r[h]===void 0||c===!0||c===void 0&&r[h]!==!1)&&(r[h||l]=al(a))}const o=(a,l)=>ue.forEach(a,(c,u)=>s(c,u,l));if(ue.isPlainObject(e)||e instanceof this.constructor)o(e,t);else if(ue.isString(e)&&(e=e.trim())&&!xM(e))o(_M(e),t);else if(ue.isObject(e)&&ue.isIterable(e)){let a={},l,c;for(const u of e){if(!ue.isArray(u))throw TypeError("Object iterator must return a key-value pair");a[c=u[0]]=(l=a[c])?ue.isArray(l)?[...l,u[1]]:[l,u[1]]:u[1]}o(a,t)}else e!=null&&s(t,e,i);return this}get(e,t){if(e=xo(e),e){const i=ue.findKey(this,e);if(i){const r=this[i];if(!t)return r;if(t===!0)return vM(r);if(ue.isFunction(t))return t.call(this,r,i);if(ue.isRegExp(t))return t.exec(r);throw new TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=xo(e),e){const i=ue.findKey(this,e);return!!(i&&this[i]!==void 0&&(!t||bc(this,this[i],i,t)))}return!1}delete(e,t){const i=this;let r=!1;function s(o){if(o=xo(o),o){const a=ue.findKey(i,o);a&&(!t||bc(i,i[a],a,t))&&(delete i[a],r=!0)}}return ue.isArray(e)?e.forEach(s):s(e),r}clear(e){const t=Object.keys(this);let i=t.length,r=!1;for(;i--;){const s=t[i];(!e||bc(this,this[s],s,e,!0))&&(delete this[s],r=!0)}return r}normalize(e){const t=this,i={};return ue.forEach(this,(r,s)=>{const o=ue.findKey(i,s);if(o){t[o]=al(r),delete t[s];return}const a=e?yM(s):String(s).trim();a!==s&&delete t[s],t[a]=al(r),i[a]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){const t=Object.create(null);return ue.forEach(this,(i,r)=>{i!=null&&i!==!1&&(t[r]=e&&ue.isArray(i)?i.join(", "):i)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join(`
`)}getSetCookie(){return this.get("set-cookie")||[]}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){const i=new this(e);return t.forEach(r=>i.set(r)),i}static accessor(e){const i=(this[ap]=this[ap]={accessors:{}}).accessors,r=this.prototype;function s(o){const a=xo(o);i[a]||(SM(r,o),i[a]=!0)}return ue.isArray(e)?e.forEach(s):s(e),this}};Un.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);ue.reduceDescriptors(Un.prototype,({value:n},e)=>{let t=e[0].toUpperCase()+e.slice(1);return{get:()=>n,set(i){this[t]=i}}});ue.freezeMethods(Un);function Ec(n,e){const t=this||ua,i=e||t,r=Un.from(i.headers);let s=i.data;return ue.forEach(n,function(a){s=a.call(t,s,r.normalize(),e?e.status:void 0)}),r.normalize(),s}function K_(n){return!!(n&&n.__CANCEL__)}let fa=class extends at{constructor(e,t,i){super(e??"canceled",at.ERR_CANCELED,t,i),this.name="CanceledError",this.__CANCEL__=!0}};function Y_(n,e,t){const i=t.config.validateStatus;!t.status||!i||i(t.status)?n(t):e(new at("Request failed with status code "+t.status,[at.ERR_BAD_REQUEST,at.ERR_BAD_RESPONSE][Math.floor(t.status/100)-4],t.config,t.request,t))}function MM(n){const e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(n);return e&&e[1]||""}function bM(n,e){n=n||10;const t=new Array(n),i=new Array(n);let r=0,s=0,o;return e=e!==void 0?e:1e3,function(l){const c=Date.now(),u=i[s];o||(o=c),t[r]=l,i[r]=c;let h=s,d=0;for(;h!==r;)d+=t[h++],h=h%n;if(r=(r+1)%n,r===s&&(s=(s+1)%n),c-o<e)return;const g=u&&c-u;return g?Math.round(d*1e3/g):void 0}}function EM(n,e){let t=0,i=1e3/e,r,s;const o=(c,u=Date.now())=>{t=u,r=null,s&&(clearTimeout(s),s=null),n(...c)};return[(...c)=>{const u=Date.now(),h=u-t;h>=i?o(c,u):(r=c,s||(s=setTimeout(()=>{s=null,o(r)},i-h)))},()=>r&&o(r)]}const El=(n,e,t=3)=>{let i=0;const r=bM(50,250);return EM(s=>{const o=s.loaded,a=s.lengthComputable?s.total:void 0,l=o-i,c=r(l),u=o<=a;i=o;const h={loaded:o,total:a,progress:a?o/a:void 0,bytes:l,rate:c||void 0,estimated:c&&a&&u?(a-o)/c:void 0,event:s,lengthComputable:a!=null,[e?"download":"upload"]:!0};n(h)},t)},lp=(n,e)=>{const t=n!=null;return[i=>e[0]({lengthComputable:t,total:n,loaded:i}),e[1]]},cp=n=>(...e)=>ue.asap(()=>n(...e)),TM=xn.hasStandardBrowserEnv?((n,e)=>t=>(t=new URL(t,xn.origin),n.protocol===t.protocol&&n.host===t.host&&(e||n.port===t.port)))(new URL(xn.origin),xn.navigator&&/(msie|trident)/i.test(xn.navigator.userAgent)):()=>!0,AM=xn.hasStandardBrowserEnv?{write(n,e,t,i,r,s,o){if(typeof document>"u")return;const a=[`${n}=${encodeURIComponent(e)}`];ue.isNumber(t)&&a.push(`expires=${new Date(t).toUTCString()}`),ue.isString(i)&&a.push(`path=${i}`),ue.isString(r)&&a.push(`domain=${r}`),s===!0&&a.push("secure"),ue.isString(o)&&a.push(`SameSite=${o}`),document.cookie=a.join("; ")},read(n){if(typeof document>"u")return null;const e=document.cookie.match(new RegExp("(?:^|; )"+n+"=([^;]*)"));return e?decodeURIComponent(e[1]):null},remove(n){this.write(n,"",Date.now()-864e5,"/")}}:{write(){},read(){return null},remove(){}};function wM(n){return typeof n!="string"?!1:/^([a-z][a-z\d+\-.]*:)?\/\//i.test(n)}function RM(n,e){return e?n.replace(/\/?\/$/,"")+"/"+e.replace(/^\/+/,""):n}function $_(n,e,t){let i=!wM(e);return n&&(i||t==!1)?RM(n,e):e}const up=n=>n instanceof Un?{...n}:n;function as(n,e){e=e||{};const t={};function i(c,u,h,d){return ue.isPlainObject(c)&&ue.isPlainObject(u)?ue.merge.call({caseless:d},c,u):ue.isPlainObject(u)?ue.merge({},u):ue.isArray(u)?u.slice():u}function r(c,u,h,d){if(ue.isUndefined(u)){if(!ue.isUndefined(c))return i(void 0,c,h,d)}else return i(c,u,h,d)}function s(c,u){if(!ue.isUndefined(u))return i(void 0,u)}function o(c,u){if(ue.isUndefined(u)){if(!ue.isUndefined(c))return i(void 0,c)}else return i(void 0,u)}function a(c,u,h){if(h in e)return i(c,u);if(h in n)return i(void 0,c)}const l={url:s,method:s,data:s,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,responseEncoding:o,validateStatus:a,headers:(c,u,h)=>r(up(c),up(u),h,!0)};return ue.forEach(Object.keys({...n,...e}),function(u){if(u==="__proto__"||u==="constructor"||u==="prototype")return;const h=ue.hasOwnProp(l,u)?l[u]:r,d=h(n[u],e[u],u);ue.isUndefined(d)&&h!==a||(t[u]=d)}),t}const J_=n=>{const e=as({},n);let{data:t,withXSRFToken:i,xsrfHeaderName:r,xsrfCookieName:s,headers:o,auth:a}=e;if(e.headers=o=Un.from(o),e.url=X_($_(e.baseURL,e.url,e.allowAbsoluteUrls),n.params,n.paramsSerializer),a&&o.set("Authorization","Basic "+btoa((a.username||"")+":"+(a.password?unescape(encodeURIComponent(a.password)):""))),ue.isFormData(t)){if(xn.hasStandardBrowserEnv||xn.hasStandardBrowserWebWorkerEnv)o.setContentType(void 0);else if(ue.isFunction(t.getHeaders)){const l=t.getHeaders(),c=["content-type","content-length"];Object.entries(l).forEach(([u,h])=>{c.includes(u.toLowerCase())&&o.set(u,h)})}}if(xn.hasStandardBrowserEnv&&(i&&ue.isFunction(i)&&(i=i(e)),i||i!==!1&&TM(e.url))){const l=r&&s&&AM.read(s);l&&o.set(r,l)}return e},CM=typeof XMLHttpRequest<"u",PM=CM&&function(n){return new Promise(function(t,i){const r=J_(n);let s=r.data;const o=Un.from(r.headers).normalize();let{responseType:a,onUploadProgress:l,onDownloadProgress:c}=r,u,h,d,g,p;function x(){g&&g(),p&&p(),r.cancelToken&&r.cancelToken.unsubscribe(u),r.signal&&r.signal.removeEventListener("abort",u)}let m=new XMLHttpRequest;m.open(r.method.toUpperCase(),r.url,!0),m.timeout=r.timeout;function _(){if(!m)return;const A=Un.from("getAllResponseHeaders"in m&&m.getAllResponseHeaders()),I={data:!a||a==="text"||a==="json"?m.responseText:m.response,status:m.status,statusText:m.statusText,headers:A,config:n,request:m};Y_(function(B){t(B),x()},function(B){i(B),x()},I),m=null}"onloadend"in m?m.onloadend=_:m.onreadystatechange=function(){!m||m.readyState!==4||m.status===0&&!(m.responseURL&&m.responseURL.indexOf("file:")===0)||setTimeout(_)},m.onabort=function(){m&&(i(new at("Request aborted",at.ECONNABORTED,n,m)),m=null)},m.onerror=function(b){const I=b&&b.message?b.message:"Network Error",D=new at(I,at.ERR_NETWORK,n,m);D.event=b||null,i(D),m=null},m.ontimeout=function(){let b=r.timeout?"timeout of "+r.timeout+"ms exceeded":"timeout exceeded";const I=r.transitional||Mh;r.timeoutErrorMessage&&(b=r.timeoutErrorMessage),i(new at(b,I.clarifyTimeoutError?at.ETIMEDOUT:at.ECONNABORTED,n,m)),m=null},s===void 0&&o.setContentType(null),"setRequestHeader"in m&&ue.forEach(o.toJSON(),function(b,I){m.setRequestHeader(I,b)}),ue.isUndefined(r.withCredentials)||(m.withCredentials=!!r.withCredentials),a&&a!=="json"&&(m.responseType=r.responseType),c&&([d,p]=El(c,!0),m.addEventListener("progress",d)),l&&m.upload&&([h,g]=El(l),m.upload.addEventListener("progress",h),m.upload.addEventListener("loadend",g)),(r.cancelToken||r.signal)&&(u=A=>{m&&(i(!A||A.type?new fa(null,n,m):A),m.abort(),m=null)},r.cancelToken&&r.cancelToken.subscribe(u),r.signal&&(r.signal.aborted?u():r.signal.addEventListener("abort",u)));const M=MM(r.url);if(M&&xn.protocols.indexOf(M)===-1){i(new at("Unsupported protocol "+M+":",at.ERR_BAD_REQUEST,n));return}m.send(s||null)})},LM=(n,e)=>{const{length:t}=n=n?n.filter(Boolean):[];if(e||t){let i=new AbortController,r;const s=function(c){if(!r){r=!0,a();const u=c instanceof Error?c:this.reason;i.abort(u instanceof at?u:new fa(u instanceof Error?u.message:u))}};let o=e&&setTimeout(()=>{o=null,s(new at(`timeout of ${e}ms exceeded`,at.ETIMEDOUT))},e);const a=()=>{n&&(o&&clearTimeout(o),o=null,n.forEach(c=>{c.unsubscribe?c.unsubscribe(s):c.removeEventListener("abort",s)}),n=null)};n.forEach(c=>c.addEventListener("abort",s));const{signal:l}=i;return l.unsubscribe=()=>ue.asap(a),l}},IM=function*(n,e){let t=n.byteLength;if(t<e){yield n;return}let i=0,r;for(;i<t;)r=i+e,yield n.slice(i,r),i=r},DM=async function*(n,e){for await(const t of NM(n))yield*IM(t,e)},NM=async function*(n){if(n[Symbol.asyncIterator]){yield*n;return}const e=n.getReader();try{for(;;){const{done:t,value:i}=await e.read();if(t)break;yield i}}finally{await e.cancel()}},fp=(n,e,t,i)=>{const r=DM(n,e);let s=0,o,a=l=>{o||(o=!0,i&&i(l))};return new ReadableStream({async pull(l){try{const{done:c,value:u}=await r.next();if(c){a(),l.close();return}let h=u.byteLength;if(t){let d=s+=h;t(d)}l.enqueue(new Uint8Array(u))}catch(c){throw a(c),c}},cancel(l){return a(l),r.return()}},{highWaterMark:2})},hp=64*1024,{isFunction:Ma}=ue,UM=(({Request:n,Response:e})=>({Request:n,Response:e}))(ue.global),{ReadableStream:dp,TextEncoder:pp}=ue.global,mp=(n,...e)=>{try{return!!n(...e)}catch{return!1}},OM=n=>{n=ue.merge.call({skipUndefined:!0},UM,n);const{fetch:e,Request:t,Response:i}=n,r=e?Ma(e):typeof fetch=="function",s=Ma(t),o=Ma(i);if(!r)return!1;const a=r&&Ma(dp),l=r&&(typeof pp=="function"?(p=>x=>p.encode(x))(new pp):async p=>new Uint8Array(await new t(p).arrayBuffer())),c=s&&a&&mp(()=>{let p=!1;const x=new t(xn.origin,{body:new dp,method:"POST",get duplex(){return p=!0,"half"}}).headers.has("Content-Type");return p&&!x}),u=o&&a&&mp(()=>ue.isReadableStream(new i("").body)),h={stream:u&&(p=>p.body)};r&&["text","arrayBuffer","blob","formData","stream"].forEach(p=>{!h[p]&&(h[p]=(x,m)=>{let _=x&&x[p];if(_)return _.call(x);throw new at(`Response type '${p}' is not supported`,at.ERR_NOT_SUPPORT,m)})});const d=async p=>{if(p==null)return 0;if(ue.isBlob(p))return p.size;if(ue.isSpecCompliantForm(p))return(await new t(xn.origin,{method:"POST",body:p}).arrayBuffer()).byteLength;if(ue.isArrayBufferView(p)||ue.isArrayBuffer(p))return p.byteLength;if(ue.isURLSearchParams(p)&&(p=p+""),ue.isString(p))return(await l(p)).byteLength},g=async(p,x)=>{const m=ue.toFiniteNumber(p.getContentLength());return m??d(x)};return async p=>{let{url:x,method:m,data:_,signal:M,cancelToken:A,timeout:b,onDownloadProgress:I,onUploadProgress:D,responseType:B,headers:E,withCredentials:w="same-origin",fetchOptions:L}=J_(p),R=e||fetch;B=B?(B+"").toLowerCase():"text";let U=LM([M,A&&A.toAbortSignal()],b),H=null;const q=U&&U.unsubscribe&&(()=>{U.unsubscribe()});let J;try{if(D&&c&&m!=="get"&&m!=="head"&&(J=await g(E,_))!==0){let ne=new t(x,{method:"POST",body:_,duplex:"half"}),fe;if(ue.isFormData(_)&&(fe=ne.headers.get("content-type"))&&E.setContentType(fe),ne.body){const[ye,je]=lp(J,El(cp(D)));_=fp(ne.body,hp,ye,je)}}ue.isString(w)||(w=w?"include":"omit");const O=s&&"credentials"in t.prototype,j={...L,signal:U,method:m.toUpperCase(),headers:E.normalize().toJSON(),body:_,duplex:"half",credentials:O?w:void 0};H=s&&new t(x,j);let ie=await(s?R(H,L):R(x,j));const X=u&&(B==="stream"||B==="response");if(u&&(I||X&&q)){const ne={};["status","statusText","headers"].forEach(tt=>{ne[tt]=ie[tt]});const fe=ue.toFiniteNumber(ie.headers.get("content-length")),[ye,je]=I&&lp(fe,El(cp(I),!0))||[];ie=new i(fp(ie.body,hp,ye,()=>{je&&je(),q&&q()}),ne)}B=B||"text";let $=await h[ue.findKey(h,B)||"text"](ie,p);return!X&&q&&q(),await new Promise((ne,fe)=>{Y_(ne,fe,{data:$,headers:Un.from(ie.headers),status:ie.status,statusText:ie.statusText,config:p,request:H})})}catch(O){throw q&&q(),O&&O.name==="TypeError"&&/Load failed|fetch/i.test(O.message)?Object.assign(new at("Network Error",at.ERR_NETWORK,p,H,O&&O.response),{cause:O.cause||O}):at.from(O,O&&O.code,p,H,O&&O.response)}}},FM=new Map,Z_=n=>{let e=n&&n.env||{};const{fetch:t,Request:i,Response:r}=e,s=[i,r,t];let o=s.length,a=o,l,c,u=FM;for(;a--;)l=s[a],c=u.get(l),c===void 0&&u.set(l,c=a?new Map:OM(e)),u=c;return c};Z_();const Eh={http:eM,xhr:PM,fetch:{get:Z_}};ue.forEach(Eh,(n,e)=>{if(n){try{Object.defineProperty(n,"name",{value:e})}catch{}Object.defineProperty(n,"adapterName",{value:e})}});const gp=n=>`- ${n}`,BM=n=>ue.isFunction(n)||n===null||n===!1;function kM(n,e){n=ue.isArray(n)?n:[n];const{length:t}=n;let i,r;const s={};for(let o=0;o<t;o++){i=n[o];let a;if(r=i,!BM(i)&&(r=Eh[(a=String(i)).toLowerCase()],r===void 0))throw new at(`Unknown adapter '${a}'`);if(r&&(ue.isFunction(r)||(r=r.get(e))))break;s[a||"#"+o]=r}if(!r){const o=Object.entries(s).map(([l,c])=>`adapter ${l} `+(c===!1?"is not supported by the environment":"is not available in the build"));let a=t?o.length>1?`since :
`+o.map(gp).join(`
`):" "+gp(o[0]):"as no adapter specified";throw new at("There is no suitable adapter to dispatch the request "+a,"ERR_NOT_SUPPORT")}return r}const Q_={getAdapter:kM,adapters:Eh};function Tc(n){if(n.cancelToken&&n.cancelToken.throwIfRequested(),n.signal&&n.signal.aborted)throw new fa(null,n)}function _p(n){return Tc(n),n.headers=Un.from(n.headers),n.data=Ec.call(n,n.transformRequest),["post","put","patch"].indexOf(n.method)!==-1&&n.headers.setContentType("application/x-www-form-urlencoded",!1),Q_.getAdapter(n.adapter||ua.adapter,n)(n).then(function(i){return Tc(n),i.data=Ec.call(n,n.transformResponse,i),i.headers=Un.from(i.headers),i},function(i){return K_(i)||(Tc(n),i&&i.response&&(i.response.data=Ec.call(n,n.transformResponse,i.response),i.response.headers=Un.from(i.response.headers))),Promise.reject(i)})}const e0="1.13.6",Kl={};["object","boolean","number","function","string","symbol"].forEach((n,e)=>{Kl[n]=function(i){return typeof i===n||"a"+(e<1?"n ":" ")+n}});const vp={};Kl.transitional=function(e,t,i){function r(s,o){return"[Axios v"+e0+"] Transitional option '"+s+"'"+o+(i?". "+i:"")}return(s,o,a)=>{if(e===!1)throw new at(r(o," has been removed"+(t?" in "+t:"")),at.ERR_DEPRECATED);return t&&!vp[o]&&(vp[o]=!0),e?e(s,o,a):!0}};Kl.spelling=function(e){return(t,i)=>!0};function VM(n,e,t){if(typeof n!="object")throw new at("options must be an object",at.ERR_BAD_OPTION_VALUE);const i=Object.keys(n);let r=i.length;for(;r-- >0;){const s=i[r],o=e[s];if(o){const a=n[s],l=a===void 0||o(a,s,n);if(l!==!0)throw new at("option "+s+" must be "+l,at.ERR_BAD_OPTION_VALUE);continue}if(t!==!0)throw new at("Unknown option "+s,at.ERR_BAD_OPTION)}}const ll={assertOptions:VM,validators:Kl},qn=ll.validators;let ss=class{constructor(e){this.defaults=e||{},this.interceptors={request:new op,response:new op}}async request(e,t){try{return await this._request(e,t)}catch(i){if(i instanceof Error){let r={};Error.captureStackTrace?Error.captureStackTrace(r):r=new Error;const s=r.stack?r.stack.replace(/^.+\n/,""):"";try{i.stack?s&&!String(i.stack).endsWith(s.replace(/^.+\n.+\n/,""))&&(i.stack+=`
`+s):i.stack=s}catch{}}throw i}}_request(e,t){typeof e=="string"?(t=t||{},t.url=e):t=e||{},t=as(this.defaults,t);const{transitional:i,paramsSerializer:r,headers:s}=t;i!==void 0&&ll.assertOptions(i,{silentJSONParsing:qn.transitional(qn.boolean),forcedJSONParsing:qn.transitional(qn.boolean),clarifyTimeoutError:qn.transitional(qn.boolean),legacyInterceptorReqResOrdering:qn.transitional(qn.boolean)},!1),r!=null&&(ue.isFunction(r)?t.paramsSerializer={serialize:r}:ll.assertOptions(r,{encode:qn.function,serialize:qn.function},!0)),t.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?t.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:t.allowAbsoluteUrls=!0),ll.assertOptions(t,{baseUrl:qn.spelling("baseURL"),withXsrfToken:qn.spelling("withXSRFToken")},!0),t.method=(t.method||this.defaults.method||"get").toLowerCase();let o=s&&ue.merge(s.common,s[t.method]);s&&ue.forEach(["delete","get","head","post","put","patch","common"],p=>{delete s[p]}),t.headers=Un.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(x){if(typeof x.runWhen=="function"&&x.runWhen(t)===!1)return;l=l&&x.synchronous;const m=t.transitional||Mh;m&&m.legacyInterceptorReqResOrdering?a.unshift(x.fulfilled,x.rejected):a.push(x.fulfilled,x.rejected)});const c=[];this.interceptors.response.forEach(function(x){c.push(x.fulfilled,x.rejected)});let u,h=0,d;if(!l){const p=[_p.bind(this),void 0];for(p.unshift(...a),p.push(...c),d=p.length,u=Promise.resolve(t);h<d;)u=u.then(p[h++],p[h++]);return u}d=a.length;let g=t;for(;h<d;){const p=a[h++],x=a[h++];try{g=p(g)}catch(m){x.call(this,m);break}}try{u=_p.call(this,g)}catch(p){return Promise.reject(p)}for(h=0,d=c.length;h<d;)u=u.then(c[h++],c[h++]);return u}getUri(e){e=as(this.defaults,e);const t=$_(e.baseURL,e.url,e.allowAbsoluteUrls);return X_(t,e.params,e.paramsSerializer)}};ue.forEach(["delete","get","head","options"],function(e){ss.prototype[e]=function(t,i){return this.request(as(i||{},{method:e,url:t,data:(i||{}).data}))}});ue.forEach(["post","put","patch"],function(e){function t(i){return function(s,o,a){return this.request(as(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}ss.prototype[e]=t(),ss.prototype[e+"Form"]=t(!0)});let HM=class t0{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let t;this.promise=new Promise(function(s){t=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new fa(s,o,a),t(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const t=this._listeners.indexOf(e);t!==-1&&this._listeners.splice(t,1)}toAbortSignal(){const e=new AbortController,t=i=>{e.abort(i)};return this.subscribe(t),e.signal.unsubscribe=()=>this.unsubscribe(t),e.signal}static source(){let e;return{token:new t0(function(r){e=r}),cancel:e}}};function zM(n){return function(t){return n.apply(null,t)}}function GM(n){return ue.isObject(n)&&n.isAxiosError===!0}const tf={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries(tf).forEach(([n,e])=>{tf[e]=n});function n0(n){const e=new ss(n),t=U_(ss.prototype.request,e);return ue.extend(t,ss.prototype,e,{allOwnKeys:!0}),ue.extend(t,e,null,{allOwnKeys:!0}),t.create=function(r){return n0(as(n,r))},t}const Qt=n0(ua);Qt.Axios=ss;Qt.CanceledError=fa;Qt.CancelToken=HM;Qt.isCancel=K_;Qt.VERSION=e0;Qt.toFormData=ql;Qt.AxiosError=at;Qt.Cancel=Qt.CanceledError;Qt.all=function(e){return Promise.all(e)};Qt.spread=zM;Qt.isAxiosError=GM;Qt.mergeConfig=as;Qt.AxiosHeaders=Un;Qt.formToJSON=n=>q_(ue.isHTMLForm(n)?new FormData(n):n);Qt.getAdapter=Q_.getAdapter;Qt.HttpStatusCode=tf;Qt.default=Qt;const{Axios:RP,AxiosError:CP,CanceledError:PP,isCancel:LP,CancelToken:IP,VERSION:DP,all:NP,Cancel:UP,isAxiosError:OP,spread:FP,toFormData:BP,AxiosHeaders:kP,HttpStatusCode:VP,formToJSON:HP,getAdapter:zP,mergeConfig:GP}=Qt;var js=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function WM(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Ac={},xp;function jM(){return xp||(xp=1,(function(){var n;function e(f){var v=0;return function(){return v<f.length?{done:!1,value:f[v++]}:{done:!0}}}var t=typeof Object.defineProperties=="function"?Object.defineProperty:function(f,v,y){return f==Array.prototype||f==Object.prototype||(f[v]=y.value),f};function i(f){f=[typeof globalThis=="object"&&globalThis,f,typeof window=="object"&&window,typeof self=="object"&&self,typeof js=="object"&&js];for(var v=0;v<f.length;++v){var y=f[v];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var r=i(this);function s(f,v){if(v)e:{var y=r;f=f.split(".");for(var T=0;T<f.length-1;T++){var F=f[T];if(!(F in y))break e;y=y[F]}f=f[f.length-1],T=y[f],v=v(T),v!=T&&v!=null&&t(y,f,{configurable:!0,writable:!0,value:v})}}s("Symbol",function(f){function v(G){if(this instanceof v)throw new TypeError("Symbol is not a constructor");return new y(T+(G||"")+"_"+F++,G)}function y(G,V){this.h=G,t(this,"description",{configurable:!0,writable:!0,value:V})}if(f)return f;y.prototype.toString=function(){return this.h};var T="jscomp_symbol_"+(1e9*Math.random()>>>0)+"_",F=0;return v}),s("Symbol.iterator",function(f){if(f)return f;f=Symbol("Symbol.iterator");for(var v="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),y=0;y<v.length;y++){var T=r[v[y]];typeof T=="function"&&typeof T.prototype[f]!="function"&&t(T.prototype,f,{configurable:!0,writable:!0,value:function(){return o(e(this))}})}return f});function o(f){return f={next:f},f[Symbol.iterator]=function(){return this},f}function a(f){var v=typeof Symbol<"u"&&Symbol.iterator&&f[Symbol.iterator];return v?v.call(f):{next:e(f)}}function l(f){if(!(f instanceof Array)){f=a(f);for(var v,y=[];!(v=f.next()).done;)y.push(v.value);f=y}return f}var c=typeof Object.assign=="function"?Object.assign:function(f,v){for(var y=1;y<arguments.length;y++){var T=arguments[y];if(T)for(var F in T)Object.prototype.hasOwnProperty.call(T,F)&&(f[F]=T[F])}return f};s("Object.assign",function(f){return f||c});var u=typeof Object.create=="function"?Object.create:function(f){function v(){}return v.prototype=f,new v},h;if(typeof Object.setPrototypeOf=="function")h=Object.setPrototypeOf;else{var d;e:{var g={a:!0},p={};try{p.__proto__=g,d=p.a;break e}catch{}d=!1}h=d?function(f,v){if(f.__proto__=v,f.__proto__!==v)throw new TypeError(f+" is not extensible");return f}:null}var x=h;function m(f,v){if(f.prototype=u(v.prototype),f.prototype.constructor=f,x)x(f,v);else for(var y in v)if(y!="prototype")if(Object.defineProperties){var T=Object.getOwnPropertyDescriptor(v,y);T&&Object.defineProperty(f,y,T)}else f[y]=v[y];f.ya=v.prototype}function _(){this.m=!1,this.j=null,this.i=void 0,this.h=1,this.v=this.s=0,this.l=null}function M(f){if(f.m)throw new TypeError("Generator is already running");f.m=!0}_.prototype.u=function(f){this.i=f};function A(f,v){f.l={ma:v,na:!0},f.h=f.s||f.v}_.prototype.return=function(f){this.l={return:f},this.h=this.v};function b(f,v,y){return f.h=y,{value:v}}function I(f){this.h=new _,this.i=f}function D(f,v){M(f.h);var y=f.h.j;return y?B(f,"return"in y?y.return:function(T){return{value:T,done:!0}},v,f.h.return):(f.h.return(v),E(f))}function B(f,v,y,T){try{var F=v.call(f.h.j,y);if(!(F instanceof Object))throw new TypeError("Iterator result "+F+" is not an object");if(!F.done)return f.h.m=!1,F;var G=F.value}catch(V){return f.h.j=null,A(f.h,V),E(f)}return f.h.j=null,T.call(f.h,G),E(f)}function E(f){for(;f.h.h;)try{var v=f.i(f.h);if(v)return f.h.m=!1,{value:v.value,done:!1}}catch(y){f.h.i=void 0,A(f.h,y)}if(f.h.m=!1,f.h.l){if(v=f.h.l,f.h.l=null,v.na)throw v.ma;return{value:v.return,done:!0}}return{value:void 0,done:!0}}function w(f){this.next=function(v){return M(f.h),f.h.j?v=B(f,f.h.j.next,v,f.h.u):(f.h.u(v),v=E(f)),v},this.throw=function(v){return M(f.h),f.h.j?v=B(f,f.h.j.throw,v,f.h.u):(A(f.h,v),v=E(f)),v},this.return=function(v){return D(f,v)},this[Symbol.iterator]=function(){return this}}function L(f){function v(T){return f.next(T)}function y(T){return f.throw(T)}return new Promise(function(T,F){function G(V){V.done?T(V.value):Promise.resolve(V.value).then(v,y).then(G,F)}G(f.next())})}function R(f){return L(new w(new I(f)))}s("Promise",function(f){function v(V){this.i=0,this.j=void 0,this.h=[],this.u=!1;var Y=this.l();try{V(Y.resolve,Y.reject)}catch(le){Y.reject(le)}}function y(){this.h=null}function T(V){return V instanceof v?V:new v(function(Y){Y(V)})}if(f)return f;y.prototype.i=function(V){if(this.h==null){this.h=[];var Y=this;this.j(function(){Y.m()})}this.h.push(V)};var F=r.setTimeout;y.prototype.j=function(V){F(V,0)},y.prototype.m=function(){for(;this.h&&this.h.length;){var V=this.h;this.h=[];for(var Y=0;Y<V.length;++Y){var le=V[Y];V[Y]=null;try{le()}catch(we){this.l(we)}}}this.h=null},y.prototype.l=function(V){this.j(function(){throw V})},v.prototype.l=function(){function V(we){return function(Ne){le||(le=!0,we.call(Y,Ne))}}var Y=this,le=!1;return{resolve:V(this.I),reject:V(this.m)}},v.prototype.I=function(V){if(V===this)this.m(new TypeError("A Promise cannot resolve to itself"));else if(V instanceof v)this.L(V);else{e:switch(typeof V){case"object":var Y=V!=null;break e;case"function":Y=!0;break e;default:Y=!1}Y?this.F(V):this.s(V)}},v.prototype.F=function(V){var Y=void 0;try{Y=V.then}catch(le){this.m(le);return}typeof Y=="function"?this.M(Y,V):this.s(V)},v.prototype.m=function(V){this.v(2,V)},v.prototype.s=function(V){this.v(1,V)},v.prototype.v=function(V,Y){if(this.i!=0)throw Error("Cannot settle("+V+", "+Y+"): Promise already settled in state"+this.i);this.i=V,this.j=Y,this.i===2&&this.K(),this.H()},v.prototype.K=function(){var V=this;F(function(){if(V.D()){var Y=r.console;typeof Y<"u"&&Y.error(V.j)}},1)},v.prototype.D=function(){if(this.u)return!1;var V=r.CustomEvent,Y=r.Event,le=r.dispatchEvent;return typeof le>"u"?!0:(typeof V=="function"?V=new V("unhandledrejection",{cancelable:!0}):typeof Y=="function"?V=new Y("unhandledrejection",{cancelable:!0}):(V=r.document.createEvent("CustomEvent"),V.initCustomEvent("unhandledrejection",!1,!0,V)),V.promise=this,V.reason=this.j,le(V))},v.prototype.H=function(){if(this.h!=null){for(var V=0;V<this.h.length;++V)G.i(this.h[V]);this.h=null}};var G=new y;return v.prototype.L=function(V){var Y=this.l();V.T(Y.resolve,Y.reject)},v.prototype.M=function(V,Y){var le=this.l();try{V.call(Y,le.resolve,le.reject)}catch(we){le.reject(we)}},v.prototype.then=function(V,Y){function le(Qe,Ge){return typeof Qe=="function"?function(st){try{we(Qe(st))}catch(gt){Ne(gt)}}:Ge}var we,Ne,rt=new v(function(Qe,Ge){we=Qe,Ne=Ge});return this.T(le(V,we),le(Y,Ne)),rt},v.prototype.catch=function(V){return this.then(void 0,V)},v.prototype.T=function(V,Y){function le(){switch(we.i){case 1:V(we.j);break;case 2:Y(we.j);break;default:throw Error("Unexpected state: "+we.i)}}var we=this;this.h==null?G.i(le):this.h.push(le),this.u=!0},v.resolve=T,v.reject=function(V){return new v(function(Y,le){le(V)})},v.race=function(V){return new v(function(Y,le){for(var we=a(V),Ne=we.next();!Ne.done;Ne=we.next())T(Ne.value).T(Y,le)})},v.all=function(V){var Y=a(V),le=Y.next();return le.done?T([]):new v(function(we,Ne){function rt(st){return function(gt){Qe[st]=gt,Ge--,Ge==0&&we(Qe)}}var Qe=[],Ge=0;do Qe.push(void 0),Ge++,T(le.value).T(rt(Qe.length-1),Ne),le=Y.next();while(!le.done)})},v});function U(f,v){f instanceof String&&(f+="");var y=0,T=!1,F={next:function(){if(!T&&y<f.length){var G=y++;return{value:v(G,f[G]),done:!1}}return T=!0,{done:!0,value:void 0}}};return F[Symbol.iterator]=function(){return F},F}s("Array.prototype.keys",function(f){return f||function(){return U(this,function(v){return v})}}),s("Array.prototype.fill",function(f){return f||function(v,y,T){var F=this.length||0;for(0>y&&(y=Math.max(0,F+y)),(T==null||T>F)&&(T=F),T=Number(T),0>T&&(T=Math.max(0,F+T)),y=Number(y||0);y<T;y++)this[y]=v;return this}});function H(f){return f||Array.prototype.fill}s("Int8Array.prototype.fill",H),s("Uint8Array.prototype.fill",H),s("Uint8ClampedArray.prototype.fill",H),s("Int16Array.prototype.fill",H),s("Uint16Array.prototype.fill",H),s("Int32Array.prototype.fill",H),s("Uint32Array.prototype.fill",H),s("Float32Array.prototype.fill",H),s("Float64Array.prototype.fill",H),s("Object.is",function(f){return f||function(v,y){return v===y?v!==0||1/v===1/y:v!==v&&y!==y}}),s("Array.prototype.includes",function(f){return f||function(v,y){var T=this;T instanceof String&&(T=String(T));var F=T.length;for(y=y||0,0>y&&(y=Math.max(y+F,0));y<F;y++){var G=T[y];if(G===v||Object.is(G,v))return!0}return!1}}),s("String.prototype.includes",function(f){return f||function(v,y){if(this==null)throw new TypeError("The 'this' value for String.prototype.includes must not be null or undefined");if(v instanceof RegExp)throw new TypeError("First argument to String.prototype.includes must not be a regular expression");return this.indexOf(v,y||0)!==-1}});var q=this||self;function J(f,v){f=f.split(".");var y=q;f[0]in y||typeof y.execScript>"u"||y.execScript("var "+f[0]);for(var T;f.length&&(T=f.shift());)f.length||v===void 0?y[T]&&y[T]!==Object.prototype[T]?y=y[T]:y=y[T]={}:y[T]=v}function O(f){var v;e:{if((v=q.navigator)&&(v=v.userAgent))break e;v=""}return v.indexOf(f)!=-1}var j=Array.prototype.map?function(f,v){return Array.prototype.map.call(f,v,void 0)}:function(f,v){for(var y=f.length,T=Array(y),F=typeof f=="string"?f.split(""):f,G=0;G<y;G++)G in F&&(T[G]=v.call(void 0,F[G],G,f));return T},ie={},X=null;function $(f){var v=f.length,y=3*v/4;y%3?y=Math.floor(y):"=.".indexOf(f[v-1])!=-1&&(y="=.".indexOf(f[v-2])!=-1?y-2:y-1);var T=new Uint8Array(y),F=0;return ne(f,function(G){T[F++]=G}),F!==y?T.subarray(0,F):T}function ne(f,v){function y(le){for(;T<f.length;){var we=f.charAt(T++),Ne=X[we];if(Ne!=null)return Ne;if(!/^[\s\xa0]*$/.test(we))throw Error("Unknown base64 encoding at char: "+we)}return le}fe();for(var T=0;;){var F=y(-1),G=y(0),V=y(64),Y=y(64);if(Y===64&&F===-1)break;v(F<<2|G>>4),V!=64&&(v(G<<4&240|V>>2),Y!=64&&v(V<<6&192|Y))}}function fe(){if(!X){X={};for(var f="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),v=["+/=","+/","-_=","-_.","-_"],y=0;5>y;y++){var T=f.concat(v[y].split(""));ie[y]=T;for(var F=0;F<T.length;F++){var G=T[F];X[G]===void 0&&(X[G]=F)}}}}var ye=typeof Uint8Array<"u",je=!(O("Trident")||O("MSIE"))&&typeof q.btoa=="function";function tt(f){if(!je){var v;v===void 0&&(v=0),fe(),v=ie[v];for(var y=Array(Math.floor(f.length/3)),T=v[64]||"",F=0,G=0;F<f.length-2;F+=3){var V=f[F],Y=f[F+1],le=f[F+2],we=v[V>>2];V=v[(V&3)<<4|Y>>4],Y=v[(Y&15)<<2|le>>6],le=v[le&63],y[G++]=we+V+Y+le}switch(we=0,le=T,f.length-F){case 2:we=f[F+1],le=v[(we&15)<<2]||T;case 1:f=f[F],y[G]=v[f>>2]+v[(f&3)<<4|we>>4]+le+T}return y.join("")}for(v="";10240<f.length;)v+=String.fromCharCode.apply(null,f.subarray(0,10240)),f=f.subarray(10240);return v+=String.fromCharCode.apply(null,f),btoa(v)}var he=RegExp("[-_.]","g");function Se(f){switch(f){case"-":return"+";case"_":return"/";case".":return"=";default:return""}}function Me(f){if(!je)return $(f);he.test(f)&&(f=f.replace(he,Se)),f=atob(f);for(var v=new Uint8Array(f.length),y=0;y<f.length;y++)v[y]=f.charCodeAt(y);return v}var Le;function Ae(){return Le||(Le=new Uint8Array(0))}var Fe={},k=typeof Uint8Array.prototype.slice=="function",z=0,Z=0;function ge(f){var v=0>f;f=Math.abs(f);var y=f>>>0;f=Math.floor((f-y)/4294967296),v&&(y=a(_e(y,f)),v=y.next().value,f=y.next().value,y=v),z=y>>>0,Z=f>>>0}var ae=typeof BigInt=="function";function _e(f,v){return v=~v,f?f=~f+1:v+=1,[f,v]}function N(f,v){this.i=f>>>0,this.h=v>>>0}function Ee(f){if(!f)return ve||(ve=new N(0,0));if(!/^-?\d+$/.test(f))return null;if(16>f.length)ge(Number(f));else if(ae)f=BigInt(f),z=Number(f&BigInt(4294967295))>>>0,Z=Number(f>>BigInt(32)&BigInt(4294967295));else{var v=+(f[0]==="-");Z=z=0;for(var y=f.length,T=v,F=(y-v)%6+v;F<=y;T=F,F+=6)T=Number(f.slice(T,F)),Z*=1e6,z=1e6*z+T,4294967296<=z&&(Z+=z/4294967296|0,z%=4294967296);v&&(v=a(_e(z,Z)),f=v.next().value,v=v.next().value,z=f,Z=v)}return new N(z,Z)}var ve;function me(f,v){return Error("Invalid wire type: "+f+" (at position "+v+")")}function xe(){return Error("Failed to read varint, encoding is invalid.")}function C(f,v){return Error("Tried to read past the end of the data "+v+" > "+f)}function S(){throw Error("Invalid UTF8")}function W(f,v){return v=String.fromCharCode.apply(null,v),f==null?v:f+v}var re=void 0,de,se=typeof TextDecoder<"u",Ue,Te=typeof TextEncoder<"u",qe;function $e(f){if(f!==Fe)throw Error("illegal external caller")}function be(f,v){if($e(v),this.V=f,f!=null&&f.length===0)throw Error("ByteString should be constructed with non-empty values")}function Ce(){return qe||(qe=new be(null,Fe))}function Oe(f){$e(Fe);var v=f.V;return v=v==null||ye&&v!=null&&v instanceof Uint8Array?v:typeof v=="string"?Me(v):null,v==null?v:f.V=v}function ze(f){if(typeof f=="string")return{buffer:Me(f),C:!1};if(Array.isArray(f))return{buffer:new Uint8Array(f),C:!1};if(f.constructor===Uint8Array)return{buffer:f,C:!1};if(f.constructor===ArrayBuffer)return{buffer:new Uint8Array(f),C:!1};if(f.constructor===be)return{buffer:Oe(f)||Ae(),C:!0};if(f instanceof Uint8Array)return{buffer:new Uint8Array(f.buffer,f.byteOffset,f.byteLength),C:!1};throw Error("Type not convertible to a Uint8Array, expected a Uint8Array, an ArrayBuffer, a base64 encoded string, a ByteString or an Array of numbers")}function Ve(f,v){this.i=null,this.m=!1,this.h=this.j=this.l=0,lt(this,f,v)}function lt(f,v,y){y=y===void 0?{}:y,f.S=y.S===void 0?!1:y.S,v&&(v=ze(v),f.i=v.buffer,f.m=v.C,f.l=0,f.j=f.i.length,f.h=f.l)}Ve.prototype.reset=function(){this.h=this.l};function K(f,v){if(f.h=v,v>f.j)throw C(f.j,v)}function Ie(f){var v=f.i,y=f.h,T=v[y++],F=T&127;if(T&128&&(T=v[y++],F|=(T&127)<<7,T&128&&(T=v[y++],F|=(T&127)<<14,T&128&&(T=v[y++],F|=(T&127)<<21,T&128&&(T=v[y++],F|=T<<28,T&128&&v[y++]&128&&v[y++]&128&&v[y++]&128&&v[y++]&128&&v[y++]&128)))))throw xe();return K(f,y),F}function Pe(f,v){if(0>v)throw Error("Tried to read a negative byte length: "+v);var y=f.h,T=y+v;if(T>f.j)throw C(v,f.j-y);return f.h=T,y}var Ke=[];function Re(){this.h=[]}Re.prototype.length=function(){return this.h.length},Re.prototype.end=function(){var f=this.h;return this.h=[],f};function pe(f,v,y){for(;0<y||127<v;)f.h.push(v&127|128),v=(v>>>7|y<<25)>>>0,y>>>=7;f.h.push(v)}function Xe(f,v){for(;127<v;)f.h.push(v&127|128),v>>>=7;f.h.push(v)}function it(f,v){if(Ke.length){var y=Ke.pop();lt(y,f,v),f=y}else f=new Ve(f,v);this.h=f,this.j=this.h.h,this.i=this.l=-1,this.setOptions(v)}it.prototype.setOptions=function(f){f=f===void 0?{}:f,this.ca=f.ca===void 0?!1:f.ca},it.prototype.reset=function(){this.h.reset(),this.j=this.h.h,this.i=this.l=-1};function Ct(f){var v=f.h;if(v.h==v.j)return!1;f.j=f.h.h;var y=Ie(f.h)>>>0;if(v=y>>>3,y&=7,!(0<=y&&5>=y))throw me(y,f.j);if(1>v)throw Error("Invalid field number: "+v+" (at position "+f.j+")");return f.l=v,f.i=y,!0}function Mt(f){switch(f.i){case 0:if(f.i!=0)Mt(f);else e:{f=f.h;for(var v=f.h,y=v+10,T=f.i;v<y;)if((T[v++]&128)===0){K(f,v);break e}throw xe()}break;case 1:f=f.h,K(f,f.h+8);break;case 2:f.i!=2?Mt(f):(v=Ie(f.h)>>>0,f=f.h,K(f,f.h+v));break;case 5:f=f.h,K(f,f.h+4);break;case 3:v=f.l;do{if(!Ct(f))throw Error("Unmatched start-group tag: stream EOF");if(f.i==4){if(f.l!=v)throw Error("Unmatched end-group tag");break}Mt(f)}while(!0);break;default:throw me(f.i,f.j)}}var Rn=[];function ti(){this.j=[],this.i=0,this.h=new Re}function zi(f,v){v.length!==0&&(f.j.push(v),f.i+=v.length)}function lo(f,v){if(v=v.R){zi(f,f.h.end());for(var y=0;y<v.length;y++)zi(f,Oe(v[y])||Ae())}}var ni=typeof Symbol=="function"&&typeof Symbol()=="symbol"?Symbol():void 0;function _i(f,v){return ni?f[ni]|=v:f.A!==void 0?f.A|=v:(Object.defineProperties(f,{A:{value:v,configurable:!0,writable:!0,enumerable:!1}}),v)}function co(f,v){ni?f[ni]&&(f[ni]&=~v):f.A!==void 0&&(f.A&=~v)}function Pt(f){var v;return ni?v=f[ni]:v=f.A,v??0}function Cn(f,v){ni?f[ni]=v:f.A!==void 0?f.A=v:Object.defineProperties(f,{A:{value:v,configurable:!0,writable:!0,enumerable:!1}})}function us(f){return _i(f,1),f}function da(f,v){Cn(v,(f|0)&-51)}function Gi(f,v){Cn(v,(f|18)&-41)}var fs={};function Wi(f){return f!==null&&typeof f=="object"&&!Array.isArray(f)&&f.constructor===Object}var _r,uo=[];Cn(uo,23),_r=Object.freeze(uo);function fo(f){if(Pt(f.o)&2)throw Error("Cannot mutate an immutable Message")}function ho(f){var v=f.length;(v=v?f[v-1]:void 0)&&Wi(v)?v.g=1:(v={},f.push((v.g=1,v)))}function pa(f){var v=f.i+f.G;return f.B||(f.B=f.o[v]={})}function Fn(f,v){return v===-1?null:v>=f.i?f.B?f.B[v]:void 0:f.o[v+f.G]}function Wn(f,v,y,T){fo(f),Fr(f,v,y,T)}function Fr(f,v,y,T){f.j&&(f.j=void 0),v>=f.i||T?pa(f)[v]=y:(f.o[v+f.G]=y,(f=f.B)&&v in f&&delete f[v])}function P(f,v,y,T){var F=Fn(f,v);Array.isArray(F)||(F=_r);var G=Pt(F);if(G&1||us(F),T)G&2||_i(F,2),y&1||Object.freeze(F);else{T=!(y&2);var V=G&2;y&1||!V?T&&G&16&&!V&&co(F,16):(F=us(Array.prototype.slice.call(F)),Fr(f,v,F))}return F}function Q(f,v){var y=Fn(f,v),T=y==null?y:typeof y=="number"||y==="NaN"||y==="Infinity"||y==="-Infinity"?Number(y):void 0;return T!=null&&T!==y&&Fr(f,v,T),T}function ce(f,v,y,T,F){f.h||(f.h={});var G=f.h[y],V=P(f,y,3,F);if(!G){var Y=V;G=[];var le=!!(Pt(f.o)&16);V=!!(Pt(Y)&2);var we=Y;!F&&V&&(Y=Array.prototype.slice.call(Y));for(var Ne=V,rt=0;rt<Y.length;rt++){var Qe=Y[rt],Ge=v,st=!1;if(st=st===void 0?!1:st,Qe=Array.isArray(Qe)?new Ge(Qe):st?new Ge:void 0,Qe!==void 0){Ge=Qe.o;var gt=st=Pt(Ge);V&&(gt|=2),le&&(gt|=16),gt!=st&&Cn(Ge,gt),Ge=gt,Ne=Ne||!!(2&Ge),G.push(Qe)}}return f.h[y]=G,le=Pt(Y),v=le|33,v=Ne?v&-9:v|8,le!=v&&(Ne=Y,Object.isFrozen(Ne)&&(Ne=Array.prototype.slice.call(Ne)),Cn(Ne,v),Y=Ne),we!==Y&&Fr(f,y,Y),(F||T&&V)&&_i(G,2),T&&Object.freeze(G),G}return F||(F=Object.isFrozen(G),T&&!F?Object.freeze(G):!T&&F&&(G=Array.prototype.slice.call(G),f.h[y]=G)),G}function oe(f,v,y){var T=!!(Pt(f.o)&2);if(v=ce(f,v,y,T,T),f=P(f,y,3,T),!(T||Pt(f)&8)){for(T=0;T<v.length;T++){if(y=v[T],Pt(y.o)&2){var F=en(y,!1);F.j=y}else F=y;y!==F&&(v[T]=F,f[T]=F.o)}_i(f,8)}return v}function te(f,v,y){if(y!=null&&typeof y!="number")throw Error("Value of float/double field must be a number|null|undefined, found "+typeof y+": "+y);Wn(f,v,y)}function Be(f,v,y,T,F){fo(f);var G=ce(f,y,v,!1,!1);return y=T??new y,f=P(f,v,2,!1),F!=null?(G.splice(F,0,y),f.splice(F,0,y.o)):(G.push(y),f.push(y.o)),y.C()&&co(f,8),y}function We(f,v){return f??v}function De(f,v,y){return y=y===void 0?0:y,We(Q(f,v),y)}var Ye;function Je(f){switch(typeof f){case"number":return isFinite(f)?f:String(f);case"object":if(f)if(Array.isArray(f)){if((Pt(f)&128)!==0)return f=Array.prototype.slice.call(f),ho(f),f}else{if(ye&&f!=null&&f instanceof Uint8Array)return tt(f);if(f instanceof be){var v=f.V;return v==null?"":typeof v=="string"?v:f.V=tt(v)}}}return f}function ct(f,v,y,T){if(f!=null){if(Array.isArray(f))f=ht(f,v,y,T!==void 0);else if(Wi(f)){var F={},G;for(G in f)F[G]=ct(f[G],v,y,T);f=F}else f=v(f,T);return f}}function ht(f,v,y,T){var F=Pt(f);T=T?!!(F&16):void 0,f=Array.prototype.slice.call(f);for(var G=0;G<f.length;G++)f[G]=ct(f[G],v,y,T);return y(F,f),f}function Ze(f){return f.ja===fs?f.toJSON():Je(f)}function At(f,v){f&128&&ho(v)}function Ht(f,v,y){if(y=y===void 0?Gi:y,f!=null){if(ye&&f instanceof Uint8Array)return f.length?new be(new Uint8Array(f),Fe):Ce();if(Array.isArray(f)){var T=Pt(f);return T&2?f:v&&!(T&32)&&(T&16||T===0)?(Cn(f,T|2),f):(f=ht(f,Ht,T&4?Gi:y,!0),v=Pt(f),v&4&&v&2&&Object.freeze(f),f)}return f.ja===fs?Tt(f):f}}function Bt(f,v,y,T,F,G,V){if(f=f.h&&f.h[y]){if(T=Pt(f),T&2?T=f:(G=j(f,Tt),Gi(T,G),Object.freeze(G),T=G),fo(v),V=T==null?_r:us([]),T!=null){for(G=!!T.length,f=0;f<T.length;f++){var Y=T[f];G=G&&!(Pt(Y.o)&2),V[f]=Y.o}G=(G?8:0)|1,f=Pt(V),(f&G)!==G&&(Object.isFrozen(V)&&(V=Array.prototype.slice.call(V)),Cn(V,f|G)),v.h||(v.h={}),v.h[y]=T}else v.h&&(v.h[y]=void 0);Fr(v,y,V,F)}else Wn(v,y,Ht(T,G,V),F)}function Tt(f){return Pt(f.o)&2||(f=en(f,!0),_i(f.o,2)),f}function en(f,v){var y=f.o,T=[];_i(T,16);var F=f.constructor.h;if(F&&T.push(F),F=f.B,F){T.length=y.length,T.fill(void 0,T.length,y.length);var G={};T[T.length-1]=G}(Pt(y)&128)!==0&&ho(T),v=v||f.C()?Gi:da,G=f.constructor,Ye=T,T=new G(T),Ye=void 0,f.R&&(T.R=f.R.slice()),G=!!(Pt(y)&16);for(var V=F?y.length-1:y.length,Y=0;Y<V;Y++)Bt(f,T,Y-f.G,y[Y],!1,G,v);if(F)for(var le in F)Bt(f,T,+le,F[le],!0,G,v);return T}function He(f,v,y){f==null&&(f=Ye),Ye=void 0;var T=this.constructor.i||0,F=0<T,G=this.constructor.h,V=!1;if(f==null){f=G?[G]:[];var Y=48,le=!0;F&&(T=0,Y|=128),Cn(f,Y)}else{if(!Array.isArray(f)||G&&G!==f[0])throw Error();var we=Y=_i(f,0);if((le=(16&we)!==0)&&((V=(32&we)!==0)||(we|=32)),F){if(128&we)T=0;else if(0<f.length){var Ne=f[f.length-1];if(Wi(Ne)&&"g"in Ne){T=0,we|=128,delete Ne.g;var rt=!0,Qe;for(Qe in Ne){rt=!1;break}rt&&f.pop()}}}else if(128&we)throw Error();Y!==we&&Cn(f,we)}this.G=(G?0:-1)-T,this.h=void 0,this.o=f;e:{if(G=this.o.length,T=G-1,G&&(G=this.o[T],Wi(G))){this.B=G,this.i=T-this.G;break e}v!==void 0&&-1<v?(this.i=Math.max(v,T+1-this.G),this.B=void 0):this.i=Number.MAX_VALUE}if(!F&&this.B&&"g"in this.B)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(y){v=le&&!V&&!0,F=this.i;var Ge;for(le=0;le<y.length;le++)V=y[le],V<F?(V+=this.G,(T=f[V])?fn(T,v):f[V]=_r):(Ge||(Ge=pa(this)),(T=Ge[V])?fn(T,v):Ge[V]=_r)}}He.prototype.toJSON=function(){return ht(this.o,Ze,At)},He.prototype.C=function(){return!!(Pt(this.o)&2)};function fn(f,v){if(Array.isArray(f)){var y=Pt(f),T=1;!v||y&2||(T|=16),(y&T)!==T&&Cn(f,y|T)}}He.prototype.ja=fs,He.prototype.toString=function(){return this.o.toString()};function xt(f,v,y){if(y){var T={},F;for(F in y){var G=y[F],V=G.qa;V||(T.J=G.wa||G.oa.W,G.ia?(T.aa=ri(G.ia),V=(function(Y){return function(le,we,Ne){return Y.J(le,we,Ne,Y.aa)}})(T)):G.ka?(T.Z=ji(G.da.P,G.ka),V=(function(Y){return function(le,we,Ne){return Y.J(le,we,Ne,Y.Z)}})(T)):V=T.J,G.qa=V),V(v,f,G.da),T={J:T.J,aa:T.aa,Z:T.Z}}}lo(v,f)}var hn=Symbol();function Bn(f,v,y){return f[hn]||(f[hn]=function(T,F){return v(T,F,y)})}function vi(f){var v=f[hn];if(!v){var y=rc(f);v=function(T,F){return Kh(T,F,y)},f[hn]=v}return v}function vr(f){var v=f.ia;if(v)return vi(v);if(v=f.va)return Bn(f.da.P,v,f.ka)}function Lt(f){var v=vr(f),y=f.da,T=f.oa.U;return v?function(F,G){return T(F,G,y,v)}:function(F,G){return T(F,G,y)}}function Kt(f,v){var y=f[v];return typeof y=="function"&&y.length===0&&(y=y(),f[v]=y),Array.isArray(y)&&(po in y||xr in y||0<y.length&&typeof y[0]=="function")?y:void 0}function ii(f,v,y,T,F,G){v.P=f[0];var V=1;if(f.length>V&&typeof f[V]!="number"){var Y=f[V++];y(v,Y)}for(;V<f.length;){y=f[V++];for(var le=V+1;le<f.length&&typeof f[le]!="number";)le++;switch(Y=f[V++],le-=V,le){case 0:T(v,y,Y);break;case 1:(le=Kt(f,V))?(V++,F(v,y,Y,le)):T(v,y,Y,f[V++]);break;case 2:le=V++,le=Kt(f,le),F(v,y,Y,le,f[V++]);break;case 3:G(v,y,Y,f[V++],f[V++],f[V++]);break;case 4:G(v,y,Y,f[V++],f[V++],f[V++],f[V++]);break;default:throw Error("unexpected number of binary field arguments: "+le)}}return v}var zt=Symbol();function ri(f){var v=f[zt];if(!v){var y=ic(f);v=function(T,F){return Yh(T,F,y)},f[zt]=v}return v}function ji(f,v){var y=f[zt];return y||(y=function(T,F){return xt(T,F,v)},f[zt]=y),y}var xr=Symbol();function Q0(f,v){f.push(v)}function ev(f,v,y){f.push(v,y.W)}function tv(f,v,y,T){var F=ri(T),G=ic(T).P,V=y.W;f.push(v,function(Y,le,we){return V(Y,le,we,G,F)})}function nv(f,v,y,T,F,G){var V=ji(T,G),Y=y.W;f.push(v,function(le,we,Ne){return Y(le,we,Ne,T,V)})}function ic(f){var v=f[xr];return v||(v=ii(f,f[xr]=[],Q0,ev,tv,nv),po in f&&xr in f&&(f.length=0),v)}var po=Symbol();function iv(f,v){f[0]=v}function rv(f,v,y,T){var F=y.U;f[v]=T?function(G,V,Y){return F(G,V,Y,T)}:F}function sv(f,v,y,T,F){var G=y.U,V=vi(T),Y=rc(T).P;f[v]=function(le,we,Ne){return G(le,we,Ne,Y,V,F)}}function ov(f,v,y,T,F,G,V){var Y=y.U,le=Bn(T,F,G);f[v]=function(we,Ne,rt){return Y(we,Ne,rt,T,le,V)}}function rc(f){var v=f[po];return v||(v=ii(f,f[po]={},iv,rv,sv,ov),po in f&&xr in f&&(f.length=0),v)}function Kh(f,v,y){for(;Ct(v)&&v.i!=4;){var T=v.l,F=y[T];if(!F){var G=y[0];G&&(G=G[T])&&(F=y[T]=Lt(G))}if(!F||!F(v,f,T)){F=v,T=f,G=F.j,Mt(F);var V=F;if(!V.ca){if(F=V.h.h-G,V.h.h=G,V=V.h,F==0)F=Ce();else{if(G=Pe(V,F),V.S&&V.m)F=V.i.subarray(G,G+F);else{V=V.i;var Y=G;F=G+F,F=Y===F?Ae():k?V.slice(Y,F):new Uint8Array(V.subarray(Y,F))}F=F.length==0?Ce():new be(F,Fe)}(G=T.R)?G.push(F):T.R=[F]}}}return f}function Yh(f,v,y){for(var T=y.length,F=T%2==1,G=F?1:0;G<T;G+=2)(0,y[G+1])(v,f,y[G]);xt(f,v,F?y[0]:void 0)}function mo(f,v){return{U:f,W:v}}var si=mo(function(f,v,y){if(f.i!==5)return!1;f=f.h;var T=f.i,F=f.h,G=T[F],V=T[F+1],Y=T[F+2];return T=T[F+3],K(f,f.h+4),V=(G<<0|V<<8|Y<<16|T<<24)>>>0,f=2*(V>>31)+1,G=V>>>23&255,V&=8388607,Wn(v,y,G==255?V?NaN:1/0*f:G==0?f*Math.pow(2,-149)*V:f*Math.pow(2,G-150)*(V+Math.pow(2,23))),!0},function(f,v,y){if(v=Q(v,y),v!=null){Xe(f.h,8*y+5),f=f.h;var T=+v;T===0?0<1/T?z=Z=0:(Z=0,z=2147483648):isNaN(T)?(Z=0,z=2147483647):(T=(y=0>T?-2147483648:0)?-T:T,34028234663852886e22<T?(Z=0,z=(y|2139095040)>>>0):11754943508222875e-54>T?(T=Math.round(T/Math.pow(2,-149)),Z=0,z=(y|T)>>>0):(v=Math.floor(Math.log(T)/Math.LN2),T*=Math.pow(2,-v),T=Math.round(8388608*T),16777216<=T&&++v,Z=0,z=(y|v+127<<23|T&8388607)>>>0)),y=z,f.h.push(y>>>0&255),f.h.push(y>>>8&255),f.h.push(y>>>16&255),f.h.push(y>>>24&255)}}),av=mo(function(f,v,y){if(f.i!==0)return!1;var T=f.h,F=0,G=f=0,V=T.i,Y=T.h;do{var le=V[Y++];F|=(le&127)<<G,G+=7}while(32>G&&le&128);for(32<G&&(f|=(le&127)>>4),G=3;32>G&&le&128;G+=7)le=V[Y++],f|=(le&127)<<G;if(K(T,Y),128>le)T=F>>>0,le=f>>>0,(f=le&2147483648)&&(T=~T+1>>>0,le=~le>>>0,T==0&&(le=le+1>>>0)),T=4294967296*le+(T>>>0);else throw xe();return Wn(v,y,f?-T:T),!0},function(f,v,y){v=Fn(v,y),v!=null&&(typeof v=="string"&&Ee(v),v!=null&&(Xe(f.h,8*y),typeof v=="number"?(f=f.h,ge(v),pe(f,z,Z)):(y=Ee(v),pe(f.h,y.i,y.h))))}),lv=mo(function(f,v,y){return f.i!==0?!1:(Wn(v,y,Ie(f.h)),!0)},function(f,v,y){if(v=Fn(v,y),v!=null&&v!=null)if(Xe(f.h,8*y),f=f.h,y=v,0<=y)Xe(f,y);else{for(v=0;9>v;v++)f.h.push(y&127|128),y>>=7;f.h.push(1)}}),$h=mo(function(f,v,y){if(f.i!==2)return!1;var T=Ie(f.h)>>>0;f=f.h;var F=Pe(f,T);if(f=f.i,se){var G=f,V;(V=de)||(V=de=new TextDecoder("utf-8",{fatal:!0})),f=F+T,G=F===0&&f===G.length?G:G.subarray(F,f);try{var Y=V.decode(G)}catch(rt){if(re===void 0){try{V.decode(new Uint8Array([128]))}catch{}try{V.decode(new Uint8Array([97])),re=!0}catch{re=!1}}throw!re&&(de=void 0),rt}}else{Y=F,T=Y+T,F=[];for(var le=null,we,Ne;Y<T;)we=f[Y++],128>we?F.push(we):224>we?Y>=T?S():(Ne=f[Y++],194>we||(Ne&192)!==128?(Y--,S()):F.push((we&31)<<6|Ne&63)):240>we?Y>=T-1?S():(Ne=f[Y++],(Ne&192)!==128||we===224&&160>Ne||we===237&&160<=Ne||((G=f[Y++])&192)!==128?(Y--,S()):F.push((we&15)<<12|(Ne&63)<<6|G&63)):244>=we?Y>=T-2?S():(Ne=f[Y++],(Ne&192)!==128||(we<<28)+(Ne-144)>>30!==0||((G=f[Y++])&192)!==128||((V=f[Y++])&192)!==128?(Y--,S()):(we=(we&7)<<18|(Ne&63)<<12|(G&63)<<6|V&63,we-=65536,F.push((we>>10&1023)+55296,(we&1023)+56320))):S(),8192<=F.length&&(le=W(le,F),F.length=0);Y=W(le,F)}return Wn(v,y,Y),!0},function(f,v,y){if(v=Fn(v,y),v!=null){var T=!1;if(T=T===void 0?!1:T,Te){if(T&&/(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])/.test(v))throw Error("Found an unpaired surrogate");v=(Ue||(Ue=new TextEncoder)).encode(v)}else{for(var F=0,G=new Uint8Array(3*v.length),V=0;V<v.length;V++){var Y=v.charCodeAt(V);if(128>Y)G[F++]=Y;else{if(2048>Y)G[F++]=Y>>6|192;else{if(55296<=Y&&57343>=Y){if(56319>=Y&&V<v.length){var le=v.charCodeAt(++V);if(56320<=le&&57343>=le){Y=1024*(Y-55296)+le-56320+65536,G[F++]=Y>>18|240,G[F++]=Y>>12&63|128,G[F++]=Y>>6&63|128,G[F++]=Y&63|128;continue}else V--}if(T)throw Error("Found an unpaired surrogate");Y=65533}G[F++]=Y>>12|224,G[F++]=Y>>6&63|128}G[F++]=Y&63|128}}v=F===G.length?G:G.subarray(0,F)}Xe(f.h,8*y+2),Xe(f.h,v.length),zi(f,f.h.end()),zi(f,v)}}),Jh=mo(function(f,v,y,T,F){if(f.i!==2)return!1;v=Be(v,y,T),y=f.h.j,T=Ie(f.h)>>>0;var G=f.h.h+T,V=G-y;if(0>=V&&(f.h.j=G,F(v,f,void 0,void 0,void 0),V=G-f.h.h),V)throw Error("Message parsing ended unexpectedly. Expected to read "+(T+" bytes, instead read "+(T-V)+" bytes, either the data ended unexpectedly or the message misreported its own length"));return f.h.h=G,f.h.j=y,!0},function(f,v,y,T,F){if(v=oe(v,T,y),v!=null)for(T=0;T<v.length;T++){var G=f;Xe(G.h,8*y+2);var V=G.h.end();zi(G,V),V.push(G.i),G=V,F(v[T],f),V=f;var Y=G.pop();for(Y=V.i+V.h.length()-Y;127<Y;)G.push(Y&127|128),Y>>>=7,V.i++;G.push(Y),V.i++}});function sc(f){return function(v,y){e:{if(Rn.length){var T=Rn.pop();T.setOptions(y),lt(T.h,v,y),v=T}else v=new it(v,y);try{var F=rc(f),G=Kh(new F.P,v,F);break e}finally{F=v.h,F.i=null,F.m=!1,F.l=0,F.j=0,F.h=0,F.S=!1,v.l=-1,v.i=-1,100>Rn.length&&Rn.push(v)}G=void 0}return G}}function oc(f){return function(){var v=new ti;Yh(this,v,ic(f)),zi(v,v.h.end());for(var y=new Uint8Array(v.i),T=v.j,F=T.length,G=0,V=0;V<F;V++){var Y=T[V];y.set(Y,G),G+=Y.length}return v.j=[y],y}}function hs(f){He.call(this,f)}m(hs,He);var Zh=[hs,1,lv,2,si,3,$h,4,$h];hs.prototype.l=oc(Zh);function ac(f){He.call(this,f,-1,cv)}m(ac,He),ac.prototype.addClassification=function(f,v){return Be(this,1,hs,f,v),this};var cv=[1],Qh=sc([ac,1,Jh,Zh]);function ds(f){He.call(this,f)}m(ds,He);var ed=[ds,1,si,2,si,3,si,4,si,5,si];ds.prototype.l=oc(ed);function td(f){He.call(this,f,-1,uv)}m(td,He);var uv=[1],nd=sc([td,1,Jh,ed]);function ma(f){He.call(this,f)}m(ma,He);var id=[ma,1,si,2,si,3,si,4,si,5,si,6,av],fv=sc(id);ma.prototype.l=oc(id);function rd(f,v,y){if(y=f.createShader(y===0?f.VERTEX_SHADER:f.FRAGMENT_SHADER),f.shaderSource(y,v),f.compileShader(y),!f.getShaderParameter(y,f.COMPILE_STATUS))throw Error(`Could not compile WebGL shader.

`+f.getShaderInfoLog(y));return y}function sd(f){return oe(f,hs,1).map(function(v){var y=Fn(v,1);return{index:y??0,score:De(v,2),label:Fn(v,3)!=null?We(Fn(v,3),""):void 0,displayName:Fn(v,4)!=null?We(Fn(v,4),""):void 0}})}function od(f){return{x:De(f,1),y:De(f,2),z:De(f,3),visibility:Q(f,4)!=null?De(f,4):void 0}}function ad(f){return f.map(function(v){return oe(nd(v),ds,1).map(od)})}function lc(f,v){this.i=f,this.h=v,this.m=0}function ld(f,v,y){return hv(f,v),typeof f.h.canvas.transferToImageBitmap=="function"?Promise.resolve(f.h.canvas.transferToImageBitmap()):y?Promise.resolve(f.h.canvas):typeof createImageBitmap=="function"?createImageBitmap(f.h.canvas):(f.j===void 0&&(f.j=document.createElement("canvas")),new Promise(function(T){f.j.height=f.h.canvas.height,f.j.width=f.h.canvas.width,f.j.getContext("2d",{}).drawImage(f.h.canvas,0,0,f.h.canvas.width,f.h.canvas.height),T(f.j)}))}function hv(f,v){var y=f.h;if(f.s===void 0){var T=rd(y,`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,pt={alphahash_fragment:dT,alphahash_pars_fragment:pT,alphamap_fragment:mT,alphamap_pars_fragment:gT,alphatest_fragment:_T,alphatest_pars_fragment:vT,aomap_fragment:xT,aomap_pars_fragment:yT,batching_pars_vertex:ST,batching_vertex:MT,begin_vertex:bT,beginnormal_vertex:ET,bsdfs:TT,iridescence_fragment:AT,bumpmap_pars_fragment:wT,clipping_planes_fragment:RT,clipping_planes_pars_fragment:CT,clipping_planes_pars_vertex:PT,clipping_planes_vertex:LT,color_fragment:IT,color_pars_fragment:DT,color_pars_vertex:NT,color_vertex:UT,common:OT,cube_uv_reflection_fragment:FT,defaultnormal_vertex:BT,displacementmap_pars_vertex:kT,displacementmap_vertex:VT,emissivemap_fragment:HT,emissivemap_pars_fragment:zT,colorspace_fragment:GT,colorspace_pars_fragment:WT,envmap_fragment:jT,envmap_common_pars_fragment:XT,envmap_pars_fragment:qT,envmap_pars_vertex:KT,envmap_physical_pars_fragment:sA,envmap_vertex:YT,fog_vertex:$T,fog_pars_vertex:JT,fog_fragment:ZT,fog_pars_fragment:QT,gradientmap_pars_fragment:eA,lightmap_pars_fragment:tA,lights_lambert_fragment:nA,lights_lambert_pars_fragment:iA,lights_pars_begin:rA,lights_toon_fragment:oA,lights_toon_pars_fragment:aA,lights_phong_fragment:lA,lights_phong_pars_fragment:cA,lights_physical_fragment:uA,lights_physical_pars_fragment:fA,lights_fragment_begin:hA,lights_fragment_maps:dA,lights_fragment_end:pA,logdepthbuf_fragment:mA,logdepthbuf_pars_fragment:gA,logdepthbuf_pars_vertex:_A,logdepthbuf_vertex:vA,map_fragment:xA,map_pars_fragment:yA,map_particle_fragment:SA,map_particle_pars_fragment:MA,metalnessmap_fragment:bA,metalnessmap_pars_fragment:EA,morphinstance_vertex:TA,morphcolor_vertex:AA,morphnormal_vertex:wA,morphtarget_pars_vertex:RA,morphtarget_vertex:CA,normal_fragment_begin:PA,normal_fragment_maps:LA,normal_pars_fragment:IA,normal_pars_vertex:DA,normal_vertex:NA,normalmap_pars_fragment:UA,clearcoat_normal_fragment_begin:OA,clearcoat_normal_fragment_maps:FA,clearcoat_pars_fragment:BA,iridescence_pars_fragment:kA,opaque_fragment:VA,packing:HA,premultiplied_alpha_fragment:zA,project_vertex:GA,dithering_fragment:WA,dithering_pars_fragment:jA,roughnessmap_fragment:XA,roughnessmap_pars_fragment:qA,shadowmap_pars_fragment:KA,shadowmap_pars_vertex:YA,shadowmap_vertex:$A,shadowmask_pars_fragment:JA,skinbase_vertex:ZA,skinning_pars_vertex:QA,skinning_vertex:ew,skinnormal_vertex:tw,specularmap_fragment:nw,specularmap_pars_fragment:iw,tonemapping_fragment:rw,tonemapping_pars_fragment:sw,transmission_fragment:ow,transmission_pars_fragment:aw,uv_pars_fragment:lw,uv_pars_vertex:cw,uv_vertex:uw,worldpos_vertex:fw,background_vert:hw,background_frag:dw,backgroundCube_vert:pw,backgroundCube_frag:mw,cube_vert:gw,cube_frag:_w,depth_vert:vw,depth_frag:xw,distance_vert:yw,distance_frag:Sw,equirect_vert:Mw,equirect_frag:bw,linedashed_vert:Ew,linedashed_frag:Tw,meshbasic_vert:Aw,meshbasic_frag:ww,meshlambert_vert:Rw,meshlambert_frag:Cw,meshmatcap_vert:Pw,meshmatcap_frag:Lw,meshnormal_vert:Iw,meshnormal_frag:Dw,meshphong_vert:Nw,meshphong_frag:Uw,meshphysical_vert:Ow,meshphysical_frag:Fw,meshtoon_vert:Bw,meshtoon_frag:kw,points_vert:Vw,points_frag:Hw,shadow_vert:zw,shadow_frag:Gw,sprite_vert:Ww,sprite_frag:jw},ke={common:{diffuse:{value:new ft(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new dt},alphaMap:{value:null},alphaMapTransform:{value:new dt},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new dt}},envmap:{envMap:{value:null},envMapRotation:{value:new dt},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new dt}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new dt}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new dt},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new dt},normalScale:{value:new St(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new dt},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new dt}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new dt}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new dt}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new ft(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new ft(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new dt},alphaTest:{value:0},uvTransform:{value:new dt}},sprite:{diffuse:{value:new ft(16777215)},opacity:{value:1},center:{value:new St(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new dt},alphaMap:{value:null},alphaMapTransform:{value:new dt},alphaTest:{value:0}}},Ri={basic:{uniforms:Tn([ke.common,ke.specularmap,ke.envmap,ke.aomap,ke.lightmap,ke.fog]),vertexShader:pt.meshbasic_vert,fragmentShader:pt.meshbasic_frag},lambert:{uniforms:Tn([ke.common,ke.specularmap,ke.envmap,ke.aomap,ke.lightmap,ke.emissivemap,ke.bumpmap,ke.normalmap,ke.displacementmap,ke.fog,ke.lights,{emissive:{value:new ft(0)},envMapIntensity:{value:1}}]),vertexShader:pt.meshlambert_vert,fragmentShader:pt.meshlambert_frag},phong:{uniforms:Tn([ke.common,ke.specularmap,ke.envmap,ke.aomap,ke.lightmap,ke.emissivemap,ke.bumpmap,ke.normalmap,ke.displacementmap,ke.fog,ke.lights,{emissive:{value:new ft(0)},specular:{value:new ft(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:pt.meshphong_vert,fragmentShader:pt.meshphong_frag},standard:{uniforms:Tn([ke.common,ke.envmap,ke.aomap,ke.lightmap,ke.emissivemap,ke.bumpmap,ke.normalmap,ke.displacementmap,ke.roughnessmap,ke.metalnessmap,ke.fog,ke.lights,{emissive:{value:new ft(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:pt.meshphysical_vert,fragmentShader:pt.meshphysical_frag},toon:{uniforms:Tn([ke.common,ke.aomap,ke.lightmap,ke.emissivemap,ke.bumpmap,ke.normalmap,ke.displacementmap,ke.gradientmap,ke.fog,ke.lights,{emissive:{value:new ft(0)}}]),vertexShader:pt.meshtoon_vert,fragmentShader:pt.meshtoon_frag},matcap:{uniforms:Tn([ke.common,ke.bumpmap,ke.normalmap,ke.displacementmap,ke.fog,{matcap:{value:null}}]),vertexShader:pt.meshmatcap_vert,fragmentShader:pt.meshmatcap_frag},points:{uniforms:Tn([ke.points,ke.fog]),vertexShader:pt.points_vert,fragmentShader:pt.points_frag},dashed:{uniforms:Tn([ke.common,ke.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:pt.linedashed_vert,fragmentShader:pt.linedashed_frag},depth:{uniforms:Tn([ke.common,ke.displacementmap]),vertexShader:pt.depth_vert,fragmentShader:pt.depth_frag},normal:{uniforms:Tn([ke.common,ke.bumpmap,ke.normalmap,ke.displacementmap,{opacity:{value:1}}]),vertexShader:pt.meshnormal_vert,fragmentShader:pt.meshnormal_frag},sprite:{uniforms:Tn([ke.sprite,ke.fog]),vertexShader:pt.sprite_vert,fragmentShader:pt.sprite_frag},background:{uniforms:{uvTransform:{value:new dt},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:pt.background_vert,fragmentShader:pt.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new dt}},vertexShader:pt.backgroundCube_vert,fragmentShader:pt.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:pt.cube_vert,fragmentShader:pt.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:pt.equirect_vert,fragmentShader:pt.equirect_frag},distance:{uniforms:Tn([ke.common,ke.displacementmap,{referencePosition:{value:new ee},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:pt.distance_vert,fragmentShader:pt.distance_frag},shadow:{uniforms:Tn([ke.lights,ke.fog,{color:{value:new ft(0)},opacity:{value:1}}]),vertexShader:pt.shadow_vert,fragmentShader:pt.shadow_frag}};Ri.physical={uniforms:Tn([Ri.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new dt},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new dt},clearcoatNormalScale:{value:new St(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new dt},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new dt},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new dt},sheen:{value:0},sheenColor:{value:new ft(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new dt},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new dt},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new dt},transmissionSamplerSize:{value:new St},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new dt},attenuationDistance:{value:0},attenuationColor:{value:new ft(0)},specularColor:{value:new ft(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new dt},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new dt},anisotropyVector:{value:new St},anisotropyMap:{value:null},anisotropyMapTransform:{value:new dt}}]),vertexShader:pt.meshphysical_vert,fragmentShader:pt.meshphysical_frag};const Za={r:0,b:0,g:0},jr=new Bi,Xw=new mt;function qw(n,e,t,i,r,s){const o=new ft(0);let a=r===!0?0:1,l,c,u=null,h=0,d=null;function g(M){let A=M.isScene===!0?M.background:null;if(A&&A.isTexture){const b=M.backgroundBlurriness>0;A=e.get(A,b)}return A}function p(M){let A=!1;const b=g(M);b===null?m(o,a):b&&b.isColor&&(m(b,1),A=!0);const I=n.xr.getEnvironmentBlendMode();I==="additive"?t.buffers.color.setClear(0,0,0,1,s):I==="alpha-blend"&&t.buffers.color.setClear(0,0,0,0,s),(n.autoClear||A)&&(t.buffers.depth.setTest(!0),t.buffers.depth.setMask(!0),t.buffers.color.setMask(!0),n.clear(n.autoClearColor,n.autoClearDepth,n.autoClearStencil))}function x(M,A){const b=g(A);b&&(b.isCubeTexture||b.mapping===Yl)?(c===void 0&&(c=new Gn(new ha(1,1,1),new ki({name:"BackgroundCubeMaterial",uniforms:Js(Ri.backgroundCube.uniforms),vertexShader:Ri.backgroundCube.vertexShader,fragmentShader:Ri.backgroundCube.fragmentShader,side:On,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute("normal"),c.geometry.deleteAttribute("uv"),c.onBeforeRender=function(I,D,B){this.matrixWorld.copyPosition(B.matrixWorld)},Object.defineProperty(c.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),i.update(c)),jr.copy(A.backgroundRotation),jr.x*=-1,jr.y*=-1,jr.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(jr.y*=-1,jr.z*=-1),c.material.uniforms.envMap.value=b,c.material.uniforms.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,c.material.uniforms.backgroundBlurriness.value=A.backgroundBlurriness,c.material.uniforms.backgroundIntensity.value=A.backgroundIntensity,c.material.uniforms.backgroundRotation.value.setFromMatrix4(Xw.makeRotationFromEuler(jr)),c.material.toneMapped=yt.getTransfer(b.colorSpace)!==It,(u!==b||h!==b.version||d!==n.toneMapping)&&(c.material.needsUpdate=!0,u=b,h=b.version,d=n.toneMapping),c.layers.enableAll(),M.unshift(c,c.geometry,c.material,0,0,null)):b&&b.isTexture&&(l===void 0&&(l=new Gn(new Zl(2,2),new ki({name:"BackgroundMaterial",uniforms:Js(Ri.background.uniforms),vertexShader:Ri.background.vertexShader,fragmentShader:Ri.background.fragmentShader,side:fr,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute("normal"),Object.defineProperty(l.material,"map",{get:function(){return this.uniforms.t2D.value}}),i.update(l)),l.material.uniforms.t2D.value=b,l.material.uniforms.backgroundIntensity.value=A.backgroundIntensity,l.material.toneMapped=yt.getTransfer(b.colorSpace)!==It,b.matrixAutoUpdate===!0&&b.updateMatrix(),l.material.uniforms.uvTransform.value.copy(b.matrix),(u!==b||h!==b.version||d!==n.toneMapping)&&(l.material.needsUpdate=!0,u=b,h=b.version,d=n.toneMapping),l.layers.enableAll(),M.unshift(l,l.geometry,l.material,0,0,null))}function m(M,A){M.getRGB(Za,O0(n)),t.buffers.color.setClear(Za.r,Za.g,Za.b,A,s)}function _(){c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0),l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0)}return{getClearColor:function(){return o},setClearColor:function(M,A=1){o.set(M),a=A,m(o,a)},getClearAlpha:function(){return a},setClearAlpha:function(M){a=M,m(o,a)},render:p,addToRenderList:x,dispose:_}}function Kw(n,e){const t=n.getParameter(n.MAX_VERTEX_ATTRIBS),i={},r=d(null);let s=r,o=!1;function a(R,U,H,q,J){let O=!1;const j=h(R,q,H,U);s!==j&&(s=j,c(s.object)),O=g(R,q,H,J),O&&p(R,q,H,J),J!==null&&e.update(J,n.ELEMENT_ARRAY_BUFFER),(O||o)&&(o=!1,b(R,U,H,q),J!==null&&n.bindBuffer(n.ELEMENT_ARRAY_BUFFER,e.get(J).buffer))}function l(){return n.createVertexArray()}function c(R){return n.bindVertexArray(R)}function u(R){return n.deleteVertexArray(R)}function h(R,U,H,q){const J=q.wireframe===!0;let O=i[U.id];O===void 0&&(O={},i[U.id]=O);const j=R.isInstancedMesh===!0?R.id:0;let ie=O[j];ie===void 0&&(ie={},O[j]=ie);let X=ie[H.id];X===void 0&&(X={},ie[H.id]=X);let $=X[J];return $===void 0&&($=d(l()),X[J]=$),$}function d(R){const U=[],H=[],q=[];for(let J=0;J<t;J++)U[J]=0,H[J]=0,q[J]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:U,enabledAttributes:H,attributeDivisors:q,object:R,attributes:{},index:null}}function g(R,U,H,q){const J=s.attributes,O=U.attributes;let j=0;const ie=H.getAttributes();for(const X in ie)if(ie[X].location>=0){const ne=J[X];let fe=O[X];if(fe===void 0&&(X==="instanceMatrix"&&R.instanceMatrix&&(fe=R.instanceMatrix),X==="instanceColor"&&R.instanceColor&&(fe=R.instanceColor)),ne===void 0||ne.attribute!==fe||fe&&ne.data!==fe.data)return!0;j++}return s.attributesNum!==j||s.index!==q}function p(R,U,H,q){const J={},O=U.attributes;let j=0;const ie=H.getAttributes();for(const X in ie)if(ie[X].location>=0){let ne=O[X];ne===void 0&&(X==="instanceMatrix"&&R.instanceMatrix&&(ne=R.instanceMatrix),X==="instanceColor"&&R.instanceColor&&(ne=R.instanceColor));const fe={};fe.attribute=ne,ne&&ne.data&&(fe.data=ne.data),J[X]=fe,j++}s.attributes=J,s.attributesNum=j,s.index=q}function x(){const R=s.newAttributes;for(let U=0,H=R.length;U<H;U++)R[U]=0}function m(R){_(R,0)}function _(R,U){const H=s.newAttributes,q=s.enabledAttributes,J=s.attributeDivisors;H[R]=1,q[R]===0&&(n.enableVertexAttribArray(R),q[R]=1),J[R]!==U&&(n.vertexAttribDivisor(R,U),J[R]=U)}function M(){const R=s.newAttributes,U=s.enabledAttributes;for(let H=0,q=U.length;H<q;H++)U[H]!==R[H]&&(n.disableVertexAttribArray(H),U[H]=0)}function A(R,U,H,q,J,O,j){j===!0?n.vertexAttribIPointer(R,U,H,J,O):n.vertexAttribPointer(R,U,H,q,J,O)}function b(R,U,H,q){x();const J=q.attributes,O=H.getAttributes(),j=U.defaultAttributeValues;for(const ie in O){const X=O[ie];if(X.location>=0){let $=J[ie];if($===void 0&&(ie==="instanceMatrix"&&R.instanceMatrix&&($=R.instanceMatrix),ie==="instanceColor"&&R.instanceColor&&($=R.instanceColor)),$!==void 0){const ne=$.normalized,fe=$.itemSize,ye=e.get($);if(ye===void 0)continue;const je=ye.buffer,tt=ye.type,he=ye.bytesPerElement,Se=tt===n.INT||tt===n.UNSIGNED_INT||$.gpuType===Ah;if($.isInterleavedBufferAttribute){const Me=$.data,Le=Me.stride,Ae=$.offset;if(Me.isInstancedInterleavedBuffer){for(let Fe=0;Fe<X.locationSize;Fe++)_(X.location+Fe,Me.meshPerAttribute);R.isInstancedMesh!==!0&&q._maxInstanceCount===void 0&&(q._maxInstanceCount=Me.meshPerAttribute*Me.count)}else for(let Fe=0;Fe<X.locationSize;Fe++)m(X.location+Fe);n.bindBuffer(n.ARRAY_BUFFER,je);for(let Fe=0;Fe<X.locationSize;Fe++)A(X.location+Fe,fe/X.locationSize,tt,ne,Le*he,(Ae+fe/X.locationSize*Fe)*he,Se)}else{if($.isInstancedBufferAttribute){for(let Me=0;Me<X.locationSize;Me++)_(X.location+Me,$.meshPerAttribute);R.isInstancedMesh!==!0&&q._maxInstanceCount===void 0&&(q._maxInstanceCount=$.meshPerAttribute*$.count)}else for(let Me=0;Me<X.locationSize;Me++)m(X.location+Me);n.bindBuffer(n.ARRAY_BUFFER,je);for(let Me=0;Me<X.locationSize;Me++)A(X.location+Me,fe/X.locationSize,tt,ne,fe*he,fe/X.locationSize*Me*he,Se)}}else if(j!==void 0){const ne=j[ie];if(ne!==void 0)switch(ne.length){case 2:n.vertexAttrib2fv(X.location,ne);break;case 3:n.vertexAttrib3fv(X.location,ne);break;case 4:n.vertexAttrib4fv(X.location,ne);break;default:n.vertexAttrib1fv(X.location,ne)}}}}M()}function I(){w();for(const R in i){const U=i[R];for(const H in U){const q=U[H];for(const J in q){const O=q[J];for(const j in O)u(O[j].object),delete O[j];delete q[J]}}delete i[R]}}function D(R){if(i[R.id]===void 0)return;const U=i[R.id];for(const H in U){const q=U[H];for(const J in q){const O=q[J];for(const j in O)u(O[j].object),delete O[j];delete q[J]}}delete i[R.id]}function B(R){for(const U in i){const H=i[U];for(const q in H){const J=H[q];if(J[R.id]===void 0)continue;const O=J[R.id];for(const j in O)u(O[j].object),delete O[j];delete J[R.id]}}}function E(R){for(const U in i){const H=i[U],q=R.isInstancedMesh===!0?R.id:0,J=H[q];if(J!==void 0){for(const O in J){const j=J[O];for(const ie in j)u(j[ie].object),delete j[ie];delete J[O]}delete H[q],Object.keys(H).length===0&&delete i[U]}}}function w(){L(),o=!0,s!==r&&(s=r,c(s.object))}function L(){r.geometry=null,r.program=null,r.wireframe=!1}return{setup:a,reset:w,resetDefaultState:L,dispose:I,releaseStatesOfGeometry:D,releaseStatesOfObject:E,releaseStatesOfProgram:B,initAttributes:x,enableAttribute:m,disableUnusedAttributes:M}}function Yw(n,e,t){let i;function r(c){i=c}function s(c,u){n.drawArrays(i,c,u),t.update(u,i,1)}function o(c,u,h){h!==0&&(n.drawArraysInstanced(i,c,u,h),t.update(u,i,h))}function a(c,u,h){if(h===0)return;e.get("WEBGL_multi_draw").multiDrawArraysWEBGL(i,c,0,u,0,h);let g=0;for(let p=0;p<h;p++)g+=u[p];t.update(g,i,1)}function l(c,u,h,d){if(h===0)return;const g=e.get("WEBGL_multi_draw");if(g===null)for(let p=0;p<c.length;p++)o(c[p],u[p],d[p]);else{g.multiDrawArraysInstancedWEBGL(i,c,0,u,0,d,0,h);let p=0;for(let x=0;x<h;x++)p+=u[x]*d[x];t.update(p,i,1)}}this.setMode=r,this.render=s,this.renderInstances=o,this.renderMultiDraw=a,this.renderMultiDrawInstances=l}function $w(n,e,t,i){let r;function s(){if(r!==void 0)return r;if(e.has("EXT_texture_filter_anisotropic")===!0){const B=e.get("EXT_texture_filter_anisotropic");r=n.getParameter(B.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else r=0;return r}function o(B){return!(B!==Zn&&i.convert(B)!==n.getParameter(n.IMPLEMENTATION_COLOR_READ_FORMAT))}function a(B){const E=B===hr&&(e.has("EXT_color_buffer_half_float")||e.has("EXT_color_buffer_float"));return!(B!==Hn&&i.convert(B)!==n.getParameter(n.IMPLEMENTATION_COLOR_READ_TYPE)&&B!==Jn&&!E)}function l(B){if(B==="highp"){if(n.getShaderPrecisionFormat(n.VERTEX_SHADER,n.HIGH_FLOAT).precision>0&&n.getShaderPrecisionFormat(n.FRAGMENT_SHADER,n.HIGH_FLOAT).precision>0)return"highp";B="mediump"}return B==="mediump"&&n.getShaderPrecisionFormat(n.VERTEX_SHADER,n.MEDIUM_FLOAT).precision>0&&n.getShaderPrecisionFormat(n.FRAGMENT_SHADER,n.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=t.precision!==void 0?t.precision:"highp";const u=l(c);u!==c&&(et("WebGLRenderer:",c,"not supported, using",u,"instead."),c=u);const h=t.logarithmicDepthBuffer===!0,d=t.reversedDepthBuffer===!0&&e.has("EXT_clip_control"),g=n.getParameter(n.MAX_TEXTURE_IMAGE_UNITS),p=n.getParameter(n.MAX_VERTEX_TEXTURE_IMAGE_UNITS),x=n.getParameter(n.MAX_TEXTURE_SIZE),m=n.getParameter(n.MAX_CUBE_MAP_TEXTURE_SIZE),_=n.getParameter(n.MAX_VERTEX_ATTRIBS),M=n.getParameter(n.MAX_VERTEX_UNIFORM_VECTORS),A=n.getParameter(n.MAX_VARYING_VECTORS),b=n.getParameter(n.MAX_FRAGMENT_UNIFORM_VECTORS),I=n.getParameter(n.MAX_SAMPLES),D=n.getParameter(n.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:s,getMaxPrecision:l,textureFormatReadable:o,textureTypeReadable:a,precision:c,logarithmicDepthBuffer:h,reversedDepthBuffer:d,maxTextures:g,maxVertexTextures:p,maxTextureSize:x,maxCubemapSize:m,maxAttributes:_,maxVertexUniforms:M,maxVaryings:A,maxFragmentUniforms:b,maxSamples:I,samples:D}}function Jw(n){const e=this;let t=null,i=0,r=!1,s=!1;const o=new Yr,a=new dt,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(h,d){const g=h.length!==0||d||i!==0||r;return r=d,i=h.length,g},this.beginShadows=function(){s=!0,u(null)},this.endShadows=function(){s=!1},this.setGlobalState=function(h,d){t=u(h,d,0)},this.setState=function(h,d,g){const p=h.clippingPlanes,x=h.clipIntersection,m=h.clipShadows,_=n.get(h);if(!r||p===null||p.length===0||s&&!m)s?u(null):c();else{const M=s?0:i,A=M*4;let b=_.clippingState||null;l.value=b,b=u(p,d,A,g);for(let I=0;I!==A;++I)b[I]=t[I];_.clippingState=b,this.numIntersection=x?this.numPlanes:0,this.numPlanes+=M}};function c(){l.value!==t&&(l.value=t,l.needsUpdate=i>0),e.numPlanes=i,e.numIntersection=0}function u(h,d,g,p){const x=h!==null?h.length:0;let m=null;if(x!==0){if(m=l.value,p!==!0||m===null){const _=g+x*4,M=d.matrixWorldInverse;a.getNormalMatrix(M),(m===null||m.length<_)&&(m=new Float32Array(_));for(let A=0,b=g;A!==x;++A,b+=4)o.copy(h[A]).applyMatrix4(M,a),o.normal.toArray(m,b),m[b+3]=o.constant}l.value=m,l.needsUpdate=!0}return e.numPlanes=x,e.numIntersection=0,m}}const Ir=4,gm=[.125,.215,.35,.446,.526,.582],Zr=20,Zw=256,wo=new ec,_m=new ft;let ou=null,au=0,lu=0,cu=!1;const Qw=new ee;class vm{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(e,t=0,i=.1,r=100,s={}){const{size:o=256,position:a=Qw}=s;ou=this._renderer.getRenderTarget(),au=this._renderer.getActiveCubeFace(),lu=this._renderer.getActiveMipmapLevel(),cu=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(o);const l=this._allocateTargets();return l.depthBuffer=!0,this._sceneToCubeUV(e,i,r,l,a),t>0&&this._blur(l,0,0,t),this._applyPMREM(l),this._cleanup(l),l}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Sm(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=ym(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodMeshes.length;e++)this._lodMeshes[e].geometry.dispose()}_cleanup(e){this._renderer.setRenderTarget(ou,au,lu),this._renderer.xr.enabled=cu,e.scissorTest=!1,Ps(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===ls||e.mapping===qs?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),ou=this._renderer.getRenderTarget(),au=this._renderer.getActiveCubeFace(),lu=this._renderer.getActiveMipmapLevel(),cu=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const i=t||this._allocateTargets();return this._textureToCubeUV(e,i),this._applyPMREM(i),this._cleanup(i),i}_allocateTargets(){const e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,i={magFilter:jt,minFilter:jt,generateMipmaps:!1,type:hr,format:Zn,colorSpace:Mn,depthBuffer:!1},r=xm(e,t,i);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=xm(e,t,i);const{_lodMax:s}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=eR(s)),this._blurMaterial=nR(s,e,t),this._ggxMaterial=tR(s,e,t)}return r}_compileMaterial(e){const t=new Gn(new un,e);this._renderer.compile(t,wo)}_sceneToCubeUV(e,t,i,r,s){const l=new Dn(90,1,t,i),c=[1,-1,1,1,1,1],u=[1,1,1,-1,-1,-1],h=this._renderer,d=h.autoClear,g=h.toneMapping;h.getClearColor(_m),h.toneMapping=Ni,h.autoClear=!1,h.state.buffers.depth.getReversed()&&(h.setRenderTarget(r),h.clearDepth(),h.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new Gn(new ha,new ns({name:"PMREM.Background",side:On,depthWrite:!1,depthTest:!1})));const x=this._backgroundBox,m=x.material;let _=!1;const M=e.background;M?M.isColor&&(m.color.copy(M),e.background=null,_=!0):(m.color.copy(_m),_=!0);for(let A=0;A<6;A++){const b=A%3;b===0?(l.up.set(0,c[A],0),l.position.set(s.x,s.y,s.z),l.lookAt(s.x+u[A],s.y,s.z)):b===1?(l.up.set(0,0,c[A]),l.position.set(s.x,s.y,s.z),l.lookAt(s.x,s.y+u[A],s.z)):(l.up.set(0,c[A],0),l.position.set(s.x,s.y,s.z),l.lookAt(s.x,s.y,s.z+u[A]));const I=this._cubeSize;Ps(r,b*I,A>2?I:0,I,I),h.setRenderTarget(r),_&&h.render(x,l),h.render(e,l)}h.toneMapping=g,h.autoClear=d,e.background=M}_textureToCubeUV(e,t){const i=this._renderer,r=e.mapping===ls||e.mapping===qs;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=Sm()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=ym());const s=r?this._cubemapMaterial:this._equirectMaterial,o=this._lodMeshes[0];o.material=s;const a=s.uniforms;a.envMap.value=e;const l=this._cubeSize;Ps(t,0,0,3*l,2*l),i.setRenderTarget(t),i.render(o,wo)}_applyPMREM(e){const t=this._renderer,i=t.autoClear;t.autoClear=!1;const r=this._lodMeshes.length;for(let s=1;s<r;s++)this._applyGGXFilter(e,s-1,s);t.autoClear=i}_applyGGXFilter(e,t,i){const r=this._renderer,s=this._pingPongRenderTarget,o=this._ggxMaterial,a=this._lodMeshes[i];a.material=o;const l=o.uniforms,c=i/(this._lodMeshes.length-1),u=t/(this._lodMeshes.length-1),h=Math.sqrt(c*c-u*u),d=0+c*1.25,g=h*d,{_lodMax:p}=this,x=this._sizeLods[i],m=3*x*(i>p-Ir?i-p+Ir:0),_=4*(this._cubeSize-x);l.envMap.value=e.texture,l.roughness.value=g,l.mipInt.value=p-t,Ps(s,m,_,3*x,2*x),r.setRenderTarget(s),r.render(a,wo),l.envMap.value=s.texture,l.roughness.value=0,l.mipInt.value=p-i,Ps(e,m,_,3*x,2*x),r.setRenderTarget(e),r.render(a,wo)}_blur(e,t,i,r,s){const o=this._pingPongRenderTarget;this._halfBlur(e,o,t,i,r,"latitudinal",s),this._halfBlur(o,e,i,i,r,"longitudinal",s)}_halfBlur(e,t,i,r,s,o,a){const l=this._renderer,c=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&ot("blur direction must be either latitudinal or longitudinal!");const u=3,h=this._lodMeshes[r];h.material=c;const d=c.uniforms,g=this._sizeLods[i]-1,p=isFinite(s)?Math.PI/(2*g):2*Math.PI/(2*Zr-1),x=s/p,m=isFinite(s)?1+Math.floor(u*x):Zr;m>Zr&&et(`sigmaRadians, ${s}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Zr}`);const _=[];let M=0;for(let B=0;B<Zr;++B){const E=B/x,w=Math.exp(-E*E/2);_.push(w),B===0?M+=w:B<m&&(M+=2*w)}for(let B=0;B<_.length;B++)_[B]=_[B]/M;d.envMap.value=e.texture,d.samples.value=m,d.weights.value=_,d.latitudinal.value=o==="latitudinal",a&&(d.poleAxis.value=a);const{_lodMax:A}=this;d.dTheta.value=p,d.mipInt.value=A-i;const b=this._sizeLods[r],I=3*b*(r>A-Ir?r-A+Ir:0),D=4*(this._cubeSize-b);Ps(t,I,D,3*b,2*b),l.setRenderTarget(t),l.render(h,wo)}}function eR(n){const e=[],t=[],i=[];let r=n;const s=n-Ir+1+gm.length;for(let o=0;o<s;o++){const a=Math.pow(2,r);e.push(a);let l=1/a;o>n-Ir?l=gm[o-n+Ir-1]:o===0&&(l=0),t.push(l);const c=1/(a-2),u=-c,h=1+c,d=[u,u,h,u,h,h,u,u,h,h,u,h],g=6,p=6,x=3,m=2,_=1,M=new Float32Array(x*p*g),A=new Float32Array(m*p*g),b=new Float32Array(_*p*g);for(let D=0;D<g;D++){const B=D%3*2/3-1,E=D>2?0:-1,w=[B,E,0,B+2/3,E,0,B+2/3,E+1,0,B,E,0,B+2/3,E+1,0,B,E+1,0];M.set(w,x*p*D),A.set(d,m*p*D);const L=[D,D,D,D,D,D];b.set(L,_*p*D)}const I=new un;I.setAttribute("position",new cn(M,x)),I.setAttribute("uv",new cn(A,m)),I.setAttribute("faceIndex",new cn(b,_)),i.push(new Gn(I,null)),r>Ir&&r--}return{lodMeshes:i,sizeLods:e,sigmas:t}}function xm(n,e,t){const i=new Ui(n,e,t);return i.texture.mapping=Yl,i.texture.name="PMREM.cubeUv",i.scissorTest=!0,i}function Ps(n,e,t,i,r){n.viewport.set(e,t,i,r),n.scissor.set(e,t,i,r)}function tR(n,e,t){return new ki({name:"PMREMGGXConvolution",defines:{GGX_SAMPLES:Zw,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function nR(n,e,t){const i=new Float32Array(Zr),r=new ee(0,1,0);return new ki({name:"SphericalGaussianBlur",defines:{n:Zr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function ym(){return new ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function Sm(){return new ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
	...
	`}class H0 extends Ui{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new L0(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new ha(5,5,5),s=new ki({name:"CubemapFromEquirect",uniforms:Js(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:On,blending:or});s.uniforms.tEquirect.value=t;const o=new Gn(r,s),a=t.minFilter;return t.minFilter===rr&&(t.minFilter=jt),new eT(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,i,r);e.setRenderTarget(s)}}function iR(n){let e=new WeakMap,t=new WeakMap,i=null;function r(d,g=!1){return d==null?null:g?o(d):s(d)}function s(d){if(d&&d.isTexture){const g=d.mapping;if(g===Cc||g===Pc)if(e.has(d)){const p=e.get(d).texture;return a(p,d.mapping)}else{const p=d.image;if(p&&p.height>0){const x=new H0(p.height);return x.fromEquirectangularTexture(n,d),e.set(d,x),d.addEventListener("dispose",c),a(x.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const g=d.mapping,p=g===Cc||g===Pc,x=g===ls||g===qs;if(p||x){let m=t.get(d);const _=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==_)return i===null&&(i=new vm(n)),m=p?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),m.texture;if(m!==void 0)return m.texture;{const M=d.image;return p&&M&&M.height>0||x&&M&&l(M)?(i===null&&(i=new vm(n)),m=p?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),d.addEventListener("dispose",u),m.texture):null}}}return d}function a(d,g){return g===Cc?d.mapping=ls:g===Pc&&(d.mapping=qs),d}function l(d){let g=0;const p=6;for(let x=0;x<p;x++)d[x]!==void 0&&g++;return g===p}function c(d){const g=d.target;g.removeEventListener("dispose",c);const p=e.get(g);p!==void 0&&(e.delete(g),p.dispose())}function u(d){const g=d.target;g.removeEventListener("dispose",u);const p=t.get(g);p!==void 0&&(t.delete(g),p.dispose())}function h(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function rR(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Rl("WebGLRenderer: "+i+" extension not supported."),r}}}function sR(n,e,t,i){const r={},s=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const p in d.attributes)e.remove(d.attributes[p]);d.removeEventListener("dispose",o),delete r[d.id];const g=s.get(d);g&&(e.remove(g),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],n.ARRAY_BUFFER)}function c(h){const d=[],g=h.index,p=h.attributes.position;let x=0;if(p===void 0)return;if(g!==null){const M=g.array;x=g.version;for(let A=0,b=M.length;A<b;A+=3){const I=M[A+0],D=M[A+1],B=M[A+2];d.push(I,D,D,B,B,I)}}else{const M=p.array;x=p.version;for(let A=0,b=M.length/3-1;A<b;A+=3){const I=A+0,D=A+1,B=A+2;d.push(I,D,D,B,B,I)}}const m=new(p.count>=65535?A0:T0)(d,1);m.version=x;const _=s.get(h);_&&e.remove(_),s.set(h,m)}function u(h){const d=s.get(h);if(d){const g=h.index;g!==null&&d.version<g.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function oR(n,e,t){let i;function r(d){i=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,g){n.drawElements(i,g,s,d*o),t.update(g,i,1)}function c(d,g,p){p!==0&&(n.drawElementsInstanced(i,g,s,d*o,p),t.update(g,i,p))}function u(d,g,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,g,0,s,d,0,p);let m=0;for(let _=0;_<p;_++)m+=g[_];t.update(m,i,1)}function h(d,g,p,x){if(p===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let _=0;_<d.length;_++)c(d[_]/o,g[_],x[_]);else{m.multiDrawElementsInstancedWEBGL(i,g,0,s,d,0,x,0,p);let _=0;for(let M=0;M<p;M++)_+=g[M]*x[M];t.update(_,i,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function aR(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:ot("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function lR(n,e,t){const i=new WeakMap,r=new Vt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=i.get(a);if(d===void 0||d.count!==h){let w=function(){B.dispose(),i.delete(a),a.removeEventListener("dispose",w)};d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,p=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],_=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let A=0;g===!0&&(A=1),p===!0&&(A=2),x===!0&&(A=3);let b=a.attributes.position.count*A,I=1;b>e.maxTextureSize&&(I=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const D=new Float32Array(b*I*4*h),B=new M0(D,b,I,h);B.type=Jn,B.needsUpdate=!0;const E=A*4;for(let L=0;L<h;L++){const R=m[L],U=_[L],H=M[L],q=b*I*4*L;for(let J=0;J<R.count;J++){const O=J*E;g===!0&&(r.fromBufferAttribute(R,J),D[q+O+0]=r.x,D[q+O+1]=r.y,D[q+O+2]=r.z,D[q+O+3]=0),p===!0&&(r.fromBufferAttribute(U,J),D[q+O+4]=r.x,D[q+O+5]=r.y,D[q+O+6]=r.z,D[q+O+7]=0),x===!0&&(r.fromBufferAttribute(H,J),D[q+O+8]=r.x,D[q+O+9]=r.y,D[q+O+10]=r.z,D[q+O+11]=H.itemSize===4?r.w:1)}}d={count:h,texture:B,size:new St(b,I)},i.set(a,d),a.addEventListener("dispose",w)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let x=0;x<c.length;x++)g+=c[x];const p=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(n,"morphTargetBaseInfluence",p),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:s}}function cR(n,e,t,i,r){let s=new WeakMap;function o(c){const u=r.render.frame,h=c.geometry,d=e.get(c,h);if(s.get(d)!==u&&(e.update(d),s.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==u&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,u))),c.isSkinnedMesh){const g=c.skeleton;s.get(g)!==u&&(g.update(),s.set(g,u))}return d}function a(){s=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:o,dispose:a}}const uR={[r0]:"LINEAR_TONE_MAPPING",[s0]:"REINHARD_TONE_MAPPING",[o0]:"CINEON_TONE_MAPPING",[a0]:"ACES_FILMIC_TONE_MAPPING",[c0]:"AGX_TONE_MAPPING",[u0]:"NEUTRAL_TONE_MAPPING",[l0]:"CUSTOM_TONE_MAPPING"};function fR(n,e,t,i,r){const s=new Ui(e,t,{type:n,depthBuffer:i,stencilBuffer:r}),o=new Ui(e,t,{type:hr,depthBuffer:!1,stencilBuffer:!1}),a=new un;a.setAttribute("position",new Xt([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Xt([0,2,0,0,2,0],2));const l=new PE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Gn(a,l),u=new ec(-1,1,1,-1,0,1);let h=null,d=null,g=!1,p,x=null,m=[],_=!1;this.setSize=function(M,A){s.setSize(M,A),o.setSize(M,A);for(let b=0;b<m.length;b++){const I=m[b];I.setSize&&I.setSize(M,A)}},this.setEffects=function(M){m=M,_=m.length>0&&m[0].isRenderPass===!0;const A=s.width,b=s.height;for(let I=0;I<m.length;I++){const D=m[I];D.setSize&&D.setSize(A,b)}},this.begin=function(M,A){if(g||M.toneMapping===Ni&&m.length===0)return!1;if(x=A,A!==null){const b=A.width,I=A.height;(s.width!==b||s.height!==I)&&this.setSize(b,I)}return _===!1&&M.setRenderTarget(s),p=M.toneMapping,M.toneMapping=Ni,!0},this.hasRenderPass=function(){return _},this.end=function(M,A){M.toneMapping=p,g=!0;let b=s,I=o;for(let D=0;D<m.length;D++){const B=m[D];if(B.enabled!==!1&&(B.render(M,I,b,A),B.needsSwap!==!1)){const E=b;b=I,I=E}}if(h!==M.outputColorSpace||d!==M.toneMapping){h=M.outputColorSpace,d=M.toneMapping,l.defines={},yt.getTransfer(h)===It&&(l.defines.SRGB_TRANSFER="");const D=uR[d];D&&(l.defines[D]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=b.texture,M.setRenderTarget(x),M.render(c,u),x=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const z0=new Jt,Kf=new ia(1,1),G0=new M0,W0=new tE,j0=new L0,Mm=[],bm=[],Em=new Float32Array(16),Tm=new Float32Array(9),Am=new Float32Array(4);function ao(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Mm[r];if(s===void 0&&(s=new Float32Array(r),Mm[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function nn(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function rn(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function nc(n,e){let t=bm[e];t===void 0&&(t=new Int32Array(e),bm[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function hR(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function dR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nn(t,e))return;n.uniform2fv(this.addr,e),rn(t,e)}}function pR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(nn(t,e))return;n.uniform3fv(this.addr,e),rn(t,e)}}function mR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nn(t,e))return;n.uniform4fv(this.addr,e),rn(t,e)}}function gR(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(nn(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),rn(t,e)}else{if(nn(t,i))return;Am.set(i),n.uniformMatrix2fv(this.addr,!1,Am),rn(t,i)}}function _R(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(nn(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),rn(t,e)}else{if(nn(t,i))return;Tm.set(i),n.uniformMatrix3fv(this.addr,!1,Tm),rn(t,i)}}function vR(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(nn(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),rn(t,e)}else{if(nn(t,i))return;Em.set(i),n.uniformMatrix4fv(this.addr,!1,Em),rn(t,i)}}function xR(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function yR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nn(t,e))return;n.uniform2iv(this.addr,e),rn(t,e)}}function SR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(nn(t,e))return;n.uniform3iv(this.addr,e),rn(t,e)}}function MR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nn(t,e))return;n.uniform4iv(this.addr,e),rn(t,e)}}function bR(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function ER(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nn(t,e))return;n.uniform2uiv(this.addr,e),rn(t,e)}}function TR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(nn(t,e))return;n.uniform3uiv(this.addr,e),rn(t,e)}}function AR(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nn(t,e))return;n.uniform4uiv(this.addr,e),rn(t,e)}}function wR(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Kf.compareFunction=t.isReversedDepthBuffer()?Nh:Dh,s=Kf):s=z0,t.setTexture2D(e||s,r)}function RR(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||W0,r)}function CR(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||j0,r)}function PR(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||G0,r)}function LR(n){switch(n){case 5126:return hR;case 35664:return dR;case 35665:return pR;case 35666:return mR;case 35674:return gR;case 35675:return _R;case 35676:return vR;case 5124:case 35670:return xR;case 35667:case 35671:return yR;case 35668:case 35672:return SR;case 35669:case 35673:return MR;case 5125:return bR;case 36294:return ER;case 36295:return TR;case 36296:return AR;case 35678:case 36198:case 36298:case 36306:case 35682:return wR;case 35679:case 36299:case 36307:return RR;case 35680:case 36300:case 36308:case 36293:return CR;case 36289:case 36303:case 36311:case 36292:return PR}}function IR(n,e){n.uniform1fv(this.addr,e)}function DR(n,e){const t=ao(e,this.size,2);n.uniform2fv(this.addr,t)}function NR(n,e){const t=ao(e,this.size,3);n.uniform3fv(this.addr,t)}function UR(n,e){const t=ao(e,this.size,4);n.uniform4fv(this.addr,t)}function OR(n,e){const t=ao(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function FR(n,e){const t=ao(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function BR(n,e){const t=ao(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function kR(n,e){n.uniform1iv(this.addr,e)}function VR(n,e){n.uniform2iv(this.addr,e)}function HR(n,e){n.uniform3iv(this.addr,e)}function zR(n,e){n.uniform4iv(this.addr,e)}function GR(n,e){n.uniform1uiv(this.addr,e)}function WR(n,e){n.uniform2uiv(this.addr,e)}function jR(n,e){n.uniform3uiv(this.addr,e)}function XR(n,e){n.uniform4uiv(this.addr,e)}function qR(n,e,t){const i=this.cache,r=e.length,s=nc(t,r);nn(i,s)||(n.uniform1iv(this.addr,s),rn(i,s));let o;this.type===n.SAMPLER_2D_SHADOW?o=Kf:o=z0;for(let a=0;a!==r;++a)t.setTexture2D(e[a]||o,s[a])}function KR(n,e,t){const i=this.cache,r=e.length,s=nc(t,r);nn(i,s)||(n.uniform1iv(this.addr,s),rn(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||W0,s[o])}function YR(n,e,t){const i=this.cache,r=e.length,s=nc(t,r);nn(i,s)||(n.uniform1iv(this.addr,s),rn(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||j0,s[o])}function $R(n,e,t){const i=this.cache,r=e.length,s=nc(t,r);nn(i,s)||(n.uniform1iv(this.addr,s),rn(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||G0,s[o])}function JR(n){switch(n){case 5126:return IR;case 35664:return DR;case 35665:return NR;case 35666:return UR;case 35674:return OR;case 35675:return FR;case 35676:return BR;case 5124:case 35670:return kR;case 35667:case 35671:return VR;case 35668:case 35672:return HR;case 35669:case 35673:return zR;case 5125:return GR;case 36294:return WR;case 36295:return jR;case 36296:return XR;case 35678:case 36198:case 36298:case 36306:case 35682:return qR;case 35679:case 36299:case 36307:return KR;case 35680:case 36300:case 36308:case 36293:return YR;case 36289:case 36303:case 36311:case 36292:return $R}}class ZR{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=LR(t.type)}}class QR{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=JR(t.type)}}class e1{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const uu=/(\w+)(\])?(\[|\.)?/g;function wm(n,e){n.seq.push(e),n.map[e.id]=e}function t1(n,e,t){const i=n.name,r=i.length;for(uu.lastIndex=0;;){const s=uu.exec(i),o=uu.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){wm(t,c===void 0?new ZR(a,n,e):new QR(a,n,e));break}else{let h=t.map[a];h===void 0&&(h=new e1(a),wm(t,h)),t=h}}}class ml{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(t,o),l=e.getUniformLocation(t,a.name);t1(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Rm(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const n1=37297;let i1=0;function r1(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const Cm=new dt;function s1(n){yt._getMatrix(Cm,yt.workingColorSpace,n);const e=`mat3( ${Cm.elements.map(t=>t.toFixed(4))} )`;switch(yt.getTransfer(n)){case Al:return[e,"LinearTransferOETF"];case It:return[e,"sRGBTransferOETF"];default:return et("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Pm(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=(n.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+r1(n.getShaderSource(e),a)}else return s}function o1(n,e){const t=s1(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const a1={[r0]:"Linear",[s0]:"Reinhard",[o0]:"Cineon",[a0]:"ACESFilmic",[c0]:"AgX",[u0]:"Neutral",[l0]:"Custom"};function l1(n,e){const t=a1[e];return t===void 0?(et("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Qa=new ee;function c1(){yt.getLuminanceCoefficients(Qa);const n=Qa.x.toFixed(4),e=Qa.y.toFixed(4),t=Qa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function u1(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(No).join(`
`)}function f1(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function h1(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function No(n){return n!==""}function Lm(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Im(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const d1=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yf(n){return n.replace(d1,m1)}const p1=new Map;function m1(n,e){let t=pt[e];if(t===void 0){const i=p1.get(e);if(i!==void 0)t=pt[i],et('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Yf(t)}const g1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Dm(n){return n.replace(g1,_1)}function _1(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Nm(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const v1={[cl]:"SHADOWMAP_TYPE_PCF",[Io]:"SHADOWMAP_TYPE_VSM"};function x1(n){return v1[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const y1={[ls]:"ENVMAP_TYPE_CUBE",[qs]:"ENVMAP_TYPE_CUBE",[Yl]:"ENVMAP_TYPE_CUBE_UV"};function S1(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":y1[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const M1={[qs]:"ENVMAP_MODE_REFRACTION"};function b1(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":M1[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const E1={[i0]:"ENVMAP_BLENDING_MULTIPLY",[mb]:"ENVMAP_BLENDING_MIX",[gb]:"ENVMAP_BLENDING_ADD"};function T1(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":E1[n.combine]||"ENVMAP_BLENDING_NONE"}function A1(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function w1(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=x1(t),c=S1(t),u=b1(t),h=T1(t),d=A1(t),g=u1(t),p=f1(s),x=r.createProgram();let m,_,M=t.glslVersion?"#version "+t.glslVersion+`
